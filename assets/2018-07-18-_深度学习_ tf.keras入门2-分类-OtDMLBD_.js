...
#不显示网格线
plt.gca().grid(False)
</code></pre><p>效果图：</p><figure><img src="https://img-blog.csdn.net/20180718085223560?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0x1b2hlbllK/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70" alt="" tabindex="0" loading="lazy"></figure><p>样本的展示代码：</p><pre><code>#图像预处理
...
for i in range(25):
    ...
    plt.xlabel(&quot;{} ({})&quot;.format(class_names[predicted_label], 
                                  ...
                                  color=color)
</code></pre><p>效果图，绿色标签表示分类正确，红色标签表示分类错误：</p><figure><img src="https://img-blog.csdn.net/20180718091104210?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0x1b2hlbllK/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70" alt="" tabindex="0" loading="lazy"></figure><p>对于单个图像的预测，需要将图像28X28的输入转换为1X28X28的输入，转换函数为np.expand_dims。函数使用如下： <a href="https://www.zhihu.com/question/265545749" target="_blank" rel="noopener noreferrer"> https://www.zhihu.com/question/265545749 </a></p><pre><code>#格式转换
...
prediction = predictions[0]
np.argmax(prediction) #9
</code></pre>`,41)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};