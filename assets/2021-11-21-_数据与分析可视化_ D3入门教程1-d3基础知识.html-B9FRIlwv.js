import{_ as t,r as n,o as l,c as s,a as i,b as a,d,e as r}from"./app-CD_-ggd_.js";const u={},v=r(`<h1 id="数据与分析可视化-d3入门教程1-d3基础知识" tabindex="-1"><a class="header-anchor" href="#数据与分析可视化-d3入门教程1-d3基础知识"><span>[数据与分析可视化] D3入门教程1-d3基础知识</span></a></h1><p>d3.js是一个用于绘图的JavaScript 库。 它可以可视化展示任何类型的数据。 本文档展示了多个交互式示例，说明了d3.js的关键概念，从而生成了第一个基本散点图。</p><h2 id="_1-html介绍" tabindex="-1"><a class="header-anchor" href="#_1-html介绍"><span>1 HTML介绍</span></a></h2><h3 id="_1-1-什么是html" tabindex="-1"><a class="header-anchor" href="#_1-1-什么是html"><span>1.1 什么是HTML？</span></a></h3><p>HTML介绍：</p><ul><li>HTML代表超文本标记语言。基本上，它是任何网站背后的语言。Mozilla 或 Safari 等 Web 浏览器会读取此类文件并将其翻译到网页中</li><li>在HTML文件中，组成网页的元素被创建，并由标签描述。例如，级别1的标题由h1标签表示，带有标签的段落，由p标签表示图像img</li><li>如果没有 html 的基本知识，就不可能学会d3.js</li></ul><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>&lt;!DOCTYPE html&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1>First html document</h1><p>This is my first sentence</p><p>This is <a href="https://www.d3-graph-gallery.com">a link to the d3 graph gallery</a></p><p>将上面的代码复制并粘贴到本地文件中。称之为test.html，便构建一个简单的网页。</p><h3 id="_1-2-自定义文档样式css" tabindex="-1"><a class="header-anchor" href="#_1-2-自定义文档样式css"><span>1.2 自定义文档样式CSS</span></a></h3><p>CSS代表级联样式表，它允许将特定样式应用于使用html创建的元素。</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>
&lt;!DOCTYPE html&gt;
&lt;!-- 将特定样式应用于inGreen类的元素 --&gt;
&lt;style&gt;
  .inRed { color: red; }
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 class="inFont">First html document</h1><p class="inRed">This is my first sentence</p><p>This is <a href="https://www.d3-graph-gallery.com">a link to the d3 graph gallery</a></p><h3 id="_1-3-构建svg图形" tabindex="-1"><a class="header-anchor" href="#_1-3-构建svg图形"><span>1.3 构建svg图形</span></a></h3><ul><li>svg代表可缩放矢量图形。它是一种矢量图像格式。基本上，它是一种允许使用代码构建形状的语言</li><li>d3.js图表实际上是一组svg组合在一起的形状</li><li>d3.js展示了不同形状的svg</li></ul><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>&lt;!DOCTYPE html&gt;
&lt;!-- 添加标题 --&gt;
&lt;h1&gt;First html document&lt;/h1&gt;
...
&lt;/svg&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/web-Study-Notes/[数据分析与可视化] D3入门教程/[数据与分析可视化] D3入门教程1/image/img2.svg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="_2-4-比例尺" tabindex="-1"><a class="header-anchor" href="#_2-4-比例尺"><span>2.4 比例尺</span></a></h3><p>如果想用百分比来表示svg中元素的位置，那么就需要用到比例尺，比例尺就是一个将像素值范围转换为位置百分比的函数。它被称为scale。如果我的数据是百分比并且我的svg区域是400px宽度。那么0%代表0px，100%代表400像素。50%代表200像素。比例尺有domain和range两个属性，range设置像素值范围，domain设置位置百分比。</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>    &lt;!-- 添加一个空的svg图片 --&gt;
    ...
    &lt;/script&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/web-Study-Notes/[数据分析与可视化] D3入门教程/[数据与分析可视化] D3入门教程1/image/img3.svg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="_2-5-添加轴" tabindex="-1"><a class="header-anchor" href="#_2-5-添加轴"><span>2.5 添加轴</span></a></h3><p>d3提供了一些自动绘制轴的功能。这些轴始终与比例尺scale对应。axisBottom()创建一个水平轴，底部带有刻度和标签。axisLeft()将用于Y 轴。</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>    &lt;!-- 添加一个空的svg图片 --&gt;
    &lt;svg id=&quot;viz_area&quot; height=200 width=450&gt;&lt;/svg&gt;
    ...
    &lt;script&gt;
        ...
        svg.append(&quot;circle&quot;)
            .attr(&quot;cx&quot;, x(100)).attr(&quot;cy&quot;, 100).attr(&quot;r&quot;, 40).style(&quot;fill&quot;, &quot;green&quot;);
    &lt;/script&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/web-Study-Notes/[数据分析与可视化] D3入门教程/[数据与分析可视化] D3入门教程1/image/img4.svg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="_2-6-边距和偏移" tabindex="-1"><a class="header-anchor" href="#_2-6-边距和偏移"><span>2.6 边距和偏移</span></a></h3><p>轴位置经常需要调整，例如，X轴通常位于图表的底部。这归功于translation函数，应用.attr(&quot;transform&quot;, &quot;translate(20,50)&quot;)到一个元素，将其向右平移 20 像素，向底部平移 50 像素。</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>
    &lt;!-- 添加一个空的svg图片 --&gt;
    &lt;div id=&quot;Area&quot;&gt;&lt;/div&gt;
    ...
    &lt;/script&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/web-Study-Notes/[数据分析与可视化] D3入门教程/[数据与分析可视化] D3入门教程1/image/img5.svg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="_2-7-数据绑定" tabindex="-1"><a class="header-anchor" href="#_2-7-数据绑定"><span>2.7 数据绑定</span></a></h3><p>将数据绑定到svg元素是我们完成散点图所需的最后一步。在我看来，这也是最难理解的部分。它始终遵循相同的步骤：</p><ul><li>svg: 选择图表所在的 svg 区域</li><li>.selectAll(&quot;whatever&quot;): 选择所有尚未创建的元素，我知道这很奇怪。</li><li>.data(data): 指定要使用的数据。</li><li>.enter(): 开始数据循环。以下代码将应用于data[0]，data[1]依此类推。</li><li>.append(&quot;circle&quot;)：对于每次迭代，添加一个圆圈。</li><li>.attr(&quot;cx&quot;, function(d){ return x(d.x) }): 给出圆的x位置。这里d将是data[0]，然后data[1]等等。</li></ul><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>    &lt;!-- 添加一个空的svg图片 --&gt;
