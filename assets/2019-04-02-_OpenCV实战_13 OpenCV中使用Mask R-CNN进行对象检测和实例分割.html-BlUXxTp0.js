import{_ as r,r as s,o as i,c as l,a as t,b as e,d as o,e as a}from"./app-CD_-ggd_.js";const c={},p=t("h1",{id:"opencv实战-13-opencv中使用mask-r-cnn进行对象检测和实例分割",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#opencv实战-13-opencv中使用mask-r-cnn进行对象检测和实例分割"},[t("span",null,"[OpenCV实战]13 OpenCV中使用Mask R-CNN进行对象检测和实例分割")])],-1),m=t("p",null,"Mask R-CNN具体内容见：",-1),d={href:"https://arxiv.org/pdf/1703.06870.pdf",target:"_blank",rel:"noopener noreferrer"},h=t("p",null,"Mask R-CNN最初于2017年11月由Facebook的AI研究团队使用Python和Caffe2推出。工程代码见：",-1),f={href:"https://github.com/facebookresearch/Detectron",target:"_blank",rel:"noopener noreferrer"},u=t("p",null,"后来Mask R-CNN被移植到Tensorflow，并且在共享了几个预先训练的模型，这些模型具有不同的训练架构，如InceptionV2，ResNet50，ResNet101和Inception- ResnetV2 。它们还为您提供培训自己模型的工具。",-1),_={href:"https://github.com/tensorflow/models/blob/master/research/object_detection/g3doc/detection_model_zoo.md",target:"_blank",rel:"noopener noreferrer"},b={href:"https://github.com/tensorflow/models/blob/master/research/object_detection/g3doc/instance_segmentation.md",target:"_blank",rel:"noopener noreferrer"},g=a('<p>基于Inception训练的Mask R-CNN速度最快，甚至可以在CPU上使用它，因此我们在本教程中选择了它。该模型在MSCOCO数据集上进行了训练。我们将共享OpenCV(OpenCV 3.43以上版本)代码以在C ++和Python中加载和使用该模型。</p><h2 id="_1-背景介绍" tabindex="-1"><a class="header-anchor" href="#_1-背景介绍"><span><strong>1</strong> <strong>背景介绍</strong></span></a></h2><h3 id="_1-1-什么是图像分割和实例分割" tabindex="-1"><a class="header-anchor" href="#_1-1-什么是图像分割和实例分割"><span><strong>1.1</strong> <strong>什么是图像分割和实例分割</strong></span></a></h3><p>在计算机视觉中，术语“图像分割”或简称“分割”意味着基于某些标准将图像分成像素区域。您可以根据颜色，纹理或您已决定的其他一些条件进行分割。这些区域有时也称为超像素区域。</p><p>进行图像分割有多种方法比如实例分割，语义分割，全景分割等。</p><p>具体区别见：</p>',6),k={href:"https://zhuanlan.zhihu.com/p/50996404",target:"_blank",rel:"noopener noreferrer"},x=t("p",null,"在实例分割中，目标是检测图像中的特定对象并在感兴趣的对象周围创建掩模。实例分割也可以被认为是对象检测，其输出是掩码而不仅仅是边界框。与尝试对图像中的每个像素进行分类的语义分割不同，实例分割不仅仅在标记图像中的每个像素，还区分各个单体。下面我们看一个在非常相似的彩色背景上的两只绵羊的实例分割的例子。",-1),N=t("figure",null,[t("img",{src:"https://www.learnopencv.com/wp-content/uploads/2018/10/Mask-RCNN-results-1024x290.png",alt:"https://www.learnopencv.com/wp-content/uploads/2018/10/Mask-RCNN-results-1024x290.png",tabindex:"0",loading:"lazy"}),t("figcaption",null,"https://www.learnopencv.com/wp-content/uploads/2018/10/Mask-RCNN-results-1024x290.png")],-1),C=t("h3",{id:"_1-2-mask-rcnn-原理",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#_1-2-mask-rcnn-原理"},[t("span",null,[t("strong",null,"1.2 Mask-RCNN"),e(),t("strong",null,"原理")])])],-1),E=t("p",null,"Mask-RCNN是对原始R-CNN论文的一系列改进结果，用于物体检测。R-CNN基于选择性搜索的方法生成候选框，然后使用卷积网络一次一个地处理每个候选框区域以输出对象标签及其边界框。",-1),w=t("p",null,"R-CNN具体见：",-1),v={href:"https://arxiv.org/abs/1311.2524",target:"_blank",rel:"noopener noreferrer"},F=t("p",null,"Fast R-CNN通过使用ROIPool层在其CNN中一起处理所有提出的候选框区域，使得R-CNN算法更快。",-1),M=t("p",null,"Fast R-CNN具体见：",-1),R={href:"https://arxiv.org/pdf/1504.08083.pdf",target:"_blank",rel:"noopener noreferrer"},y=t("p",null,"Faster R-CNN通过提取候选区域的网络RPN，代替了费时的选择性搜索，使得检测速度大幅提高。",-1),O=t("p",null,"Faster R-CNN具体见：",-1),V={href:"https://arxiv.org/pdf/1506.01497.pdf",target:"_blank",rel:"noopener noreferrer"},P=t("p",null,"上述R-CNN及其优化版本简要原理见：",-1),D={href:"https://www.cnblogs.com/skyfsm/p/6806246.html",target:"_blank",rel:"noopener noreferrer"},B=a('<p>Mask R-CNN是对Faster RCNN的一种改进，它包括掩码预测与标签预测和边界框预测两个输出，如下图所示：</p><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/[OpenCV实战]13 OpenCV中使用Mask R-CNN进行对象检测和实例分割/20190402185014806.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0x1b2hlbllK,size_16,color_FFFFFF,t_70" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>Mask-RCNN网络有两个主要部分。</p><p>第一个是候选区域生成网络，每个图像生成大约300个候选区域。在训练期间，这些候选区域（ROI）中的每一个都通过第二部分，即目标检测和掩膜预测网络，如上所示。注意，由于掩模预测分支与分类框预测分支并行运行，因此对于每个给定的ROI，网络预测可能会获得属于任何类别的掩模。</p><p>在推理期间，候选区域会用非最大抑制性方法进行筛选，并且掩模预测分支仅处理最高得分100检测框。因此，对于100个ROI和90个对象类，网络的掩模预测部分输出尺寸为100x90x15x15的4D张量，其中每个掩模的大小为15×15。</p><p>对于上面显示的绵羊图像，网络检测到两个对象。对于每个对象，它输出一个数组，其中包含预测的类分数（表示对象属于预测类的概率），检测到的对象的边界框的左，上，右和下位置。从掩码预测分支的输出中提取相应分类的掩码。检测到的两个对象的掩码如下所示：</p><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/[OpenCV实战]13 OpenCV中使用Mask R-CNN进行对象检测和实例分割/20190402185013714.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0x1b2hlbllK,size_16,color_FFFFFF,t_70" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>与Faster R-CNN一样，Mask R-CNN所用架构网络也很灵活。我们之所以选择InceptionV2是因为速度更快，但正如Mask R-CNN论文的作者所指出的那样，人们可以通过ResNeXt-101这样的更好的架构获得更好的结果。</p><p>与其他物体探测器（如YOLOv3）相比，Mask-RCNN网络可在更大的图像上运行。网络调整输入图像的大小，使得较小的边是800像素。下面我们将详细介绍获取实例分段结果所需的步骤。为了简化和清晰可视化，我们使用相同的颜色来表示同一类的对象，</p><p>Mask R-CNN简要理解见：</p>',10),z={href:"https://www.cnblogs.com/wangyong/p/9305347.html",target:"_blank",rel:"noopener noreferrer"},I=a('<h2 id="_2-mask-rcnn-在opencv-中的使用" tabindex="-1"><a class="header-anchor" href="#_2-mask-rcnn-在opencv-中的使用"><span><strong>2 Mask-RCNN</strong> <strong>在OpenCV</strong> <strong>中的使用</strong></span></a></h2><h3 id="_2-1-模型下载" tabindex="-1"><a class="header-anchor" href="#_2-1-模型下载"><span><strong>2.1</strong> <strong>模型下载</strong></span></a></h3><p>模型下载地址：</p>',3),A={href:"http://download.tensorflow.org/models/object_detection/mask_rcnn_inception_v2_coco_2018_01_28.tar.gz",target:"_blank",rel:"noopener noreferrer"},S=a(`<h3 id="_2-2-模型初始化" tabindex="-1"><a class="header-anchor" href="#_2-2-模型初始化"><span><strong>2.2</strong> <strong>模型初始化</strong></span></a></h3><p>Mask-RCNN算法输出生成为边界框。每个边界框与置信度分数相关联。置信度阈值参数以下的都将被忽略。从网络输出的对象掩码是灰度图像。由于我们在本教程中使用二值掩码，因此我们使用maskThreshold参数来阈值灰色掩码图像。降低其值将获取更大的掩模。有时这有助于包括在边界附近遗漏的部分，但同时，它还可能包括更尖的边界区域处的背景像素。</p><p>文件mscoco_labels.names包含训练模型的所有预测对象。colors.txt文件包含用于标记各种类对象的所有颜色。</p><p>接下来，我们使用这两个文件加载网络</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>mask_rcnn_inception_v2_coco.pb：预先训练的权重；
...
`)],-1),j=t("p",null,"Python版本代码：",-1),H=t("pre",null,[t("code",null,`import cv2 as cv
import numpy as np
import os.path
import sys
import random
