import{_ as n,r as d,o as t,c as a,a as e,b as s,d as l,e as r}from"./app-q9tmr8t5.js";const v={},c=r(`<h1 id="编程基础-c-多线程入门2-连接和分离线程" tabindex="-1"><a class="header-anchor" href="#编程基础-c-多线程入门2-连接和分离线程" aria-hidden="true">#</a> [编程基础] C++多线程入门2-连接和分离线程</h1><p>原始C++标准仅支持单线程编程。新的C++标准(称为C++11或C++0x)于2011年发布。在C++11中，引入了新的线程库。因此运行本文程序需要C++至少符合C++11标准。</p><h2 id="_2-连接和分离线程" tabindex="-1"><a class="header-anchor" href="#_2-连接和分离线程" aria-hidden="true">#</a> 2 连接和分离线程</h2><p>在本章中，我们将讨论std::thread的连接和分离。</p><h3 id="_2-1-用std-join-连接线程" tabindex="-1"><a class="header-anchor" href="#_2-1-用std-join-连接线程" aria-hidden="true">#</a> 2.1 用std:🧵:join()连接线程</h3><p>一旦启动一个线程，则另一个线程可以等待该新线程完成。为此，还需要在std::thread对象上调用join()函数，即</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>std::thread th(funcPtr);
// Some Code
th.join();
