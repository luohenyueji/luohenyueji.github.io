import{_ as a,r as l,o as s,c as d,a as e,b as i,d as n,e as r}from"./app-DtrmxRee.js";const o={},E=r(`<h1 id="数据分析与可视化-数据绘图要点6-数据组过多" tabindex="-1"><a class="header-anchor" href="#数据分析与可视化-数据绘图要点6-数据组过多"><span>[数据分析与可视化] 数据绘图要点6-数据组过多</span></a></h1><p>比较几个数值变量的分布是数据展示中的一项常见任务。变量的分布可以使用直方图或密度图来表示，在同一轴上表示适量数据的组是非常有吸引力的。但是数据组过多将严重影响图表信息表现。</p><h2 id="数据分布绘图实例" tabindex="-1"><a class="header-anchor" href="#数据分布绘图实例"><span>数据分布绘图实例</span></a></h2><p>下面是一个示例，展示了人们如何感知词汇。短语“Highly likely”表示什么情况的概率问题。以下是人们给出概率分数分布结果。</p><div class="language-R line-numbers-mode" data-ext="R" data-title="R"><pre class="language-R"><code>## 加载库
library(tidyverse)
library(hrbrthemes)
library(viridis)
library(patchwork)
