import{_ as o,r as i,o as l,c as r,a as t,b as e,d as a,e as s}from"./app-CD_-ggd_.js";const p={},c=t("h1",{id:"深度学习-tf-keras入门2-分类",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#深度学习-tf-keras入门2-分类"},[t("span",null,"[深度学习] tf.keras入门2-分类")])],-1),d=t("p",null,"主要介绍基于tf.keras的Fashion MNIST数据库分类，",-1),m={href:"https://tensorflow.google.cn/tutorials/keras/basic_classification",target:"_blank",rel:"noopener noreferrer"},_={href:"https://tensorflow.google.cn/tutorials/keras/basic_text_classification",target:"_blank",rel:"noopener noreferrer"},h=s(`<p>首先是函数的调用，对于tensorflow只有在版本1.2以上的版本才有tf.keras库。另外推荐使用python3，而不是python2。</p><pre><code>## TensorFlow and tf.keras
...
`)],-1),V=t("h2",{id:"总体代码",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#总体代码"},[t("span",null,"总体代码")])],-1),X=t("pre",null,[t("code",null,`## TensorFlow and tf.keras
import tensorflow as tf
from tensorflow import keras
