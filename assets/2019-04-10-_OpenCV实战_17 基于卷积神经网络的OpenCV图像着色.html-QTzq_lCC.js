...
</code></pre><h3 id="_2-2-加载量化信息" tabindex="-1"><a class="header-anchor" href="#_2-2-加载量化信息" aria-hidden="true">#</a> 2.2 加载量化信息</h3><p>接下来，我们加载量化分级信息。然后就是对输出进行变换。最后，我们添加一个非零值的缩放图层。</p><p>c++代码：</p><pre><code>	// setup additional layers 在网络里额外添加两层
	int sz[] = { 2, 313, 1, 1 };
	//添加一个ab转换层
...
</code></pre><h2 id="_3-代码" tabindex="-1"><a class="header-anchor" href="#_3-代码" aria-hidden="true">#</a> 3 代码</h2><p>算法速度很快，但是我个人觉得没加颜色再平衡的效果更好。代码分为图像版本和视频版本。但是总体效果一般般吧。</p><p>代码下载地址：</p>`,21),x={href:"https://github.com/luohenyueji/OpenCV-Practical-Exercise",target:"_blank",rel:"noopener noreferrer"},q=o(`<h3 id="_3-1-图像着色代码" tabindex="-1"><a class="header-anchor" href="#_3-1-图像着色代码" aria-hidden="true">#</a> 3.1 图像着色代码</h3><p>C++:</p><pre><code>// OpenCV_Colorization.cpp : 此文件包含 &quot;main&quot; 函数。程序执行将在此处开始并结束。
//
...
print(&#39;Done !!!&#39;)
</code></pre><h3 id="_3-2-视频着色代码" tabindex="-1"><a class="header-anchor" href="#_3-2-视频着色代码" aria-hidden="true">#</a> 3.2 视频着色代码</h3><p>C++:</p><pre><code>#include &quot;pch.h&quot;
#include &lt;opencv2/dnn.hpp&gt;
#include &lt;opencv2/imgproc.hpp&gt;
#include &lt;opencv2/highgui.hpp&gt;
#include &lt;iostream&gt;
...
print(&#39;Done !!!&#39;)
</code></pre><h2 id="_4-参考" tabindex="-1"><a class="header-anchor" href="#_4-参考" aria-hidden="true">#</a> 4 参考</h2>`,11),G={href:"https://www.learnopencv.com/convolutional-neural-network-based-image-colorization-using-opencv/",target:"_blank",rel:"noopener noreferrer"};function k(R,Z){const n=r("ExternalLinkIcon");return l(),p("div",null,[c,_,u,e("p",null,[t("基于传统的计算机视觉方法以及发表了许多关于图像着色的论文。我最喜欢的一篇文章是名为Colorization using Optimization的论文。它使用了一些彩色涂鸦来指导解决着色的优化问题。论文见 "),e("a",g,[t("https://www.cs.huji.ac.il/~yweiss/Colorization/"),a(n)])]),h,m,d,e("p",null,[t("论文原文： "),e("a",b,[t(" http://videolectures.net/eccv2016_zhang_image_colorization/ "),a(n)])]),f,e("p",null,[e("a",y,[t(" https://blog.csdn.net/qq_16137569/article/details/83859156"),a(n)])]),F,e("p",null,[t("地址： "),e("a",z,[t(" https://github.com/richzhang/colorization"),a(n)])]),C,w,v,e("p",null,[e("a",V,[t("http://eecs.berkeley.edu/~rich.zhang/projects/2016_colorization/files/demo_v2/colorization_release_v2.caffemodel"),a(n)])]),e("p",null,[e("a",L,[t("http://eecs.berkeley.edu/~rich.zhang/projects/2016_colorization/files/demo_v2/colorization_release_v2_norebal.caffemodel"),a(n)])]),O,e("p",null,[e("a",x,[t(" https://github.com/luohenyueji/OpenCV-Practical-Exercise"),a(n)])]),q,e("ul",null,[e("li",null,[e("a",G,[t(" https://www.learnopencv.com/convolutional-neural-network-based-image- colorization-using-opencv/ "),a(n)])])])])}const N=i(s,[["render",k],["__file","2019-04-10-_OpenCV实战_17 基于卷积神经网络的OpenCV图像着色.html.vue"]]);export{N as default};
