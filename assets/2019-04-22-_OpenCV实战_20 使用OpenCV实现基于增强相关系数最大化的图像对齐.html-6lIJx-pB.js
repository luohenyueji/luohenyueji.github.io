...
if __name__ == &#39;__main__&#39;:
    ...
    cv2.waitKey(0)
</code></pre><p>结果就是本文一张图的效果。</p><p>如果您要实际制作商业图像注册产品，则需要做的比我的代码更多。例如，当对齐错误很多时，此代码可能会失败。在这种情况下，您需要在较低分辨率版本的图像上估计变换参数，并使用低分辨率版本中估计的参数初始化较高分辨率版本的变换矩阵。此外，findTransformECC估计单个全局变换以进行对齐。当图像中存在局部运动时（例如，主体在两张照片中移动了一点），这种运动模型显然是不够的。在这种情况下，需要使用基于光流的方法来进行额外的局部对准。另外这个算法计算很慢，注意图像分辨率。如果想提高精度，改变阈值增加算法迭代次数。</p><h2 id="_3-参考" tabindex="-1"><a class="header-anchor" href="#_3-参考" aria-hidden="true">#</a> 3 参考</h2>`,22),R={href:"https://www.learnopencv.com/image-alignment-ecc-in-opencv-c-python/",target:"_blank",rel:"noopener noreferrer"};function E(A,M){const n=o("ExternalLinkIcon");return p(),c("div",null,[s,_,h,m,e("p",null,[e("a",d,[t(" https://github.com/luohenyueji/OpenCV-Practical-Exercise"),i(n)])]),g,e("p",null,[e("a",u,[t(" http://www.nphoto.net/news/2016-06/15/31621980c7927bea4.shtml"),i(n)])]),f,e("p",null,[e("a",w,[t(" http://www.vintagephoto.tv/mb.shtml "),i(n)])]),b,C,e("p",null,[e("a",y,[t(" http://www.loc.gov/pictures/collection/prok/ "),i(n)])]),x,e("p",null,[e("a",O,[t("http://xanthippi.ceid.upatras.gr/people/evangelidis/george_files/PAMI_2008.pdf"),i(n)])]),v,e("ul",null,[e("li",null,[e("a",R,[t(" https://www.learnopencv.com/image-alignment-ecc-in-opencv-c-python/"),i(n)])])])])}const N=r(l,[["render",E],["__file","2019-04-22-_OpenCV实战_20 使用OpenCV实现基于增强相关系数最大化的图像对齐.html.vue"]]);export{N as default};
