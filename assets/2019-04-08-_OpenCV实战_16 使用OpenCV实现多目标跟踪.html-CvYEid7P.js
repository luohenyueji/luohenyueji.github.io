...
</code></pre><p>总体来说精度和单目标跟踪器差不多，所耗时间差不多5到7倍，不同算法不同。</p><p>代码下载地址：</p>`,50),f={href:"https://github.com/luohenyueji/OpenCV-Practical-Exercise",target:"_blank",rel:"noopener noreferrer"},h=e("p",null,"完整代码如下：",-1),b=e("p",null,"C++：",-1),m=e("pre",null,[e("code",null,`// Opencv_MultiTracker.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//
...
`)],-1),g=e("p",null,"Python：",-1),y=e("pre",null,[e("code",null,`from __future__ import print_function
import sys
import cv2
from random import randint
