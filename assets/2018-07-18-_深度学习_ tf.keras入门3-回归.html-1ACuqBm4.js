import{_ as o,r as s,o as d,c as l,a as t,b as e,d as a,e as r}from"./app-CxcT-WUR.js";const i={},p=t("h1",{id:"深度学习-tf-keras入门3-回归",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#深度学习-tf-keras入门3-回归"},[t("span",null,"[深度学习] tf.keras入门3-回归")])],-1),h={href:"https://tensorflow.google.cn/tutorials/keras/basic_regression",target:"_blank",rel:"noopener noreferrer"},c=r(`<h2 id="波士顿房价数据集" tabindex="-1"><a class="header-anchor" href="#波士顿房价数据集"><span>波士顿房价数据集</span></a></h2><h3 id="数据集" tabindex="-1"><a class="header-anchor" href="#数据集"><span>数据集</span></a></h3><p>波士顿数据集是一个回归问题。每个类的观察值数量是均等的，共有 506 个观察，13 个输入变量和1个输出变量。每条数据包含房屋以及房屋周围的详细信息。其中包含城镇犯罪率，一氧化氮浓度，住宅平均房间数，到中心区域的加权距离以及自住房平均房价等等。</p><p>但是对于回归问题，需要读取数据后需要将数据集打散，代码如下：</p><pre><code>boston_housing = keras.datasets.boston_housing
