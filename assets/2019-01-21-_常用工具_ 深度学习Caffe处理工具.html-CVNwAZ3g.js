import{_ as r,r as o,o as i,c as p,a as e,b as t,d as a,e as s}from"./app-CD_-ggd_.js";const l={},c=s(`<h1 id="常用工具-深度学习caffe处理工具" tabindex="-1"><a class="header-anchor" href="#常用工具-深度学习caffe处理工具"><span>[常用工具] 深度学习Caffe处理工具</span></a></h1><p>对于机器学习、图像处理有时要对图像数据进行分割处理。用python写了一些常用小工具代码。</p><h2 id="_1-caffe数据集txt文本制作" tabindex="-1"><a class="header-anchor" href="#_1-caffe数据集txt文本制作"><span>1 Caffe数据集txt文本制作</span></a></h2><p>很多时候要建立如下数据集txt文本，类似图片所示（图片网上找的)</p><figure><img src="https://img-blog.csdnimg.cn/20190121145819354.jpg?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0x1b2hlbllK,size_16,color_FFFFFF,t_70" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>生成代码如下：</p><pre><code>&quot;&quot;&quot;
caffe数据集txt文本制作
&quot;&quot;&quot;
...
listdir(&#39;./2&#39;,name)
del_dir(&#39;./1&#39;,name,&#39;./3&#39;)
</code></pre><h2 id="_7-绘制caffe模型的roc曲线-二分类" tabindex="-1"><a class="header-anchor" href="#_7-绘制caffe模型的roc曲线-二分类"><span>7 绘制caffe模型的ROC曲线(二分类)</span></a></h2><p>主要原理为通过OpenCV DNN 调用caffe模型，其他模型一样套路。然后对每张图像进行检测，保存该图像真实标签，以及该标签分类的模型预测概率。调用sklearn绘制ROC，并计算AUC值。通过约登指数获得ROC曲线中最佳阈值。最后通过matplotlib绘图。约登指数为TPR- FPR或者TPR+TNR-1。具体ROC原理可参考：</p>`,24),m={href:"https://www.jianshu.com/p/c61ae11cc5f6",target:"_blank",rel:"noopener noreferrer"},f={href:"https://www.jianshu.com/p/82903edb58dc",target:"_blank",rel:"noopener noreferrer"},d={href:"https://blog.csdn.net/u014264373/article/details/80487766",target:"_blank",rel:"noopener noreferrer"},h=e("pre",null,[e("code",null,`'''
opencv调用caffe并计算roc
'''
import numpy as np
