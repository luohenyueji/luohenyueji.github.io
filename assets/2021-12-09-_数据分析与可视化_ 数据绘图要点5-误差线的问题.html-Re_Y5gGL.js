import{_ as d}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as l,o as s,c as r,a as e,b as i,d as n,e as a}from"./app-kCY7hV_E.js";const o={},c=a(`<h1 id="数据分析与可视化-数据绘图要点5-误差线的问题" tabindex="-1"><a class="header-anchor" href="#数据分析与可视化-数据绘图要点5-误差线的问题" aria-hidden="true">#</a> [数据分析与可视化] 数据绘图要点5-误差线的问题</h1><p>[toc]</p><p>误差线给出了测量精确度的一般概念，真实（无误差）值可能与报告值相差多远。如果条形图上显示的值是聚合的结果（如多个数据点的平均值），您可能需要显示误差线。但我们必须要谨慎使用误差线，具体原因将在后续给出。</p><h2 id="误差线的绘制" tabindex="-1"><a class="header-anchor" href="#误差线的绘制" aria-hidden="true">#</a> 误差线的绘制</h2><p>在下图中，报告了5个group。条形高度代表它们的平均值。黑色误差线提供有关单个观测值如何分散在平均值周围的信息。例如，似乎groupB中的测量结果比groupE中的更精确。</p><div class="language-R line-numbers-mode" data-ext="R"><pre class="language-R"><code>## 加载库
library(tidyverse)
library(hrbrthemes)
library(viridis)
library(patchwork)
