...
</code></pre><h2 id="_3-代码" tabindex="-1"><a class="header-anchor" href="#_3-代码"><span>3 代码</span></a></h2><p>本文所有代码见：</p>`,52),s={href:"https://github.com/luohenyueji/OpenCV-Practical-Exercise",target:"_blank",rel:"noopener noreferrer"},m=n("p",null,"C++:",-1),u=n("pre",null,[n("code",null,`#include "pch.h"
...
`)],-1),d=n("p",null,"Python:",-1),h=n("pre",null,[n("code",null,`#!/usr/bin/env python
