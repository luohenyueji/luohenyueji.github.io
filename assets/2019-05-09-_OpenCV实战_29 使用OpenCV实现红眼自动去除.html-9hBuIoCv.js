import{_ as o}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as s,o as r,c as l,a as e,b as n,d as t,e as i}from"./app-MsA2k2kn.js";const c={},p=i('<h1 id="opencv实战-29-使用opencv实现红眼自动去除" tabindex="-1"><a class="header-anchor" href="#opencv实战-29-使用opencv实现红眼自动去除" aria-hidden="true">#</a> [OpenCV实战]29 使用OpenCV实现红眼自动去除</h1><p>在本教程中，我们将学习如何完全自动地从照片中消除红眼。如下图所示：</p><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/[OpenCV实战]29 使用OpenCV实现红眼自动去除/20190509150754666.jpeg?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0x1b2hlbllK,size_16,color_FFFFFF,t_70" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>当我们晚上拍摄的照片有红眼效果时，带着血腥眼睛的微笑的人会让人想起德古拉。使用照片编辑工具可以删除红眼，但是需要很长的时间来学习。构建一个可用于各种图像的强大的红眼消除应用程序超出了本文的范围。但是，我们将学习基本原理并验证效果。</p><p>什么原因导致闪光灯拍照中的红眼效应？</p><p>当你在一个黑暗的房间里时，你的瞳孔会扩张（放大）以获得更多光线帮助你看得更清楚。大多数相机的闪光灯都非常靠近镜头。当您使用闪光灯拍摄照片时，来自闪光灯的光线会通过放大的瞳孔传到眼球的后部，然后通过瞳孔返回到相机的镜头中。眼球的后部称为眼底。由于眼底血液供应充足，它呈红色。</p><p>眼底的图像显示在下面。检查眼底可以揭示很多关于一个人的健康。您甚至可以获得智能手机应用程序，帮助您通过附件查看眼底。大多数相机持续闪烁几秒，使瞳孔收缩，从而减少红眼的可能性。</p><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/[OpenCV实战]29 使用OpenCV实现红眼自动去除/20190509150754691.jpeg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="_1-红眼消除" tabindex="-1"><a class="header-anchor" href="#_1-红眼消除" aria-hidden="true">#</a> 1 红眼消除</h2><p>在本节中，我们将逐步介绍用于自动消除红眼的算法。</p><h3 id="_1-1-眼部检测" tabindex="-1"><a class="header-anchor" href="#_1-1-眼部检测" aria-hidden="true">#</a> 1.1 眼部检测</h3><p>第一步是自动检测眼睛。我们使用标准的OpenCV Haar探测器（haarcascade_eye.xml）来寻找眼睛。有时，首先运行面部检测器然后检测面部区域内的眼睛是有意义的。为了简单起见，我们直接在图像上运行眼睛检测器。当输入图像是人像拍摄，或者您有眼睛的特写镜头时，跳过面部检测器。</p><p>您也可以按照此处的说明训练您自己的HAAR物体探测器。</p>',13),m={href:"https://www.learnopencv.com/training-better-haar-lbp-cascade-eye-detector-opencv",target:"_blank",rel:"noopener noreferrer"},d=i(`<p>人眼检测模型调用代码如下：</p><p>C++:</p><pre><code>// Read image
...
`)],-1),_=e("p",null,"python:",-1),b=e("pre",null,[e("code",null,`import cv2
import numpy as np
...
if __name__ == '__main__' :
    ...
    cv2.waitKey(0)
`)],-1),f=e("h2",{id:"_3-参考",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_3-参考","aria-hidden":"true"},"#"),n(" 3 参考")],-1),k={href:"https://www.learnopencv.com/automatic-red-eye-remover-using-opencv-cpp-python/",target:"_blank",rel:"noopener noreferrer"};function C(x,w){const a=s("ExternalLinkIcon");return r(),l("div",null,[p,e("p",null,[e("a",m,[n(" https://www.learnopencv.com/training-better-haar-lbp-cascade-eye-detector-opencv "),t(a)])]),d,e("p",null,[e("a",h,[n(" https://github.com/luohenyueji/OpenCV-Practical-Exercise "),t(a)])]),g,y,u,_,b,f,e("ul",null,[e("li",null,[e("a",k,[n(" https://www.learnopencv.com/automatic-red-eye-remover-using-opencv-cpp-python/ "),t(a)])])])])}const v=o(c,[["render",C],["__file","2019-05-09-_OpenCV实战_29 使用OpenCV实现红眼自动去除.html.vue"]]);export{v as default};
