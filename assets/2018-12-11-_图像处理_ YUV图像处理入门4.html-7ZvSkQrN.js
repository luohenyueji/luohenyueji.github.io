import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as i,o as r,c as a,a as t,b as o,d as p,e as u}from"./app-MsA2k2kn.js";const s={},l=u(`<h1 id="图像处理-yuv图像处理入门4" tabindex="-1"><a class="header-anchor" href="#图像处理-yuv图像处理入门4" aria-hidden="true">#</a> [图像处理] YUV图像处理入门4</h1><h2 id="_9-yuv420图像截取" tabindex="-1"><a class="header-anchor" href="#_9-yuv420图像截取" aria-hidden="true">#</a> 9 yuv420图像截取</h2><p>本程序中的函数主要是对YUV420P视频数据流的第一帧图像进行截取。类似opencv中的rect函数，函数的代码如下所示：</p><pre><code>/**
 * @file 9 yuv_clip.cpp
 * @author luohen
...
void yuv420_erode(unsigned char *pFrame, unsigned char *pErodeResult, int kernel, int w, int h);
</code></pre><p>腐蚀膨胀的原理和作用见文章；</p>`,29),d={href:"https://blog.csdn.net/qq_25847123/article/details/73744575",target:"_blank",rel:"noopener noreferrer"},h=t("p",null,"简单。这段代码是opencv中dilate和erode函数中的简化版。不同之处是，这段代码所用处理核只能是矩形的。此外对于边缘点，opencv中会用类似深度学习卷积神经网络中的padding操作，在周围填充点；这段代码就忽略边缘的点，直接处理中间的像素点。",-1),c=t("p",null,"代码很简单，通常对yuv图像处理就是读图，分离yuv分量，然后分别对像素点进行处理。",-1),f=t("p",null,"膨胀腐蚀的结果如图所示：",-1),m=t("figure",null,[t("img",{src:"https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/[图像处理] YUV图像处理入门4/20181211183651281.jpg?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0x1b2hlbllK,size_16,color_FFFFFF,t_70",alt:"",tabindex:"0",loading:"lazy"}),t("figcaption")],-1),g=t("figure",null,[t("img",{src:"https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/[图像处理] YUV图像处理入门4/20181211183706205.jpg?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0x1b2hlbllK,size_16,color_FFFFFF,t_70",alt:"",tabindex:"0",loading:"lazy"}),t("figcaption")],-1);function _(w,y){const n=i("ExternalLinkIcon");return r(),a("div",null,[l,t("p",null,[t("a",d,[o(" https://blog.csdn.net/qq_25847123/article/details/73744575"),p(n)])]),h,c,f,m,g])}const b=e(s,[["render",_],["__file","2018-12-11-_图像处理_ YUV图像处理入门4.html.vue"]]);export{b as default};
