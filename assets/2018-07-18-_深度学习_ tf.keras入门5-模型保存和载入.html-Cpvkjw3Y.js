import{_ as n,r as s,o as l,c as o,a as e,b as t,d as i,e as r}from"./app-CMpBw1Ht.js";const c={},d=e("h1",{id:"深度学习-tf-keras入门5-模型保存和载入",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#深度学习-tf-keras入门5-模型保存和载入"},[e("span",null,"[深度学习] tf.keras入门5-模型保存和载入")])],-1),m={href:"https://tensorflow.google.cn/tutorials/keras/save_and_restore_models",target:"_blank",rel:"noopener noreferrer"},_=r(`<h2 id="设置" tabindex="-1"><a class="header-anchor" href="#设置"><span>设置</span></a></h2><p>依赖项设置：</p><blockquote><p>!pip install -q h5py pyyaml</p></blockquote><p>模型建立：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>    from __future__ import absolute_import, division, print_function
