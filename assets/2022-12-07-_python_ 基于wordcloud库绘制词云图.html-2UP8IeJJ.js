import{_ as e,r as p,o,c as i,a as n,b as s,d as t,e as l}from"./app-7i6QNW5x.js";const c={},u=n("h1",{id:"python-基于wordcloud库绘制词云图",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#python-基于wordcloud库绘制词云图"},[n("span",null,"[python] 基于wordcloud库绘制词云图")])],-1),r={href:"https://github.com/amueller/word_cloud",target:"_blank",rel:"noopener noreferrer"},d=l(`<blockquote><p>pip install wordcloud</p></blockquote><p>[toc]</p><h2 id="_0-wordcloud绘图说明" tabindex="-1"><a class="header-anchor" href="#_0-wordcloud绘图说明"><span>0 wordcloud绘图说明</span></a></h2><p>wordcloud库关于绘制词云的相关函数均由其内置类WordCloud提供。</p><p>WordCloud类初始函数如下：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code>WordCloud<span class="token punctuation">(</span>font_path<span class="token operator">=</span><span class="token boolean">None</span><span class="token punctuation">,</span> width<span class="token operator">=</span><span class="token number">400</span><span class="token punctuation">,</span> height<span class="token operator">=</span><span class="token number">200</span><span class="token punctuation">,</span> margin<span class="token operator">=</span><span class="token number">2</span><span class="token punctuation">,</span>
