...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_1-1-2-staticsaliencyfinegrained" tabindex="-1"><a class="header-anchor" href="#_1-1-2-staticsaliencyfinegrained"><span>1.1.2 StaticSaliencyFineGrained</span></a></h4>`,6),C=e("li",null,"原理：该方法基于空间尺度差异center-surround differences计算显著性。利用积分图像integral images.实时生成高分辨率显著性图。",-1),S={href:"https://www.sciencedirect.com/science/article/abs/pii/S0262885609001371",target:"_blank",rel:"noopener noreferrer"},q=e("li",null,"提出时间：2010",-1),x=e("li",null,"检测方式：单张图片检测",-1),O=l(`<p>调用接口如下：</p><p><strong>C++</strong></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>saliencyAlgorithm = StaticSaliencyFineGrained::create();
// 计算显著性
bool success = saliencyAlgorithm-&gt;computeSaliency(image, saliencyMap);
...
# 计算显著性
success, saliencyMap = saliencyAlgorithm.computeSaliency(image)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_1-1-3-objectnessbing" tabindex="-1"><a class="header-anchor" href="#_1-1-3-objectnessbing"><span>1.1.3 ObjectnessBING</span></a></h4>`,6),w=e("li",null,"原理：基于二值化梯度特征(BING features)进行物体检测",-1),M={href:"https://mmcheng.net/bing/",target:"_blank",rel:"noopener noreferrer"},V=e("li",null,"提出时间：2014",-1),j=e("li",null,"检测方式：加载模型，单张图片检测",-1),R=l(`<p>调用接口如下：</p><p><strong>C++</strong></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>saliencyAlgorithm = ObjectnessBING::create();
