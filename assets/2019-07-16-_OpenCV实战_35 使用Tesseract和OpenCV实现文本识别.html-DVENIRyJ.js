...
sudo pip install pytesseract
</code></pre><h3 id="_1-3-在windows下安装tesseract-4-0" tabindex="-1"><a class="header-anchor" href="#_1-3-在windows下安装tesseract-4-0"><span>1.3 在windows下安装Tesseract 4.0</span></a></h3><p>Tesseract本身没有windows的安装包，不过它指定了一个第三方的封装的windows安装包，在其wiki上有说明，大家可直接到这个地址进行下载：</p>`,13),C={href:"https://digi.bib.uni-mannheim.de/tesseract/",target:"_blank",rel:"noopener noreferrer"},w=e("figure",null,[e("img",{src:"https://img2018.cnblogs.com/blog/753333/201810/753333-20181030134114956-498729297.png",alt:"https://img2018.cnblogs.com/blog/753333/201810/753333-20181030134114956-498729297.png",tabindex:"0",loading:"lazy"}),e("figcaption",null,"https://img2018.cnblogs.com/blog/753333/201810/753333-20181030134114956-498729297.png")],-1),f=e("p",null,"其中文件名中带有 dev 的为开发版本，不带 dev 的为稳定版本。",-1),E=e("p",null,"下载后就是一个exe安装包，直接右击安装即可，安装完成之后，配置一下环境变量，编辑 系统变量里面 path，添加下面的安装路径：",-1),y=e("p",null,"C:\\Program Files (x86)\\Tesseract-OCR",-1),x=e("p",null,"具体使用安装见：",-1),v={href:"https://www.cnblogs.com/gl1573/p/9876397.html",target:"_blank",rel:"noopener noreferrer"},S={href:"https://blog.csdn.net/qq_35531549/article/details/95191677",target:"_blank",rel:"noopener noreferrer"},V=a(`<h3 id="_1-4-检查tesseract版本" tabindex="-1"><a class="header-anchor" href="#_1-4-检查tesseract版本"><span>1.4 检查Tesseract版本</span></a></h3><p>要检查前面的步骤中是否一切正常，请在命令行上尝试以下操作</p><pre><code>tesseract –version
...
</code></pre><p>Windows下使用tesseract需要编译后使用，编译教程见：</p>`,25),P={href:"http://www.dengb.com/cjjc/1345780.html",target:"_blank",rel:"noopener noreferrer"},A=e("h3",{id:"_2-4-语言包错误",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_2-4-语言包错误"},[e("span",null,"2.4 语言包错误")])],-1),M=e("p",null,"您可能会遇到错误Error opening data file tessdata/eng.traineddata",-1),k=e("p",null,"它只是意味着语言包（tessdata / eng.traineddata）不在正确的路径中。您可以通过两种方式解决此问题。",-1),L=e("p",null,"1：确保文件位于预期路径中（例如，在linux上，路径为/usr/share/tesseract-ocr/4.00/tessdata/eng.traineddata）。",-1),R=e("p",null,"2：创建目录tessdata，下载eng.traineddata并将文件保存到tessdata/eng.traineddata。然后，您可以指示Tesseract使用查找此目录中的语言包。(这种方法不推荐问题很多)。",-1),N=e("p",null,"如果你想下载新的语言库，下载地址见：",-1),U={href:"https://github.com/tesseract-ocr/tessdata",target:"_blank",rel:"noopener noreferrer"},I=e("h2",{id:"_3-结果与评价",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_3-结果与评价"},[e("span",null,"3 结果与评价")])],-1),j=e("p",null,"Tesseract是一种通用的OCR引擎，但是当我们在普通字体的纯白色背景上使用干净的黑色文本时，它最有效。当文本大致水平且文本高度至少为20像素时，它也可以很好地工作。如果文本具有周围边界，则可以将其检测为一些随机文本。具体使用类似于平常OCR软件。如果能够联网建议使用百度云OCR。",-1),B=e("p",null,"所有代码见：",-1),D={href:"https://github.com/luohenyueji/OpenCV-Practical-Exercise",target:"_blank",rel:"noopener noreferrer"},F=e("p",null,"具体评测见：",-1),z={href:"https://segmentfault.com/a/1190000012861561?utm_source=tag-newest",target:"_blank",rel:"noopener noreferrer"},q=e("p",null,"如果使用tesseract，在实际工程tesseract错误率很高，识别率极差。一般需要对图像进行各种图像处理后再用tesseract识别，最后根据错误类型进行二次识别。tesseract的错误还是具有一定规律的。另外tesseract识别中文效果并不好，你要制作专门的中文训练集通过jTessBoxEditor.jar去训练它，但是整个制作流程较为复杂。具体见：",-1),H={href:"https://github.com/tesseract-ocr/tesseract/wiki/TrainingTesseract-4.00",target:"_blank",rel:"noopener noreferrer"},Y=e("p",null,"tesseract要想有好的识别效果，就必须有大量的训练样本。但是tesseract对英文支持还是不错的。",-1),G=e("h2",{id:"_4-参考",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_4-参考"},[e("span",null,"4 参考")])],-1),Z={href:"https://www.learnopencv.com/deep-learning-based-text-recognition-ocr-using-tesseract-and-opencv/",target:"_blank",rel:"noopener noreferrer"};function X(J,W){const t=c("ExternalLinkIcon");return o(),i("div",null,[p,d,u,h,e("p",null,[e("a",g,[n(" http://colah.github.io/posts/2015-08-Understanding-LSTMs/"),s(t)])]),_,m,T,e("p",null,[e("a",b,[n(" https://github.com/tesseract-ocr/tesseract/wiki"),s(t)])]),O,e("p",null,[e("a",C,[n(" https://digi.bib.uni-mannheim.de/tesseract/ "),s(t)])]),w,f,E,y,x,e("p",null,[e("a",v,[n(" https://www.cnblogs.com/gl1573/p/9876397.html"),s(t)])]),e("p",null,[e("a",S,[n(" https://blog.csdn.net/qq_35531549/article/details/95191677"),s(t)])]),V,e("p",null,[e("a",P,[n(" http://www.dengb.com/cjjc/1345780.html"),s(t)])]),A,M,k,L,R,N,e("p",null,[e("a",U,[n(" https://github.com/tesseract-ocr/tessdata "),s(t)])]),I,j,B,e("p",null,[e("a",D,[n(" https://github.com/luohenyueji/OpenCV-Practical-Exercise "),s(t)])]),F,e("p",null,[e("a",z,[n(" https://segmentfault.com/a/1190000012861561?utm_source=tag-newest"),s(t)])]),q,e("p",null,[e("a",H,[n(" https://github.com/tesseract-ocr/tesseract/wiki/TrainingTesseract-4.00"),s(t)])]),Y,G,e("ul",null,[e("li",null,[e("a",Z,[n(" https://www.learnopencv.com/deep-learning-based-text-recognition-ocr-using-tesseract-and-opencv/ "),s(t)])])])])}const Q=r(l,[["render",X],["__file","2019-07-16-_OpenCV实战_35 使用Tesseract和OpenCV实现文本识别.html.vue"]]),$=JSON.parse('{"path":"/blog/opencv/opencv%E5%AE%9E%E6%88%98/2019-07-16-_OpenCV%E5%AE%9E%E6%88%98_35%20%E4%BD%BF%E7%94%A8Tesseract%E5%92%8COpenCV%E5%AE%9E%E7%8E%B0%E6%96%87%E6%9C%AC%E8%AF%86%E5%88%AB.html","title":"[OpenCV实战]35 使用Tesseract和OpenCV实现文本识别","lang":"zh-CN","frontmatter":{"category":["OpenCV"],"date":"2019-07-16T11:29:04.000Z","tag":["OpenCV实战","OpenCV"],"description":"[OpenCV实战]35 使用Tesseract和OpenCV实现文本识别 在今天的文章中，我们将学习如何使用名为Tesseract和OpenCV的开源工具识别图像中的文本。从图像中提取文本的方法也称为光学字符识别（OCR）或有时简称为文本识别。Tesseract是由Hewlett Packard Labs开发的专有软件。2005年，惠普与内华达拉斯维...","head":[["meta",{"property":"og:url","content":"https://luohenyueji.github.io/blog/opencv/opencv%E5%AE%9E%E6%88%98/2019-07-16-_OpenCV%E5%AE%9E%E6%88%98_35%20%E4%BD%BF%E7%94%A8Tesseract%E5%92%8COpenCV%E5%AE%9E%E7%8E%B0%E6%96%87%E6%9C%AC%E8%AF%86%E5%88%AB.html"}],["meta",{"property":"og:site_name","content":"落痕月极的博客"}],["meta",{"property":"og:title","content":"[OpenCV实战]35 使用Tesseract和OpenCV实现文本识别"}],["meta",{"property":"og:description","content":"[OpenCV实战]35 使用Tesseract和OpenCV实现文本识别 在今天的文章中，我们将学习如何使用名为Tesseract和OpenCV的开源工具识别图像中的文本。从图像中提取文本的方法也称为光学字符识别（OCR）或有时简称为文本识别。Tesseract是由Hewlett Packard Labs开发的专有软件。2005年，惠普与内华达拉斯维..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://img2018.cnblogs.com/blog/753333/201810/753333-20181030134114956-498729297.png"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"name":"twitter:card","content":"summary_large_image"}],["meta",{"name":"twitter:image:alt","content":"[OpenCV实战]35 使用Tesseract和OpenCV实现文本识别"}],["meta",{"property":"article:author","content":"落痕月极"}],["meta",{"property":"article:tag","content":"OpenCV实战"}],["meta",{"property":"article:tag","content":"OpenCV"}],["meta",{"property":"article:published_time","content":"2019-07-16T11:29:04.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"[OpenCV实战]35 使用Tesseract和OpenCV实现文本识别\\",\\"image\\":[\\"https://img2018.cnblogs.com/blog/753333/201810/753333-20181030134114956-498729297.png\\"],\\"datePublished\\":\\"2019-07-16T11:29:04.000Z\\",\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"落痕月极\\",\\"url\\":\\"/\\"}]}"]]},"headers":[{"level":2,"title":"1 如何在Ubuntu和windows上安装Tesseract","slug":"_1-如何在ubuntu和windows上安装tesseract","link":"#_1-如何在ubuntu和windows上安装tesseract","children":[{"level":3,"title":"1.1 在ubuntu18.04上安装Tesseract4","slug":"_1-1-在ubuntu18-04上安装tesseract4","link":"#_1-1-在ubuntu18-04上安装tesseract4","children":[]},{"level":3,"title":"1.2 在Ubuntu 14.04,16.04,17.04,17.10上安装Tesseract 4.0","slug":"_1-2-在ubuntu-14-04-16-04-17-04-17-10上安装tesseract-4-0","link":"#_1-2-在ubuntu-14-04-16-04-17-04-17-10上安装tesseract-4-0","children":[]},{"level":3,"title":"1.3 在windows下安装Tesseract 4.0","slug":"_1-3-在windows下安装tesseract-4-0","link":"#_1-3-在windows下安装tesseract-4-0","children":[]},{"level":3,"title":"1.4 检查Tesseract版本","slug":"_1-4-检查tesseract版本","link":"#_1-4-检查tesseract版本","children":[]}]},{"level":2,"title":"2 Tesseract基本用法","slug":"_2-tesseract基本用法","link":"#_2-tesseract基本用法","children":[{"level":3,"title":"2.1 命令行用法","slug":"_2-1-命令行用法","link":"#_2-1-命令行用法","children":[]},{"level":3,"title":"2.2 使用pytesseract","slug":"_2-2-使用pytesseract","link":"#_2-2-使用pytesseract","children":[]},{"level":3,"title":"2.3 使用C ++ API","slug":"_2-3-使用c-api","link":"#_2-3-使用c-api","children":[]},{"level":3,"title":"2.4 语言包错误","slug":"_2-4-语言包错误","link":"#_2-4-语言包错误","children":[]}]},{"level":2,"title":"3 结果与评价","slug":"_3-结果与评价","link":"#_3-结果与评价","children":[]},{"level":2,"title":"4 参考","slug":"_4-参考","link":"#_4-参考","children":[]}],"git":{},"readingTime":{"minutes":8.23,"words":2468},"filePathRelative":"blog/opencv/opencv实战/2019-07-16-[OpenCV实战]35 使用Tesseract和OpenCV实现文本识别.md","localizedDate":"2019年7月16日","excerpt":"\\n<p>在今天的文章中，我们将学习如何使用名为Tesseract和OpenCV的开源工具识别图像中的文本。从图像中提取文本的方法也称为光学字符识别（OCR）或有时简称为文本识别。Tesseract是由Hewlett Packard Labs开发的专有软件。2005年，惠普与内华达拉斯维加斯大学合作开源。自2006年以来，它一直由谷歌和许多开源贡献者积极开发。</p>\\n<p>当Tesseract开始支持许多图像格式并逐渐添加大量脚本（语言）时，Tesseract在3.x版本中逐渐完善。Tesseract 3.x基于传统的计算机视觉算法。在过去几年中，基于深度学习的方法在计算机视觉的许多领域中在准确性方面已经超越了传统的机器学习技术。手写识别是一个突出的例子。因此，Tesseract也有一个基于深度学习的识别引擎只是时间问题。在Tesseract4版本中，Tesseract实现了基于长短期记忆（LSTM）的识别引擎。LSTM是一种递归神经网络（RNN）。</p>","autoDesc":true}');export{Q as comp,$ as data};
