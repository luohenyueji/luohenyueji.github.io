...
</code></pre><p>请注意，您可以通过第三个参数（CONTOURS_MATCH_I1，CONTOURS_MATCH_I2或CONTOURS_MATCH_I3）使用三种b不同的距离。如果上述距离很小，则两个图像（im1和im2）相似。您可以使用任何距离测量。它们通常产生类似的结果。个人喜欢第二种，因为好计算。</p><p>三种距离具体计算如下：</p><p>1 CONTOURS_MATCH_I1</p><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/[OpenCV实战]10 使用Hu矩进行形状匹配/20190316185220194.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>2 CONTOURS_MATCH_I2</p><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/[OpenCV实战]10 使用Hu矩进行形状匹配/20190316185220198.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>3 CONTOURS_MATCH_I3</p><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/[OpenCV实战]10 使用Hu矩进行形状匹配/20190316191027194.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/[OpenCV实战]10 使用Hu矩进行形状匹配/20190316185220195.png" alt="" loading="lazy"> 是图像A和B之间的距离，<br><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/[OpenCV实战]10 使用Hu矩进行形状匹配/20190316185220206.png" alt="" loading="lazy"> 和 <img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/[OpenCV实战]10 使用Hu矩进行形状匹配/20190316185220197.png" alt="" loading="lazy"> 是图像A和B第i个Hu矩对数转换后的值。</p><p>当我们在图像上使用形状匹配时，如S0与S0,K0和S4，我们得到以下输出：</p><pre><code>S0和S0：0.0

S0和K0：0.10783054664091285

S0和S4：0.008484870268973932
</code></pre><p>如果您想在两个形状之间自定义距离。例如，您可能希望使用由给定的Hu<br> Moments之间的欧几里德距离。首先，如前一节所述，计算对数变换的Hu矩，然后自己计算距离，而不是使用matchShapes。</p><h2 id="_4-代码" tabindex="-1"><a class="header-anchor" href="#_4-代码"><span>4 代码</span></a></h2><p>代码地址：</p><p><a href="https://github.com/luohenyueji/OpenCV-Practical-Exercise" target="_blank" rel="noopener noreferrer"> https://github.com/luohenyueji/OpenCV-Practical-Exercise<br></a></p><p><a href="https://download.csdn.net/download/luohenyj/11026231" target="_blank" rel="noopener noreferrer"> https://download.csdn.net/download/luohenyj/11026231<br></a></p><p>如果没有积分（系统自动设定资源分数）看看参考链接。我搬运过来的，大修改没有。</p><h3 id="_4-1-hu矩计算" tabindex="-1"><a class="header-anchor" href="#_4-1-hu矩计算"><span>4.1 Hu矩计算</span></a></h3><p>C++:</p><pre><code>#include &quot;pch.h&quot;
#include &lt;iostream&gt;
