import{_ as t}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as p,o,c,a as n,b as s,d as e,e as i}from"./app-tQFRrlV7.js";const l={},d=n("h1",{id:"python-基于chardet识别字符编码",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#python-基于chardet识别字符编码","aria-hidden":"true"},"#"),s(" [python] 基于chardet识别字符编码")],-1),u={href:"https://www.runoob.com/w3cnote/charset-encoding.html",target:"_blank",rel:"noopener noreferrer"},r={href:"https://github.com/chardet/chardet",target:"_blank",rel:"noopener noreferrer"},k=i(`<blockquote><p>pip install chardet</p></blockquote><h2 id="_1-使用" tabindex="-1"><a class="header-anchor" href="#_1-使用" aria-hidden="true">#</a> 1 使用</h2><p><strong>基础使用</strong></p><p>chardet提供detect函数接口实现字符编码的自动检测。detect函数接受一个参数，即非Unicode字符串。它返回一个字典，其中包含自动检测到的字符编码和范围为0到1的置信度，还有语言类型。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment"># 导入库</span>
