import{_ as e,r as i,o as r,c as a,a as t,b as o,d as p,e as s}from"./app-CzX2i_WZ.js";const u={},l=s(`<h1 id="图像处理-yuv图像处理入门4" tabindex="-1"><a class="header-anchor" href="#图像处理-yuv图像处理入门4"><span>[图像处理] YUV图像处理入门4</span></a></h1><h2 id="_9-yuv420图像截取" tabindex="-1"><a class="header-anchor" href="#_9-yuv420图像截取"><span>9 yuv420图像截取</span></a></h2><p>本程序中的函数主要是对YUV420P视频数据流的第一帧图像进行截取。类似opencv中的rect函数，函数的代码如下所示：</p><pre><code>/**
 * @file 9 yuv_clip.cpp
 * @author luohen
