import{_ as i,r as p,o as l,c,a as n,b as a,d as e,e as t}from"./app-CxcT-WUR.js";const o={},r=t(`<h1 id="opencv实战-3-透明斗篷" tabindex="-1"><a class="header-anchor" href="#opencv实战-3-透明斗篷"><span>[OpenCV实战]3 透明斗篷</span></a></h1><p>弄出哈利波特电影里一样效果的透明斗篷。也就是一个视频里，将红布弄成透明。类似下面的效果。</p><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/[OpenCV实战]3 透明斗篷/1.gif" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>基本思想如下：</p><p>1寻找和存储背景帧。</p><p>2用颜色检测算法检测红色布。</p><p>3提取红色区域。</p><p>4背景帧红布区域替换当前帧红布区域。</p><h2 id="_1-寻找和存储背景帧" tabindex="-1"><a class="header-anchor" href="#_1-寻找和存储背景帧"><span>1 寻找和存储背景帧</span></a></h2><p>算法关键思想是用背景像素替换与布相对应的当前帧像我们需提取和存储背景帧。背景帧检测算法很简单，实际上算不上背景帧建模算法。仅仅设定视频第31帧为背景图像。如果想了解背景帧提取算法可以看看背景建模算法，比如混合高斯背景建模算法。</p><p>C++代码如下:</p><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>    	Mat background;
    	//跳过前30帧
    	for (int i = 0; i &lt; 30; i++)
    	{
    		cap &gt;&gt; background;
