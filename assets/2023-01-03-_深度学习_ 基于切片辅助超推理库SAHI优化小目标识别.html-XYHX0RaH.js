...
</code></pre><h3 id="_1-1-图像切片" tabindex="-1"><a class="header-anchor" href="#_1-1-图像切片"><span>1.1 图像切片</span></a></h3><p>SAHI提供了封装好的函数接口，以切分输入图像和其标注数据。切分后的子图及其标注数据可以用于识别，或者保存为本地数据以供模型训练。</p><h4 id="_1-1-1-单张图像切片" tabindex="-1"><a class="header-anchor" href="#_1-1-1-单张图像切片"><span>1.1.1 单张图像切片</span></a></h4><p>SAHI提供slice_image函数以切分单张图片及其标注文件（仅支持coco标注文件），slice_image函数接口介绍如下：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token comment">## 返回SAHI的图像分片结果类SliceImageResult</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,8),A={href:"https://github.com/obss/sahi/blob/main/sahi/slicing.py",target:"_blank",rel:"noopener noreferrer"},y=o(`<ol><li><p>获得pillow image图像对象</p></li><li><p>调用get_slice_bboxes函数切分图像</p><ul><li>获得切分参数</li></ul><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">if</span> slice_height <span class="token keyword">and</span> slice_width<span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>循环切分图像</li></ul><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token comment">## 行循环</span>
...
切分子图15张
</code></pre><p><strong>展示切分后的子图</strong></p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">import</span> matplotlib<span class="token punctuation">.</span>pyplot <span class="token keyword">as</span> plt
<span class="token keyword">from</span> PIL <span class="token keyword">import</span> Image
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/CSDN/[深度学习] 基于切片辅助超推理库SAHI优化小目标识别/[深度学习] 基于切片辅助超推理库SAHI优化小目标识别/output_10_0.png" alt="png" tabindex="0" loading="lazy"><figcaption>png</figcaption></figure><h4 id="_1-1-2-coco数据集切片" tabindex="-1"><a class="header-anchor" href="#_1-1-2-coco数据集切片"><span>1.1.2 COCO数据集切片</span></a></h4><p>SAHI提供slice_coco函数以切分coco数据集（仅支持coco数据集）。slice_coco函数接口介绍如下：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token comment">## 返回切片后的coco标注字典文件，coco文件保存地址</span>
<span class="token keyword">def</span> <span class="token function">slice_coco</span><span class="token punctuation">(</span>
    ...
    verbose<span class="token punctuation">:</span> <span class="token builtin">bool</span> <span class="token operator">=</span> <span class="token boolean">False</span><span class="token punctuation">,</span> <span class="token comment">## 是否打印详细信息</span>
<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,14),B={href:"https://github.com/obss/sahi/blob/main/sahi/slicing.py",target:"_blank",rel:"noopener noreferrer"},f=o(`<ol><li>读取coco文件和图片信息</li><li>循环读取coco数据集的图片，每张图片调用get_slice_bboxes函数切分图像</li><li>创建coco dict结果并保存文件</li></ol><p>以下代码演示了对coco数据集进行切片，并将切分后的子图和标注文件保存到本地。coco数据集可以包含若干张图片，但是以下代码示例中只包含一张图片，方便演示。</p><p><strong>展示数据集</strong></p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token comment">## 展示图像</span>
...
切分子图12张
获得标注框18个
</code></pre><p><strong>展示切分后的子图和标注框</strong></p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code>axarr_row <span class="token operator">=</span> <span class="token number">3</span>
...
<span class="token keyword">for</span> index<span class="token punctuation">,</span> img <span class="token keyword">in</span> <span class="token builtin">enumerate</span><span class="token punctuation">(</span>coco_dict<span class="token punctuation">[</span><span class="token string">&#39;images&#39;</span><span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
    ...
    <span class="token keyword">for</span> ann_ind <span class="token keyword">in</span> <span class="token builtin">range</span><span class="token punctuation">(</span><span class="token builtin">len</span><span class="token punctuation">(</span>coco_dict<span class="token punctuation">[</span><span class="token string">&quot;annotations&quot;</span><span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
        ...
        <span class="token keyword">if</span> coco_dict<span class="token punctuation">[</span><span class="token string">&quot;annotations&quot;</span><span class="token punctuation">]</span><span class="token punctuation">[</span>ann_ind<span class="token punctuation">]</span><span class="token punctuation">[</span><span class="token string">&quot;image_id&quot;</span><span class="token punctuation">]</span> <span class="token operator">==</span> coco_dict<span class="token punctuation">[</span><span class="token string">&quot;images&quot;</span><span class="token punctuation">]</span><span class="token punctuation">[</span>index<span class="token punctuation">]</span><span class="token punctuation">[</span><span class="token string">&quot;id&quot;</span><span class="token punctuation">]</span><span class="token punctuation">:</span>
            ...
            ImageDraw<span class="token punctuation">.</span>Draw<span class="token punctuation">(</span>img<span class="token punctuation">,</span> <span class="token string">&#39;RGBA&#39;</span><span class="token punctuation">)</span><span class="token punctuation">.</span>rectangle<span class="token punctuation">(</span>xyxy<span class="token punctuation">,</span> width<span class="token operator">=</span><span class="token number">5</span><span class="token punctuation">)</span>
    axarr<span class="token punctuation">[</span><span class="token builtin">int</span><span class="token punctuation">(</span>index <span class="token operator">/</span> axarr_col<span class="token punctuation">)</span><span class="token punctuation">,</span> <span class="token builtin">int</span><span class="token punctuation">(</span>index <span class="token operator">%</span> axarr_col<span class="token punctuation">)</span><span class="token punctuation">]</span><span class="token punctuation">.</span>imshow<span class="token punctuation">(</span>img<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/CSDN/[深度学习] 基于切片辅助超推理库SAHI优化小目标识别/[深度学习] 基于切片辅助超推理库SAHI优化小目标识别/output_17_0.png" alt="png" tabindex="0" loading="lazy"><figcaption>png</figcaption></figure><h3 id="_1-2-图像预测" tabindex="-1"><a class="header-anchor" href="#_1-2-图像预测"><span>1.2 图像预测</span></a></h3><h4 id="_1-2-1-接口介绍" tabindex="-1"><a class="header-anchor" href="#_1-2-1-接口介绍"><span>1.2.1 接口介绍</span></a></h4><p>SHAI提供了图像切片预测的封装接口，具体的函数接口如下：</p><p><strong>AutoDetectionModel类</strong></p>`,16),x={href:"https://github.com/obss/sahi/tree/main/sahi/models",target:"_blank",rel:"noopener noreferrer"},w=o(`<p><strong>模型预测</strong></p><ul><li><p>基于get_prediction函数调用模型预测单张图片，也就是直接调用AutoDetectionModel类提供的模型，直接推理单张图片。</p></li><li><p>基于get_sliced_prediction函数以切分图片的方式进行预测。在get_sliced_prediction函数内部会先切分图片，然后对每个子图单独进行模型推理；如果设置了对整张原图进行推理，那么也会整合原图推理的结果以增加模型精度。最后对所有的预测结果进行nms整合，相近的两个预测框也会进行合并。get_sliced_prediction函数接口如下：</p></li></ul><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">get_sliced_prediction</span><span class="token punctuation">(</span>
...
<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>基于predict函数进行批处理，predict函数进一步封装了识别代码，如果想使用该函数，阅读predict源代码参数接口即可。</li></ul><h4 id="_1-2-2-应用实例" tabindex="-1"><a class="header-anchor" href="#_1-2-2-应用实例"><span>1.2.2 应用实例</span></a></h4><p><strong>直接预测图片</strong></p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> sahi <span class="token keyword">import</span> AutoDetectionModel
...
</code></pre><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/CSDN/[深度学习] 基于切片辅助超推理库SAHI优化小目标识别/[深度学习] 基于切片辅助超推理库SAHI优化小目标识别/output_24_1.png" alt="png" tabindex="0" loading="lazy"><figcaption>png</figcaption></figure><h3 id="_1-3-sahi工具函数" tabindex="-1"><a class="header-anchor" href="#_1-3-sahi工具函数"><span>1.3 SAHI工具函数</span></a></h3>`,17),q={href:"https://github.com/obss/sahi/blob/main/docs/coco.md",target:"_blank",rel:"noopener noreferrer"},C=o(`<h4 id="_1-3-1-coco数据集制作与精度分析" tabindex="-1"><a class="header-anchor" href="#_1-3-1-coco数据集制作与精度分析"><span>1.3.1 coco数据集制作与精度分析</span></a></h4><p>以下代码创建了coco标注数据，并保存到本地</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> sahi<span class="token punctuation">.</span>utils<span class="token punctuation">.</span><span class="token builtin">file</span> <span class="token keyword">import</span> save_json
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3),I={href:"https://github.com/cocodataset/cocoapi",target:"_blank",rel:"noopener noreferrer"},j=o(`<div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token comment">## 需要单独安装pycocotools</span>
...
</code></pre><p><strong>统计数据集标注信息</strong></p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> sahi<span class="token punctuation">.</span>utils<span class="token punctuation">.</span>coco <span class="token keyword">import</span> Coco
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_1-3-2-coco数据集处理" tabindex="-1"><a class="header-anchor" href="#_1-3-2-coco数据集处理"><span>1.3.2 coco数据集处理</span></a></h4><p><strong>切分数据集</strong></p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> sahi<span class="token punctuation">.</span>utils<span class="token punctuation">.</span>coco <span class="token keyword">import</span> Coco
...
</code></pre><p><strong>修改标注类别</strong></p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> sahi<span class="token punctuation">.</span>utils<span class="token punctuation">.</span>coco <span class="token keyword">import</span> Coco
...
</code></pre><p><strong>按照标注框面积过滤数据集</strong></p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> sahi<span class="token punctuation">.</span>utils<span class="token punctuation">.</span>coco <span class="token keyword">import</span> Coco
<span class="token keyword">from</span> sahi<span class="token punctuation">.</span>utils<span class="token punctuation">.</span><span class="token builtin">file</span> <span class="token keyword">import</span> save_json
...
</code></pre><p><strong>过滤无标注的图片</strong></p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> sahi<span class="token punctuation">.</span>utils<span class="token punctuation">.</span>coco <span class="token keyword">import</span> Coco
<span class="token keyword">from</span> sahi<span class="token punctuation">.</span>utils<span class="token punctuation">.</span><span class="token builtin">file</span> <span class="token keyword">import</span> save_json
...
</code></pre><p><strong>裁剪标注框</strong></p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> sahi<span class="token punctuation">.</span>utils<span class="token punctuation">.</span>coco <span class="token keyword">import</span> Coco
<span class="token keyword">from</span> sahi<span class="token punctuation">.</span>utils<span class="token punctuation">.</span><span class="token builtin">file</span> <span class="token keyword">import</span> save_json
...
</code></pre><p><strong>合并coco数据集</strong></p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token comment">## from sahi.utils.coco import Coco</span>
...
</code></pre><p><strong>上采样数据集</strong></p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> sahi<span class="token punctuation">.</span>utils<span class="token punctuation">.</span>coco <span class="token keyword">import</span> Coco
<span class="token keyword">from</span> sahi<span class="token punctuation">.</span>utils<span class="token punctuation">.</span><span class="token builtin">file</span> <span class="token keyword">import</span> save_json
coco_path <span class="token operator">=</span> <span class="token string">&quot;coco_dataset.json&quot;</span>
...
</code></pre><h4 id="_1-3-3-coco数据集转换" tabindex="-1"><a class="header-anchor" href="#_1-3-3-coco数据集转换"><span>1.3.3 coco数据集转换</span></a></h4><p><strong>导出为yolov5格式并分割数据集</strong></p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> sahi<span class="token punctuation">.</span>utils<span class="token punctuation">.</span>coco <span class="token keyword">import</span> Coco
...
</code></pre><p><strong>将训练集和验证集导出为yolov5格式</strong></p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> sahi<span class="token punctuation">.</span>utils<span class="token punctuation">.</span>coco <span class="token keyword">import</span> Coco<span class="token punctuation">,</span> export_coco_as_yolov5
...
</code></pre><h3 id="_1-4-总结" tabindex="-1"><a class="header-anchor" href="#_1-4-总结"><span>1.4 总结</span></a></h3><p>目标检测过程中，通过对高分辨率小目标图像进行滑动窗口切片，能够有效提高大分辨率小目标图像的识别精度。但是滑动切片识别有需要注意的地方：</p><ul><li>需要图像数据集是否符合通用的高分辨小目标图像标准，如果对普通数据集进行切片识别容易拆分已有目标物体，这样做浪费推理时间也会导致最终检测结果精度不高。</li><li>滑动切片对识别模型的精度有一定的要求，一般来说模型越大精度越高，但是切片识别所花费的推理时间也越长。所以需要平衡模型精度和模型推理时间，而且也要确定滑动切片的尺度。</li><li>滑动切片识别在识别目标类别较少的任务中，识别精度更高，因为后处理能过滤很多重复识别检测框。</li></ul>`,41),S={href:"https://github.com/PaddlePaddle/PaddleDetection/tree/develop/configs/smalldet",target:"_blank",rel:"noopener noreferrer"},D=n("h2",{id:"_2-参考",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_2-参考"},[n("span",null,"2 参考")])],-1),F={href:"https://github.com/obss/sahi",target:"_blank",rel:"noopener noreferrer"},H={href:"https://github.com/obss/sahi/tree/main/demo",target:"_blank",rel:"noopener noreferrer"},N={href:"https://github.com/obss/sahi/tree/main/docs",target:"_blank",rel:"noopener noreferrer"},P={href:"https://arxiv.org/abs/2202.06934",target:"_blank",rel:"noopener noreferrer"},O={href:"https://github.com/obss/sahi/blob/main/sahi/slicing.py",target:"_blank",rel:"noopener noreferrer"},R={href:"https://github.com/obss/sahi/tree/main/sahi/models",target:"_blank",rel:"noopener noreferrer"},L={href:"https://github.com/obss/sahi/blob/main/docs/coco.md",target:"_blank",rel:"noopener noreferrer"},M={href:"https://github.com/cocodataset/cocoapi",target:"_blank",rel:"noopener noreferrer"},T={href:"https://github.com/PaddlePaddle/PaddleDetection/tree/develop/configs/smalldet",target:"_blank",rel:"noopener noreferrer"};function z(U,G){const a=p("ExternalLinkIcon");return c(),i("div",null,[u,r,d,n("p",null,[s("SAHI的官方仓库地址为："),n("a",k,[s("sahi"),t(a)]),s("。关于SAHI的使用可以阅读官方demo和官方文档："),n("a",m,[s("sahi-demo"),t(a)]),s("和"),n("a",v,[s("sahi-docs"),t(a)]),s("。如果想进一步了解SAHI具体工作性能和原理，可以阅读官方发表的论文："),n("a",b,[s("Slicing Aided Hyper Inference and Fine-Tuning for Small Object Detection"),t(a)]),s("。 SAHI安装指令如下：")]),_,g,n("p",null,[s("github: "),n("a",h,[s("Python-Study-Notes"),t(a)])]),E,n("p",null,[s("slice_image函数源代码位于"),n("a",A,[s("sahi/slicing.py"),t(a)]),s("中，这段代码可以单步调试看看怎么运行的，主要逻辑如下：")]),y,n("p",null,[s("slice_coco函数源代码位于"),n("a",B,[s("sahi/slicing.py"),t(a)]),s("中，这段代码可以单步调试看看怎么做的，主要逻辑如下：")]),f,n("p",null,[s("SAHI基于AutoDetectionModel类的from_pretrained函数加载深度学习模型。目前支持YOLOv5 models, MMDetection models, Detectron2 models和HuggingFace object detection models等深度学习模型库，如果想支持新的模型库,可以参考"),n("a",x,[s("sahi/models"),t(a)]),s("目录下的模型文件，新建模型检测类。")]),w,n("p",null,[s("SAHI提供多个工具函数以处理COCO数据集，具体使用可以阅读"),n("a",q,[s("sahi-docs-coco"),t(a)]),s("。")]),C,n("p",null,[s("当我们获得了预测数据，我们可以基于pycocotools工具分析预测数据的精度，pycocotools是目标检测必备工具，官方仓库地址为"),n("a",I,[s("cocoapi"),t(a)]),s("，结果分析代码如下：")]),j,n("p",null,[s("如果想了解其他的小目标识别方案，可以看看paddle家的"),n("a",S,[s("paddledetection-smalldet"),t(a)]),s("。paddle提供了基于原图和基于切图的小目标识别方案，也提供了统计数据集尺寸分布的代码（该统计代码对某些特定的数据集效果不好，具体原因看看代码）。推荐看看PaddleDetection的小目标识别方案，做的很不错。")]),D,n("ul",null,[n("li",null,[n("a",F,[s("sahi"),t(a)])]),n("li",null,[n("a",H,[s("sahi-demo"),t(a)])]),n("li",null,[n("a",N,[s("sahi-docs"),t(a)])]),n("li",null,[n("a",P,[s("Slicing Aided Hyper Inference and Fine-Tuning for Small Object Detection"),t(a)])]),n("li",null,[n("a",O,[s("sahi/slicing.py"),t(a)])]),n("li",null,[n("a",R,[s("sahi/models"),t(a)])]),n("li",null,[n("a",L,[s("sahi-docs-coco"),t(a)])]),n("li",null,[n("a",M,[s("cocoapi"),t(a)])]),n("li",null,[n("a",T,[s("paddledetection-smalldet"),t(a)])])])])}const Y=e(l,[["render",z],["__file","2023-01-03-_深度学习_ 基于切片辅助超推理库SAHI优化小目标识别.html.vue"]]),Z=JSON.parse('{"path":"/blog/%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0/2023-01-03-_%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0_%20%E5%9F%BA%E4%BA%8E%E5%88%87%E7%89%87%E8%BE%85%E5%8A%A9%E8%B6%85%E6%8E%A8%E7%90%86%E5%BA%93SAHI%E4%BC%98%E5%8C%96%E5%B0%8F%E7%9B%AE%E6%A0%87%E8%AF%86%E5%88%AB.html","title":"[深度学习] 基于切片辅助超推理库SAHI优化小目标识别","lang":"zh-CN","frontmatter":{"date":"2023-01-03T20:12:01.000Z","category":["深度学习"],"tag":["深度学习","Python","图像处理"],"description":"[深度学习] 基于切片辅助超推理库SAHI优化小目标识别 对象检测是迄今为止计算机视觉中最重要的应用领域。然而，小物体的检测和大图像的推理仍然是实际使用中的主要问题，这是因为小目标物体有效特征少，覆盖范围少。小目标物体的定义通常有两种方式。一种是绝对尺度定义，即以物体的像素尺寸来判断是否为小目标，如在COCO数据集中，尺寸小于32×32像素的目标被判定...","head":[["meta",{"property":"og:url","content":"https://luohenyueji.github.io/blog/%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0/2023-01-03-_%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0_%20%E5%9F%BA%E4%BA%8E%E5%88%87%E7%89%87%E8%BE%85%E5%8A%A9%E8%B6%85%E6%8E%A8%E7%90%86%E5%BA%93SAHI%E4%BC%98%E5%8C%96%E5%B0%8F%E7%9B%AE%E6%A0%87%E8%AF%86%E5%88%AB.html"}],["meta",{"property":"og:site_name","content":"落痕月极的博客"}],["meta",{"property":"og:title","content":"[深度学习] 基于切片辅助超推理库SAHI优化小目标识别"}],["meta",{"property":"og:description","content":"[深度学习] 基于切片辅助超推理库SAHI优化小目标识别 对象检测是迄今为止计算机视觉中最重要的应用领域。然而，小物体的检测和大图像的推理仍然是实际使用中的主要问题，这是因为小目标物体有效特征少，覆盖范围少。小目标物体的定义通常有两种方式。一种是绝对尺度定义，即以物体的像素尺寸来判断是否为小目标，如在COCO数据集中，尺寸小于32×32像素的目标被判定..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/CSDN/%5B%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%5D%20%E5%9F%BA%E4%BA%8E%E5%88%87%E7%89%87%E8%BE%85%E5%8A%A9%E8%B6%85%E6%8E%A8%E7%90%86%E5%BA%93SAHI%E4%BC%98%E5%8C%96%E5%B0%8F%E7%9B%AE%E6%A0%87%E8%AF%86%E5%88%AB/%5B%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%5D%20%E5%9F%BA%E4%BA%8E%E5%88%87%E7%89%87%E8%BE%85%E5%8A%A9%E8%B6%85%E6%8E%A8%E7%90%86%E5%BA%93SAHI%E4%BC%98%E5%8C%96%E5%B0%8F%E7%9B%AE%E6%A0%87%E8%AF%86%E5%88%AB/image/sliced_inference.gif"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"name":"twitter:card","content":"summary_large_image"}],["meta",{"name":"twitter:image:alt","content":"[深度学习] 基于切片辅助超推理库SAHI优化小目标识别"}],["meta",{"property":"article:author","content":"落痕月极"}],["meta",{"property":"article:tag","content":"深度学习"}],["meta",{"property":"article:tag","content":"Python"}],["meta",{"property":"article:tag","content":"图像处理"}],["meta",{"property":"article:published_time","content":"2023-01-03T20:12:01.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"[深度学习] 基于切片辅助超推理库SAHI优化小目标识别\\",\\"image\\":[\\"https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/CSDN/%5B%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%5D%20%E5%9F%BA%E4%BA%8E%E5%88%87%E7%89%87%E8%BE%85%E5%8A%A9%E8%B6%85%E6%8E%A8%E7%90%86%E5%BA%93SAHI%E4%BC%98%E5%8C%96%E5%B0%8F%E7%9B%AE%E6%A0%87%E8%AF%86%E5%88%AB/%5B%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%5D%20%E5%9F%BA%E4%BA%8E%E5%88%87%E7%89%87%E8%BE%85%E5%8A%A9%E8%B6%85%E6%8E%A8%E7%90%86%E5%BA%93SAHI%E4%BC%98%E5%8C%96%E5%B0%8F%E7%9B%AE%E6%A0%87%E8%AF%86%E5%88%AB/image/sliced_inference.gif\\",\\"https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/CSDN/%5B%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%5D%20%E5%9F%BA%E4%BA%8E%E5%88%87%E7%89%87%E8%BE%85%E5%8A%A9%E8%B6%85%E6%8E%A8%E7%90%86%E5%BA%93SAHI%E4%BC%98%E5%8C%96%E5%B0%8F%E7%9B%AE%E6%A0%87%E8%AF%86%E5%88%AB/%5B%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%5D%20%E5%9F%BA%E4%BA%8E%E5%88%87%E7%89%87%E8%BE%85%E5%8A%A9%E8%B6%85%E6%8E%A8%E7%90%86%E5%BA%93SAHI%E4%BC%98%E5%8C%96%E5%B0%8F%E7%9B%AE%E6%A0%87%E8%AF%86%E5%88%AB/output_6_0.png\\",\\"https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/CSDN/%5B%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%5D%20%E5%9F%BA%E4%BA%8E%E5%88%87%E7%89%87%E8%BE%85%E5%8A%A9%E8%B6%85%E6%8E%A8%E7%90%86%E5%BA%93SAHI%E4%BC%98%E5%8C%96%E5%B0%8F%E7%9B%AE%E6%A0%87%E8%AF%86%E5%88%AB/%5B%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%5D%20%E5%9F%BA%E4%BA%8E%E5%88%87%E7%89%87%E8%BE%85%E5%8A%A9%E8%B6%85%E6%8E%A8%E7%90%86%E5%BA%93SAHI%E4%BC%98%E5%8C%96%E5%B0%8F%E7%9B%AE%E6%A0%87%E8%AF%86%E5%88%AB/output_10_0.png\\",\\"https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/CSDN/%5B%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%5D%20%E5%9F%BA%E4%BA%8E%E5%88%87%E7%89%87%E8%BE%85%E5%8A%A9%E8%B6%85%E6%8E%A8%E7%90%86%E5%BA%93SAHI%E4%BC%98%E5%8C%96%E5%B0%8F%E7%9B%AE%E6%A0%87%E8%AF%86%E5%88%AB/%5B%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%5D%20%E5%9F%BA%E4%BA%8E%E5%88%87%E7%89%87%E8%BE%85%E5%8A%A9%E8%B6%85%E6%8E%A8%E7%90%86%E5%BA%93SAHI%E4%BC%98%E5%8C%96%E5%B0%8F%E7%9B%AE%E6%A0%87%E8%AF%86%E5%88%AB/output_13_1.png\\",\\"https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/CSDN/%5B%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%5D%20%E5%9F%BA%E4%BA%8E%E5%88%87%E7%89%87%E8%BE%85%E5%8A%A9%E8%B6%85%E6%8E%A8%E7%90%86%E5%BA%93SAHI%E4%BC%98%E5%8C%96%E5%B0%8F%E7%9B%AE%E6%A0%87%E8%AF%86%E5%88%AB/%5B%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%5D%20%E5%9F%BA%E4%BA%8E%E5%88%87%E7%89%87%E8%BE%85%E5%8A%A9%E8%B6%85%E6%8E%A8%E7%90%86%E5%BA%93SAHI%E4%BC%98%E5%8C%96%E5%B0%8F%E7%9B%AE%E6%A0%87%E8%AF%86%E5%88%AB/output_17_0.png\\",\\"https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/CSDN/%5B%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%5D%20%E5%9F%BA%E4%BA%8E%E5%88%87%E7%89%87%E8%BE%85%E5%8A%A9%E8%B6%85%E6%8E%A8%E7%90%86%E5%BA%93SAHI%E4%BC%98%E5%8C%96%E5%B0%8F%E7%9B%AE%E6%A0%87%E8%AF%86%E5%88%AB/%5B%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%5D%20%E5%9F%BA%E4%BA%8E%E5%88%87%E7%89%87%E8%BE%85%E5%8A%A9%E8%B6%85%E6%8E%A8%E7%90%86%E5%BA%93SAHI%E4%BC%98%E5%8C%96%E5%B0%8F%E7%9B%AE%E6%A0%87%E8%AF%86%E5%88%AB/output_20_0.png\\",\\"https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/CSDN/%5B%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%5D%20%E5%9F%BA%E4%BA%8E%E5%88%87%E7%89%87%E8%BE%85%E5%8A%A9%E8%B6%85%E6%8E%A8%E7%90%86%E5%BA%93SAHI%E4%BC%98%E5%8C%96%E5%B0%8F%E7%9B%AE%E6%A0%87%E8%AF%86%E5%88%AB/%5B%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%5D%20%E5%9F%BA%E4%BA%8E%E5%88%87%E7%89%87%E8%BE%85%E5%8A%A9%E8%B6%85%E6%8E%A8%E7%90%86%E5%BA%93SAHI%E4%BC%98%E5%8C%96%E5%B0%8F%E7%9B%AE%E6%A0%87%E8%AF%86%E5%88%AB/output_22_1.png\\",\\"https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/CSDN/%5B%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%5D%20%E5%9F%BA%E4%BA%8E%E5%88%87%E7%89%87%E8%BE%85%E5%8A%A9%E8%B6%85%E6%8E%A8%E7%90%86%E5%BA%93SAHI%E4%BC%98%E5%8C%96%E5%B0%8F%E7%9B%AE%E6%A0%87%E8%AF%86%E5%88%AB/%5B%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%5D%20%E5%9F%BA%E4%BA%8E%E5%88%87%E7%89%87%E8%BE%85%E5%8A%A9%E8%B6%85%E6%8E%A8%E7%90%86%E5%BA%93SAHI%E4%BC%98%E5%8C%96%E5%B0%8F%E7%9B%AE%E6%A0%87%E8%AF%86%E5%88%AB/output_24_1.png\\"],\\"datePublished\\":\\"2023-01-03T20:12:01.000Z\\",\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"落痕月极\\",\\"url\\":\\"/\\"}]}"]]},"headers":[{"level":2,"title":"1 SAHI使用","slug":"_1-sahi使用","link":"#_1-sahi使用","children":[{"level":3,"title":"1.1 图像切片","slug":"_1-1-图像切片","link":"#_1-1-图像切片","children":[]},{"level":3,"title":"1.2 图像预测","slug":"_1-2-图像预测","link":"#_1-2-图像预测","children":[]},{"level":3,"title":"1.3 SAHI工具函数","slug":"_1-3-sahi工具函数","link":"#_1-3-sahi工具函数","children":[]},{"level":3,"title":"1.4 总结","slug":"_1-4-总结","link":"#_1-4-总结","children":[]}]},{"level":2,"title":"2 参考","slug":"_2-参考","link":"#_2-参考","children":[]}],"git":{},"readingTime":{"minutes":20.14,"words":6041},"filePathRelative":"blog/深度学习/2023-01-03-[深度学习] 基于切片辅助超推理库SAHI优化小目标识别.md","localizedDate":"2023年1月4日","excerpt":"\\n<p>对象检测是迄今为止计算机视觉中最重要的应用领域。然而，小物体的检测和大图像的推理仍然是实际使用中的主要问题，这是因为小目标物体有效特征少，覆盖范围少。小目标物体的定义通常有两种方式。一种是绝对尺度定义，即以物体的像素尺寸来判断是否为小目标，如在COCO数据集中，尺寸小于32×32像素的目标被判定为小目标。另外一种是相对尺度定义，即以物体在图像中的占比面积比例来判断是否为小目标，例如国际光学工程学会SPIE定义，若目标尺寸小于原图的0.12%则可以判定成小目标。\\nSAHI: Slicing Aided Hyper Inference（切片辅助超推理）通过图像切片的方式来检测小目标。SAHI检测过程可以描述为：通过滑动窗口将图像切分成若干区域，各个区域分别进行预测，同时也对整张图片进行推理。然后将各个区域的预测结果和整张图片的预测结果合并，最后用NMS（非极大值抑制）进行过滤。用动图表示该识别过程如下：</p>","autoDesc":true}');export{Y as comp,Z as data};
