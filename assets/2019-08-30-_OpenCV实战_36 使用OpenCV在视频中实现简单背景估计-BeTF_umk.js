...
</code></pre><h2 id="_4-总结和代码" tabindex="-1"><a class="header-anchor" href="#_4-总结和代码"><span>4 总结和代码</span></a></h2><p>对于本文描述的方法，如文章题目一样简单背景估计，用于做运动检测非常不准确，所选择的中间帧不一定能够完整代表实际环境（如果大部分都是运动的物体就完蛋了）。此外中间帧选取时计算量过大，速度太慢，不推荐使用，运动检测还是老老实实用混合高斯或者vibe。</p><p>本文所有代码见：</p><p><a href="https://github.com/luohenyueji/OpenCV-Practical-Exercise" target="_blank" rel="noopener noreferrer"> https://github.com/luohenyueji/OpenCV-Practical-Exercise<br></a></p><p>具体代码如下：</p><p>C++：</p><pre><code>#include &quot;pch.h&quot;
