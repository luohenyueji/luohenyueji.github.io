import{_ as t,r as p,o as e,c as o,a as n,b as s,d as c,e as i}from"./app-CD_-ggd_.js";const l={},u=n("h1",{id:"python-《python编程快速上手让繁琐工作自动化》学习笔记6",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#python-《python编程快速上手让繁琐工作自动化》学习笔记6"},[n("span",null,"[python]《Python编程快速上手让繁琐工作自动化》学习笔记6")])],-1),r={id:"_1-发送电子邮件和短信笔记-第16章-代码下载",tabindex:"-1"},d={class:"header-anchor",href:"#_1-发送电子邮件和短信笔记-第16章-代码下载"},m={href:"https://github.com/luohenyueji/Python-Study-Notes/tree/master/Automate%20the%20Boring%20Stuff%20with%20Python",target:"_blank",rel:"noopener noreferrer"},k=i(`<h3 id="_1-1-发送电子邮件" tabindex="-1"><a class="header-anchor" href="#_1-1-发送电子邮件"><span>1.1 发送电子邮件</span></a></h3><p>简单邮件传输协议（SMTP）是用于发送电子邮件的协议。SMTP 规定电子邮件应该如何格式化、加密、在邮件服务器之间传递，以及在你点击发送后，计算机要处理的所有其他细节。。但是，你并不需要知道这些技术细节，因为Python 的smtplib 模块将它们简化成几个函数。SMTP只负责向别人发送电子邮件。 SMTP发送邮件主要步骤如下：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">import</span> smtplib
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><p>结果如下所示： <img src="https://imgconvert.csdnimg.cn/aHR0cHM6Ly9naXRlZS5jb20vbHVtaW5pb3VzL2FydGljbGVfcGljdHVyZV93YXJlaG91c2UvcmF3L21hc3Rlci9QeXRob24tU3R1ZHktTm90ZXMvZW1haWwvMTYuMS5qcGc" alt="基础邮件发送" loading="lazy"></p><h4 id="_1-2-2-发送html邮件" tabindex="-1"><a class="header-anchor" href="#_1-2-2-发送html邮件"><span>1.2.2 发送HTML邮件</span></a></h4><p>如果我们要发送HTML邮件，而不是普通的纯文本文件怎么办？方法很简单，在构造MIMEText对象时，把HTML字符串传进去，再把第二个参数由plain变为html就可以了。</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">import</span> smtplib
<span class="token comment"># 设置暗文</span>
<span class="token keyword">import</span> getpass
<span class="token comment"># 设置邮件编码格式</span>
<span class="token keyword">from</span> email<span class="token punctuation">.</span>header <span class="token keyword">import</span> Header
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对于常用的时间模块具体。python设置时间主要time模块和datetime模块。通过import time和import datetime调用time模块和datetime模块。常用函数如下：</p><table><thead><tr><th>函数</th><th>用途</th><th>备注</th></tr></thead><tbody><tr><td>time.time()函数</td><td>返回自Unix纪元时(协调世界时UTC)的秒数</td><td>Unix 纪元时间：1970 年1 月1 日0 点，即协调世界时</td></tr><tr><td>time.sleep(n)</td><td>让程序暂停一下n秒</td><td>按Ctrl-C 不会中断time.sleep()调用</td></tr><tr><td>datetime.datetime.now()</td><td>返回当前的日期和时间</td><td>包含当前时刻的年、月、日、时、分、秒和微秒</td></tr><tr><td>datetime.datetime(2015, 10, 21, 16, 29, 0)</td><td>得到特定时刻的datetime 对象</td><td></td></tr><tr><td>datetime.datetime.fromtimestamp(time)</td><td>将Unix 纪元时间戳转换为datetime对象</td><td></td></tr><tr><td>delta = datetime.timedelta(days=11, hours=10, minutes=9, seconds=8)</td><td>创建timedelta 数据类型表示一段时间</td><td></td></tr><tr><td>delta.days/delta.seconds/delta.microseconds</td><td>获得timedelta对象拥有的总时间以天、秒、微秒来表示</td><td></td></tr><tr><td>delta.total_seconds()</td><td>返回只以秒表示的delta时间</td><td></td></tr><tr><td>strftime()</td><td>将datetime 对象转换为字符串</td><td></td></tr><tr><td>strptime()</td><td>将字符串转换成 datetime 对象</td><td></td></tr></tbody></table><h2 id="_3-参考" tabindex="-1"><a class="header-anchor" href="#_3-参考"><span>3 参考</span></a></h2><ul><li>https://docs.python.org/3/library/email.mime.html</li><li>https://www.runoob.com/python/python-email.html</li><li>https://www.cnblogs.com/zhangxinqi/p/9113859.html</li><li>https://www.liaoxuefeng.com/wiki/1016959663602400/1017790702398272</li><li>https://tools.ietf.org/html/rfc3501.html#section-6.4.4</li></ul>`,33);function v(b,g){const a=p("ExternalLinkIcon");return e(),o("div",null,[u,n("h2",r,[n("a",d,[n("span",null,[s("1. 发送电子邮件和短信笔记（第16章）"),n("a",m,[s("(代码下载)"),c(a)])])])]),k])}const y=t(l,[["render",v],["__file","2019-07-31-_python_《Python编程快速上手让繁琐工作自动化》学习笔记6.html.vue"]]),M=JSON.parse('{"path":"/blog/python/python%E7%BC%96%E7%A8%8B%E5%BF%AB%E9%80%9F%E4%B8%8A%E6%89%8B/2019-07-31-_python_%E3%80%8APython%E7%BC%96%E7%A8%8B%E5%BF%AB%E9%80%9F%E4%B8%8A%E6%89%8B%E8%AE%A9%E7%B9%81%E7%90%90%E5%B7%A5%E4%BD%9C%E8%87%AA%E5%8A%A8%E5%8C%96%E3%80%8B%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B06.html","title":"[python]《Python编程快速上手让繁琐工作自动化》学习笔记6","lang":"zh-CN","frontmatter":{"date":"2019-07-31T18:51:36.000Z","category":["Python"],"tag":["Python"],"description":"[python]《Python编程快速上手让繁琐工作自动化》学习笔记6 1. 发送电子邮件和短信笔记（第16章）(代码下载) 1.1 发送电子邮件 简单邮件传输协议（SMTP）是用于发送电子邮件的协议。SMTP 规定电子邮件应该如何格式化、加密、在邮件服务器之间传递，以及在你点击发送后，计算机要处理的所有其他细节。。但是，你并不需要知道这些技术细节，因...","head":[["meta",{"property":"og:url","content":"https://luohenyueji.github.io/blog/python/python%E7%BC%96%E7%A8%8B%E5%BF%AB%E9%80%9F%E4%B8%8A%E6%89%8B/2019-07-31-_python_%E3%80%8APython%E7%BC%96%E7%A8%8B%E5%BF%AB%E9%80%9F%E4%B8%8A%E6%89%8B%E8%AE%A9%E7%B9%81%E7%90%90%E5%B7%A5%E4%BD%9C%E8%87%AA%E5%8A%A8%E5%8C%96%E3%80%8B%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B06.html"}],["meta",{"property":"og:site_name","content":"落痕月极的博客"}],["meta",{"property":"og:title","content":"[python]《Python编程快速上手让繁琐工作自动化》学习笔记6"}],["meta",{"property":"og:description","content":"[python]《Python编程快速上手让繁琐工作自动化》学习笔记6 1. 发送电子邮件和短信笔记（第16章）(代码下载) 1.1 发送电子邮件 简单邮件传输协议（SMTP）是用于发送电子邮件的协议。SMTP 规定电子邮件应该如何格式化、加密、在邮件服务器之间传递，以及在你点击发送后，计算机要处理的所有其他细节。。但是，你并不需要知道这些技术细节，因..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://imgconvert.csdnimg.cn/aHR0cHM6Ly9naXRlZS5jb20vbHVtaW5pb3VzL2FydGljbGVfcGljdHVyZV93YXJlaG91c2UvcmF3L21hc3Rlci9QeXRob24tU3R1ZHktTm90ZXMvZW1haWwvMTYuMS5qcGc"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"name":"twitter:card","content":"summary_large_image"}],["meta",{"name":"twitter:image:alt","content":"[python]《Python编程快速上手让繁琐工作自动化》学习笔记6"}],["meta",{"property":"article:author","content":"落痕月极"}],["meta",{"property":"article:tag","content":"Python"}],["meta",{"property":"article:published_time","content":"2019-07-31T18:51:36.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"[python]《Python编程快速上手让繁琐工作自动化》学习笔记6\\",\\"image\\":[\\"https://imgconvert.csdnimg.cn/aHR0cHM6Ly9naXRlZS5jb20vbHVtaW5pb3VzL2FydGljbGVfcGljdHVyZV93YXJlaG91c2UvcmF3L21hc3Rlci9QeXRob24tU3R1ZHktTm90ZXMvZW1haWwvMTYuMS5qcGc\\",\\"https://imgconvert.csdnimg.cn/aHR0cHM6Ly9naXRlZS5jb20vbHVtaW5pb3VzL2FydGljbGVfcGljdHVyZV93YXJlaG91c2UvcmF3L21hc3Rlci9QeXRob24tU3R1ZHktTm90ZXMvZW1haWwvMTYuMi5qcGc\\",\\"https://imgconvert.csdnimg.cn/aHR0cHM6Ly9naXRlZS5jb20vbHVtaW5pb3VzL2FydGljbGVfcGljdHVyZV93YXJlaG91c2UvcmF3L21hc3Rlci9QeXRob24tU3R1ZHktTm90ZXMvZW1haWwvMTYuMy5qcGc\\",\\"https://imgconvert.csdnimg.cn/aHR0cHM6Ly9naXRlZS5jb20vbHVtaW5pb3VzL2FydGljbGVfcGljdHVyZV93YXJlaG91c2UvcmF3L21hc3Rlci9QeXRob24tU3R1ZHktTm90ZXMvZW1haWwvMTYuNC5qcGc\\"],\\"datePublished\\":\\"2019-07-31T18:51:36.000Z\\",\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"落痕月极\\",\\"url\\":\\"/\\"}]}"]]},"headers":[{"level":2,"title":"1. 发送电子邮件和短信笔记（第16章）(代码下载)","slug":"_1-发送电子邮件和短信笔记-第16章-代码下载","link":"#_1-发送电子邮件和短信笔记-第16章-代码下载","children":[{"level":3,"title":"1.1 发送电子邮件","slug":"_1-1-发送电子邮件","link":"#_1-1-发送电子邮件","children":[]},{"level":3,"title":"1.2 发送电子邮件具体实例","slug":"_1-2-发送电子邮件具体实例","link":"#_1-2-发送电子邮件具体实例","children":[]}]},{"level":2,"title":"2. 处理电子邮件","slug":"_2-处理电子邮件","link":"#_2-处理电子邮件","children":[]},{"level":2,"title":"3 参考","slug":"_3-参考","link":"#_3-参考","children":[]}],"git":{},"readingTime":{"minutes":8.65,"words":2594},"filePathRelative":"blog/python/python编程快速上手/2019-07-31-[python]《Python编程快速上手让繁琐工作自动化》学习笔记6.md","localizedDate":"2019年8月1日","excerpt":"\\n<h2><a class=\\"header-anchor\\" href=\\"#_1-发送电子邮件和短信笔记-第16章-代码下载\\"><span>1. 发送电子邮件和短信笔记（第16章）</span></a><a href=\\"https://github.com/luohenyueji/Python-Study-Notes/tree/master/Automate%20the%20Boring%20Stuff%20with%20Python\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">(代码下载)</a></h2>\\n<h3>1.1 发送电子邮件</h3>\\n<p>简单邮件传输协议（SMTP）是用于发送电子邮件的协议。SMTP 规定电子邮件应该如何格式化、加密、在邮件服务器之间传递，以及在你点击发送后，计算机要处理的所有其他细节。。但是，你并不需要知道这些技术细节，因为Python 的smtplib 模块将它们简化成几个函数。SMTP只负责向别人发送电子邮件。\\nSMTP发送邮件主要步骤如下：</p>","autoDesc":true}');export{y as comp,M as data};
