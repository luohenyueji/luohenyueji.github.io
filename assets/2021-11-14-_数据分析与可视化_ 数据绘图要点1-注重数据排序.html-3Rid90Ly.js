import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as d,o as r,c as l,a as e,b as n,d as a,e as s}from"./app-tQFRrlV7.js";const o={},c=s(`<h1 id="数据分析与可视化-数据绘图要点1-注重数据排序" tabindex="-1"><a class="header-anchor" href="#数据分析与可视化-数据绘图要点1-注重数据排序" aria-hidden="true">#</a> [数据分析与可视化] 数据绘图要点1-注重数据排序</h1><h2 id="数据绘图要点1-注重数据排序" tabindex="-1"><a class="header-anchor" href="#数据绘图要点1-注重数据排序" aria-hidden="true">#</a> 数据绘图要点1-注重数据排序</h2><p>默认情况下，大多数数据可视化工具将使用字母顺序或使用输入表中的出现顺序对分类变量组进行排序。当显示多个实体项的值时，对它们进行排序会使得图表更具洞察力。</p><h3 id="实例" tabindex="-1"><a class="header-anchor" href="#实例" aria-hidden="true">#</a> 实例</h3><h4 id="无序棒棒糖图" tabindex="-1"><a class="header-anchor" href="#无序棒棒糖图" aria-hidden="true">#</a> 无序棒棒糖图</h4><p>让我们从一个无序棒棒糖图开始，下面代码展示了一些国家出口的某一重要物品的数量。这里每一行代表一个国家，X 轴显示2017 年销售的重要物品数量。默认情况下，国家按字母顺序排列。</p><div class="language-R line-numbers-mode" data-ext="R"><pre class="language-R"><code>
## Libraries
library(tidyverse)
library(hrbrthemes)
library(kableExtra)
