...
l2_model_history = l2_model.fit(train_data, train_labels,
                                ...
                                verbose=2)
</code></pre><h3 id="dropout" tabindex="-1"><a class="header-anchor" href="#dropout"><span>dropout</span></a></h3><p>Dropout将在训练过程中每次更新参数时按一定概率（rate）随机断开输入神经元，使得比例为rate的神经元不被训练。</p><p>具体见： <a href="https://yq.aliyun.com/articles/68901" target="_blank" rel="noopener noreferrer"> https://yq.aliyun.com/articles/68901<br></a></p><pre><code>dpt_model = keras.models.Sequential([
...
dpt_model_history = dpt_model.fit(train_data, train_labels,
                                  ...
                                  validation_data=(test_data, test_labels),
                                  verbose=2)
</code></pre><h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结"><span>总结</span></a></h2><p>常用防止过拟合的方法有：</p><ol><li>增加数据量</li><li>减少网络结构参数</li><li>正则化</li><li>dropout</li><li>数据扩增data-augmentation</li><li>批标准化</li></ol>`,24)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};