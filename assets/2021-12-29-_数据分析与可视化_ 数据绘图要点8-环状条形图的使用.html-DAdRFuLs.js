import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as d,o as l,c as r,a as e,b as a,d as n,e as s}from"./app-kCY7hV_E.js";const o={},u=s(`<h1 id="数据分析与可视化-数据绘图要点8-环状条形图的使用" tabindex="-1"><a class="header-anchor" href="#数据分析与可视化-数据绘图要点8-环状条形图的使用" aria-hidden="true">#</a> [数据分析与可视化] 数据绘图要点8-环状条形图的使用</h1><p>环状条形图RADIAL BAR CHARTS是指用极坐标而不是笛卡尔平面绘制的条形图，RADIAL BAR CHARTS没有规定的中文翻译，有些人翻译为环状条形图，有些人翻译为径向条形图。</p><h2 id="绘图实例" tabindex="-1"><a class="header-anchor" href="#绘图实例" aria-hidden="true">#</a> 绘图实例</h2><p>下图是显示2017年某一商品前6大国家的出口数量。</p><div class="language-R line-numbers-mode" data-ext="R"><pre class="language-R"><code>## 导入库
library(tidyverse)
library(hrbrthemes)
