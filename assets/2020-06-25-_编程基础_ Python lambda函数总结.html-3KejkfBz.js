import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as t,o,c,a as n,b as a,d as p,e as l}from"./app-kCY7hV_E.js";const i={},u=l(`<h1 id="编程基础-python-lambda函数总结" tabindex="-1"><a class="header-anchor" href="#编程基础-python-lambda函数总结" aria-hidden="true">#</a> [编程基础] Python lambda函数总结</h1><p>Python lambda函数教程展示了如何在Python中创建匿名函数。Python中的匿名函数是使用lambda关键字创建的。</p><h2 id="_1-介绍" tabindex="-1"><a class="header-anchor" href="#_1-介绍" aria-hidden="true">#</a> 1 介绍</h2><p>Python lambda函数也称为匿名函数，是没有名称的内联函数。它们是用lambda关键字创建的。这是内置Python的函数范型的一部分。 Python lambda函数仅限于一个表达式。它们可以在任何可以使用正常功能的地方使用。</p><p>Python lambda具有以下语法：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>z = lambda x: x * y
