...
sudo pip install pytesseract
</code></pre><h3 id="_1-3-在windows下安装tesseract-4-0" tabindex="-1"><a class="header-anchor" href="#_1-3-在windows下安装tesseract-4-0"><span>1.3 在windows下安装Tesseract 4.0</span></a></h3><p>Tesseract本身没有windows的安装包，不过它指定了一个第三方的封装的windows安装包，在其wiki上有说明，大家可直接到这个地址进行下载：</p><p><a href="https://digi.bib.uni-mannheim.de/tesseract/" target="_blank" rel="noopener noreferrer"> https://digi.bib.uni-mannheim.de/tesseract/ </a></p><figure><img src="https://img2018.cnblogs.com/blog/753333/201810/753333-20181030134114956-498729297.png" alt="https://img2018.cnblogs.com/blog/753333/201810/753333-20181030134114956-498729297.png" tabindex="0" loading="lazy"><figcaption><a href="https://img2018.cnblogs.com/blog/753333/201810/753333-20181030134114956-498729297.png" target="_blank" rel="noopener noreferrer">https://img2018.cnblogs.com/blog/753333/201810/753333-20181030134114956-498729297.png</a></figcaption></figure><p>其中文件名中带有 dev 的为开发版本，不带 dev 的为稳定版本。</p><p>下载后就是一个exe安装包，直接右击安装即可，安装完成之后，配置一下环境变量，编辑 系统变量里面 path，添加下面的安装路径：</p><p>C:\\Program Files (x86)\\Tesseract-OCR</p><p>具体使用安装见：</p><p><a href="https://www.cnblogs.com/gl1573/p/9876397.html" target="_blank" rel="noopener noreferrer"> https://www.cnblogs.com/gl1573/p/9876397.html</a></p><p><a href="https://blog.csdn.net/qq_35531549/article/details/95191677" target="_blank" rel="noopener noreferrer"> https://blog.csdn.net/qq_35531549/article/details/95191677</a></p><h3 id="_1-4-检查tesseract版本" tabindex="-1"><a class="header-anchor" href="#_1-4-检查tesseract版本"><span>1.4 检查Tesseract版本</span></a></h3><p>要检查前面的步骤中是否一切正常，请在命令行上尝试以下操作</p><pre><code>tesseract –version
...
</code></pre><h3 id="_2-2-使用pytesseract" tabindex="-1"><a class="header-anchor" href="#_2-2-使用pytesseract"><span>2.2 使用pytesseract</span></a></h3><p>在Python中，我们使用pytesseract模块。它只是命令行工具的包装器，其中使用config参数指定了命令行选项。基本使用要求我们先阅读使用OpenCV的图像，并通过图像image_to_string的pytesseract类的方法与语言（ENG）一起。Pytesseract通过pip<br> install Pytesseract就可以安装。详细使用代码见：</p><pre><code>import cv2
import pytesseract
...
</code></pre><p>Windows下使用tesseract需要编译后使用，编译教程见：</p><p><a href="http://www.dengb.com/cjjc/1345780.html" target="_blank" rel="noopener noreferrer"> http://www.dengb.com/cjjc/1345780.html</a></p><h3 id="_2-4-语言包错误" tabindex="-1"><a class="header-anchor" href="#_2-4-语言包错误"><span>2.4 语言包错误</span></a></h3><p>您可能会遇到错误Error opening data file tessdata/eng.traineddata</p><p>它只是意味着语言包（tessdata / eng.traineddata）不在正确的路径中。您可以通过两种方式解决此问题。</p><p>1：确保文件位于预期路径中（例如，在linux上，路径为/usr/share/tesseract-ocr/4.00/tessdata/eng.traineddata）。</p><p>2：创建目录tessdata，下载eng.traineddata并将文件保存到tessdata/eng.traineddata。然后，您可以指示Tesseract使用查找此目录中的语言包。(这种方法不推荐问题很多)。</p><p>如果你想下载新的语言库，下载地址见：</p><p><a href="https://github.com/tesseract-ocr/tessdata" target="_blank" rel="noopener noreferrer"> https://github.com/tesseract-ocr/tessdata </a></p><h2 id="_3-结果与评价" tabindex="-1"><a class="header-anchor" href="#_3-结果与评价"><span>3 结果与评价</span></a></h2><p>Tesseract是一种通用的OCR引擎，但是当我们在普通字体的纯白色背景上使用干净的黑色文本时，它最有效。当文本大致水平且文本高度至少为20像素时，它也可以很好地工作。如果文本具有周围边界，则可以将其检测为一些随机文本。具体使用类似于平常OCR软件。如果能够联网建议使用百度云OCR。</p><p>所有代码见：</p><p><a href="https://github.com/luohenyueji/OpenCV-Practical-Exercise" target="_blank" rel="noopener noreferrer"> https://github.com/luohenyueji/OpenCV-Practical-Exercise<br></a></p><p>具体评测见：</p><p><a href="https://segmentfault.com/a/1190000012861561?utm_source=tag-newest" target="_blank" rel="noopener noreferrer"> https://segmentfault.com/a/1190000012861561?utm_source=tag-newest</a></p><p>如果使用tesseract，在实际工程tesseract错误率很高，识别率极差。一般需要对图像进行各种图像处理后再用tesseract识别，最后根据错误类型进行二次识别。tesseract的错误还是具有一定规律的。另外tesseract识别中文效果并不好，你要制作专门的中文训练集通过jTessBoxEditor.jar去训练它，但是整个制作流程较为复杂。具体见：</p><p><a href="https://github.com/tesseract-ocr/tesseract/wiki/TrainingTesseract-4.00" target="_blank" rel="noopener noreferrer"> https://github.com/tesseract-ocr/tesseract/wiki/TrainingTesseract-4.00</a></p><p>tesseract要想有好的识别效果，就必须有大量的训练样本。但是tesseract对英文支持还是不错的。</p><h2 id="_4-参考" tabindex="-1"><a class="header-anchor" href="#_4-参考"><span>4 参考</span></a></h2><ul><li><a href="https://www.learnopencv.com/deep-learning-based-text-recognition-ocr-using-tesseract-and-opencv/" target="_blank" rel="noopener noreferrer"> https://www.learnopencv.com/deep-learning-based-text-recognition-ocr-using-tesseract-and-opencv/ </a></li></ul>`,74)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};