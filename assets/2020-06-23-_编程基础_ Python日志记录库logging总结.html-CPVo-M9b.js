import{_ as i,r as l,o,c as p,a as n,b as a,d as e,e as t}from"./app-Bf4gfzXW.js";const c={},u=t(`<h1 id="编程基础-python日志记录库logging总结" tabindex="-1"><a class="header-anchor" href="#编程基础-python日志记录库logging总结"><span>[编程基础] Python日志记录库logging总结</span></a></h1><p>Python日志记录教程展示了如何使用日志记录模块在Python中进行日志记录。</p><h2 id="_1-介绍" tabindex="-1"><a class="header-anchor" href="#_1-介绍"><span>1 介绍</span></a></h2><h3 id="_1-1-背景" tabindex="-1"><a class="header-anchor" href="#_1-1-背景"><span>1.1 背景</span></a></h3><p>日志记录是将信息写入日志文件的过程。日志文件包含有关在操作系统，软件或通信中发生的各种事件的信息。完成记录是出于以下目的：</p><ul><li>信息收集</li><li>故障排除</li><li>产生统计资料</li><li>审计</li><li>剖析</li></ul><p>记录不仅限于识别软件开发中的错误。它还可用于检测安全事件，监视策略违规，在出现问题时提供信息，查找应用程序瓶颈或生成使用情况数据。应记录的事件包括输入验证失败，身份验证和授权失败，应用程序错误，配置更改以及应用程序启动和关闭。 但是不应记录的事件包括应用程序源代码，会话标识值，访问令牌，敏感的个人数据，密码，数据库连接字符串，加密密钥，银行帐户和持卡人数据。 综上所述，进行日志记录的一些最佳做法：</p><ul><li>日志记录应该有意义。</li><li>日志应包含上下文。</li><li>日志记录应在不同级别进行结构化和完成。</li><li>日志记录应该是平衡的；它不应该包含太少或太多的信息。</li><li>记录消息应该是人类可以理解的，并且可以被机器解析。</li><li>登录更复杂的应用程序应完成几个日志文件。</li><li>日志应适应开发和生产。</li></ul><h3 id="_1-2-python日志记录模块" tabindex="-1"><a class="header-anchor" href="#_1-2-python日志记录模块"><span>1.2 Python日志记录模块</span></a></h3><p>Python日志模块定义了一些函数和类，这些函数和类为应用程序和库实现了一个灵活的事件日志系统。 日志记录模块具有四个主要组件：记录器（loggers），处理程序（handlers），过滤器（filters）和格式化程序（formatters）。记录器公开了应用程序代码直接使用的接口。处理程序将日志记录（由记录器创建）发送到适当的目的地。筛选器提供了更细粒度的功能，用于确定要输出的日志记录。格式化程序在最终输出中指定日志记录的布局。 Python日志记录级别主要有以下六个：</p><ul><li>CRITICAL 危急</li><li>ERROR 错误</li><li>WARNING 警告</li><li>INFO 信息</li><li>DEBUG 调试</li><li>NOTSET 无设置</li></ul><p>要注意日志等级是从上到下依次降低的，即：NOTEST&lt; DEBUG &lt; INFO &lt; WARNING &lt; ERROR &lt; CRITICAL，而日志的信息量是依次减少的； 如果日志记录级别设置为WARNING，所有的WARNING， ERROR以及CRITICAL消息被写入日志文件或控制台。如果它被设置为ERROR，只有ERROR和 CRITICAL消息被记录。</p><p>日志记录器具有有效等级的概念。如果未在记录器上显式设置级别，则将其父级别用作其有效级别。如果父级没有显式设置的级别，则检查其父级，依此类推-搜索所有祖先，直到找到显式设置的级别。使用getLogger()创建记录器时，级别设置为NOTSET。如果未使用set level()显式设置日志记录级别，则消息将传播到日志记录父级。在找到级别不是NOTSET的祖先或到达根记录器之前，将遍历日志记录器的祖先链。根记录器设置了默认警告级别。</p><h3 id="_1-3-根记录器" tabindex="-1"><a class="header-anchor" href="#_1-3-根记录器"><span>1.3 根记录器</span></a></h3><p>所有记录器都是根记录器的后代。每个记录器将日志消息传递到其父级。使用该getLogger(name) 方法创建新的记录器。调用不带名称的函数（getLogger()）将返回root记录器。根记录器始终具有显式级别集，WARNING 默认情况下为该级别。 根记录器位于层次结构的顶部，并且始终存在，即使未配置。通常，程序或库不应直接针对根日志记录器进行日志记录。相反，应该为程序配置一个特定的记录器。根日志可以用来轻松地打开和关闭所有库中的所有日志。</p><h2 id="_2-python-logging模块使用教程" tabindex="-1"><a class="header-anchor" href="#_2-python-logging模块使用教程"><span>2 Python logging模块使用教程</span></a></h2><p>python logging模块通常可以直接调用，无需安装</p><h3 id="_2-1-python-logging模块简单使用" tabindex="-1"><a class="header-anchor" href="#_2-1-python-logging模块简单使用"><span>2.1 Python logging模块简单使用</span></a></h3><p>该logging模块具有简单的方法，无需任何配置即可立即使用。这可以用于简单的日志记录。以下示例调用该logging模块的五个方法。消息将写入控制台。请注意，使用了根记录器，并且只写入了三则消息。这是因为默认情况下，仅写入具有级别警告和更高级别的消息。</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">import</span> logging
...
30
</code></pre><h3 id="_2-4-python记录处理程序" tabindex="-1"><a class="header-anchor" href="#_2-4-python记录处理程序"><span>2.4 Python记录处理程序</span></a></h3><p>处理程序是一个对象，负责将适当的日志消息（基于日志消息的严重性）分派到处理程序的指定目标。处理程序像级别一样设定。如果记录器没有处理程序集，则其父记录器将搜索处理程序。</p><p>以下示例为记录器创建了两个处理程序：文件处理程序和控制台处理程序。</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">import</span> logging
...
</code></pre><p>注意上面的程序在添加到记录器必须移除处理程序（这是这个大坑），不然会重复输出，因为会把当前logger和其父节点所有数据输出，如下所示：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">import</span> logging
...
information message
INFO:dev:information message
</code></pre><h3 id="_2-5-python记录格式化程序" tabindex="-1"><a class="header-anchor" href="#_2-5-python记录格式化程序"><span>2.5 Python记录格式化程序</span></a></h3><p>格式化程序是配置日志记录的最终顺序、结构和内容的对象。除了消息字符串之外，日志记录还包括日期和时间、日志名称和日志级别的严重性。下面示例创建一个控制台记录器，并向其处理程序添加格式化程序。</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">import</span> logging
...
ERROR:root:This is an error message
CRITICAL:root:This is a critical message
</code></pre><h3 id="_2-7-python日志记录文件配置" tabindex="-1"><a class="header-anchor" href="#_2-7-python日志记录文件配置"><span>2.7 Python日志记录文件配置</span></a></h3><p>fileConfig()从configparser格式文件读取日志配置。本文在log.conf定义了一个记录器，处理程序和格式化。</p><p>log.conf文件内容如下：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>[loggers]
keys=root,dev
...
</code></pre><h3 id="_2-8-python日志记录变量" tabindex="-1"><a class="header-anchor" href="#_2-8-python日志记录变量"><span>2.8 Python日志记录变量</span></a></h3><p>通过使用字符串格式记录动态数据。以下示例将自定义数据写入日志消息。</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">import</span> logging
...
</code></pre><h3 id="_2-9-python日志记录格式日期时间" tabindex="-1"><a class="header-anchor" href="#_2-9-python日志记录格式日期时间"><span>2.9 Python日志记录格式日期时间</span></a></h3><p>日期时间包含在带有asctime日志记录的日志消息中。使用datefmt配置选项，我们可以格式化datetime字符串。以下示例为格式化日志消息的日期时间。</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">import</span> logging
...
</code></pre><h3 id="_2-11-python记录getlogger" tabindex="-1"><a class="header-anchor" href="#_2-11-python记录getlogger"><span>2.11 Python记录getLogger</span></a></h3><p>在getLogger()返回具有指定名称的记录器。如果未指定名称，则返回根记录器。通常的做法是将模块名称放在其中。</p><p>使用给定名称对此函数的所有调用都返回相同的记录器实例。这意味着记录器实例不需要在应用程序的不同部分之间传递（这一点很坑）。</p><p>以下示例使用getLogger()创建一个新的记录器。它有一个文件处理程序和一个格式化程序</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">import</span> logging
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>my.log中内容如下：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>2020-06-23 22:54:41,265  main    INFO: info message
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-参考" tabindex="-1"><a class="header-anchor" href="#_3-参考"><span>3 参考</span></a></h2>`,38),v={href:"http://zetcode.com/python/logging/",target:"_blank",rel:"noopener noreferrer"},m={href:"https://www.cnblogs.com/telecomshy/p/10630888.html",target:"_blank",rel:"noopener noreferrer"},k={href:"https://blog.csdn.net/huilan_same/article/details/51858817",target:"_blank",rel:"noopener noreferrer"};function h(b,y){const s=l("ExternalLinkIcon");return o(),p("div",null,[u,n("blockquote",null,[n("p",null,[n("a",r,[a("https://www.cnblogs.com/telecomshy/p/10630888.html"),e(s)])])]),n("blockquote",null,[n("p",null,[n("a",d,[a("https://blog.csdn.net/huilan_same/article/details/51858817"),e(s)])])]),g,n("blockquote",null,[n("p",null,[n("a",v,[a("http://zetcode.com/python/logging/"),e(s)])])]),n("blockquote",null,[n("p",null,[n("a",m,[a("https://www.cnblogs.com/telecomshy/p/10630888.html"),e(s)])])]),n("blockquote",null,[n("p",null,[n("a",k,[a("https://blog.csdn.net/huilan_same/article/details/51858817"),e(s)])])])])}const _=i(c,[["render",h],["__file","2020-06-23-_编程基础_ Python日志记录库logging总结.html.vue"]]),E=JSON.parse('{"path":"/blog/%E7%BC%96%E7%A8%8B%E5%9F%BA%E7%A1%80/%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/2020-06-23-_%E7%BC%96%E7%A8%8B%E5%9F%BA%E7%A1%80_%20Python%E6%97%A5%E5%BF%97%E8%AE%B0%E5%BD%95%E5%BA%93logging%E6%80%BB%E7%BB%93.html","title":"[编程基础] Python日志记录库logging总结","lang":"zh-CN","frontmatter":{"date":"2020-06-23T23:02:04.000Z","category":["编程基础"],"tag":["编程基础","Python"],"description":"[编程基础] Python日志记录库logging总结 Python日志记录教程展示了如何使用日志记录模块在Python中进行日志记录。 1 介绍 1.1 背景 日志记录是将信息写入日志文件的过程。日志文件包含有关在操作系统，软件或通信中发生的各种事件的信息。完成记录是出于以下目的： 信息收集 故障排除 产生统计资料 审计 剖析 记录不仅限于识别软件开...","head":[["meta",{"property":"og:url","content":"https://luohenyueji.github.io/blog/%E7%BC%96%E7%A8%8B%E5%9F%BA%E7%A1%80/%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/2020-06-23-_%E7%BC%96%E7%A8%8B%E5%9F%BA%E7%A1%80_%20Python%E6%97%A5%E5%BF%97%E8%AE%B0%E5%BD%95%E5%BA%93logging%E6%80%BB%E7%BB%93.html"}],["meta",{"property":"og:site_name","content":"落痕月极的博客"}],["meta",{"property":"og:title","content":"[编程基础] Python日志记录库logging总结"}],["meta",{"property":"og:description","content":"[编程基础] Python日志记录库logging总结 Python日志记录教程展示了如何使用日志记录模块在Python中进行日志记录。 1 介绍 1.1 背景 日志记录是将信息写入日志文件的过程。日志文件包含有关在操作系统，软件或通信中发生的各种事件的信息。完成记录是出于以下目的： 信息收集 故障排除 产生统计资料 审计 剖析 记录不仅限于识别软件开..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"article:author","content":"落痕月极"}],["meta",{"property":"article:tag","content":"编程基础"}],["meta",{"property":"article:tag","content":"Python"}],["meta",{"property":"article:published_time","content":"2020-06-23T23:02:04.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"[编程基础] Python日志记录库logging总结\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2020-06-23T23:02:04.000Z\\",\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"落痕月极\\",\\"url\\":\\"/\\"}]}"]]},"headers":[{"level":2,"title":"1 介绍","slug":"_1-介绍","link":"#_1-介绍","children":[{"level":3,"title":"1.1 背景","slug":"_1-1-背景","link":"#_1-1-背景","children":[]},{"level":3,"title":"1.2 Python日志记录模块","slug":"_1-2-python日志记录模块","link":"#_1-2-python日志记录模块","children":[]},{"level":3,"title":"1.3 根记录器","slug":"_1-3-根记录器","link":"#_1-3-根记录器","children":[]}]},{"level":2,"title":"2 Python logging模块使用教程","slug":"_2-python-logging模块使用教程","link":"#_2-python-logging模块使用教程","children":[{"level":3,"title":"2.1 Python logging模块简单使用","slug":"_2-1-python-logging模块简单使用","link":"#_2-1-python-logging模块简单使用","children":[]},{"level":3,"title":"2.2 Python有效日志记录级别","slug":"_2-2-python有效日志记录级别","link":"#_2-2-python有效日志记录级别","children":[]},{"level":3,"title":"2.3 Python有效日志记录级别","slug":"_2-3-python有效日志记录级别","link":"#_2-3-python有效日志记录级别","children":[]},{"level":3,"title":"2.4 Python记录处理程序","slug":"_2-4-python记录处理程序","link":"#_2-4-python记录处理程序","children":[]},{"level":3,"title":"2.5 Python记录格式化程序","slug":"_2-5-python记录格式化程序","link":"#_2-5-python记录格式化程序","children":[]},{"level":3,"title":"2.6 Python日志基本配置","slug":"_2-6-python日志基本配置","link":"#_2-6-python日志基本配置","children":[]},{"level":3,"title":"2.7 Python日志记录文件配置","slug":"_2-7-python日志记录文件配置","link":"#_2-7-python日志记录文件配置","children":[]},{"level":3,"title":"2.8 Python日志记录变量","slug":"_2-8-python日志记录变量","link":"#_2-8-python日志记录变量","children":[]},{"level":3,"title":"2.9 Python日志记录格式日期时间","slug":"_2-9-python日志记录格式日期时间","link":"#_2-9-python日志记录格式日期时间","children":[]},{"level":3,"title":"2.10 Python日志记录堆栈跟踪","slug":"_2-10-python日志记录堆栈跟踪","link":"#_2-10-python日志记录堆栈跟踪","children":[]},{"level":3,"title":"2.11 Python记录getLogger","slug":"_2-11-python记录getlogger","link":"#_2-11-python记录getlogger","children":[]}]},{"level":2,"title":"3 参考","slug":"_3-参考","link":"#_3-参考","children":[]}],"git":{},"readingTime":{"minutes":11.07,"words":3321},"filePathRelative":"blog/编程基础/学习笔记/2020-06-23-[编程基础] Python日志记录库logging总结.md","localizedDate":"2020年6月24日","excerpt":"\\n<p>Python日志记录教程展示了如何使用日志记录模块在Python中进行日志记录。</p>\\n<h2>1 介绍</h2>\\n<h3>1.1 背景</h3>\\n<p>日志记录是将信息写入日志文件的过程。日志文件包含有关在操作系统，软件或通信中发生的各种事件的信息。完成记录是出于以下目的：</p>\\n<ul>\\n<li>信息收集</li>\\n<li>故障排除</li>\\n<li>产生统计资料</li>\\n<li>审计</li>\\n<li>剖析</li>\\n</ul>\\n<p>记录不仅限于识别软件开发中的错误。它还可用于检测安全事件，监视策略违规，在出现问题时提供信息，查找应用程序瓶颈或生成使用情况数据。应记录的事件包括输入验证失败，身份验证和授权失败，应用程序错误，配置更改以及应用程序启动和关闭。\\n但是不应记录的事件包括应用程序源代码，会话标识值，访问令牌，敏感的个人数据，密码，数据库连接字符串，加密密钥，银行帐户和持卡人数据。\\n综上所述，进行日志记录的一些最佳做法：</p>","autoDesc":true}');export{_ as comp,E as data};
