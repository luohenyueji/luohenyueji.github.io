...
</code></pre><p>您可以创建模型pcaParams.yml使用createPCAModel.cpp和createPCAModel.py。该代码使用CelebA数据集的前1000个图像，并将它们首先缩放到一半大小。所以这个PCA模型是在大小（89x109）的图像上训练的。除了1000张图像之外，代码还使用了原始图像的垂直翻转版本，因此我们使用2000张图像进行训练。。但是createPCAModel文件里面没有reisze函数，要自己缩放为89X109分辨率。生成了pcaParams.yml文件，再通过reconstructFace获取人脸。</p><p>本文所有代码包括createPCAModel文件见：</p>`,38),u={href:"https://github.com/luohenyueji/OpenCV-Practical-Exercise",target:"_blank",rel:"noopener noreferrer"},p=e("p",null,"但是图像没有列出，从CelebA数据集下载",-1),m={href:"http://mmlab.ie.cuhk.edu.hk/projects/CelebA.html",target:"_blank",rel:"noopener noreferrer"},d=e("h2",{id:"_3-参考",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_3-参考","aria-hidden":"true"},"#"),t(" 3 参考")],-1),h={href:"https://www.learnopencv.com/face-reconstruction-using-eigenfaces-cpp-python/",target:"_blank",rel:"noopener noreferrer"};function f(_,F){const n=o("ExternalLinkIcon");return r(),s("div",null,[l,e("p",null,[e("a",u,[t(" https://github.com/luohenyueji/OpenCV-Practical-Exercise"),a(n)])]),p,e("p",null,[e("a",m,[t(" http://mmlab.ie.cuhk.edu.hk/projects/CelebA.html "),a(n)])]),d,e("ul",null,[e("li",null,[e("a",h,[t(" https://www.learnopencv.com/face-reconstruction-using-eigenfaces-cpp-python/"),a(n)])])])])}const E=i(g,[["render",f],["__file","2019-04-24-_OpenCV实战_22 使用EigenFaces进行人脸重建.html.vue"]]);export{E as default};
