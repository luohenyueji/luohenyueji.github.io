import{_ as e,c as l,a as n,d,f as a,b as t,o as p,r}from"./app-BNuIUq7T.js";const c={};function v(u,s){const i=r("VPIcon");return p(),l("div",null,[s[2]||(s[2]=n(`<h1 id="编程基础-c-多线程入门3-小心地将参数传递给线程" tabindex="-1"><a class="header-anchor" href="#编程基础-c-多线程入门3-小心地将参数传递给线程"><span>[编程基础] C++多线程入门3-小心地将参数传递给线程</span></a></h1><p>原始C++标准仅支持单线程编程。新的C++标准(称为c++11或c++0x)于2011年发布。在c++11中，引入了新的线程库。因此运行本文程序需要C++至少符合c++11标准。</p><h2 id="_3-小心地将参数传递给线程" tabindex="-1"><a class="header-anchor" href="#_3-小心地将参数传递给线程"><span>3 小心地将参数传递给线程</span></a></h2><p>要将参数传递给线程的关联可调用对象或函数，只需将其他参数传递给std::thread构造函数。默认情况下，所有参数都复制到新线程的内部存储中。让我们看一个例子：</p><h3 id="_3-1-在c-11中将简单参数传递给std-thread" tabindex="-1"><a class="header-anchor" href="#_3-1-在c-11中将简单参数传递给std-thread"><span>3.1 在c++11中将简单参数传递给std::thread</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>#include &lt;iostream&gt;</span></span>
