import{_ as e,r as o,o as c,c as i,a as n,b as s,d as t,e as p}from"./app-CD_-ggd_.js";const l={},u=n("h1",{id:"深度学习-pytorch模型转换为onnx模型笔记",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#深度学习-pytorch模型转换为onnx模型笔记"},[n("span",null,"[深度学习] Pytorch模型转换为onnx模型笔记")])],-1),r={href:"https://github.com/luohenyueji/Python-Study-Notes/blob/master/Documents",target:"_blank",rel:"noopener noreferrer"},d=p(`<h2 id="_1-使用说明" tabindex="-1"><a class="header-anchor" href="#_1-使用说明"><span>1 使用说明</span></a></h2><p>本文示例为调用pytorch预训练的mobilenetv2模型，将其导出为onnx模型。主要步骤如下：</p><ol><li>读取模型</li><li>检测图像</li><li>导出为onnx模型</li><li>模型测试</li><li>模型简化</li></ol><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token comment">## 需要调用的头文件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-1-读取模型" tabindex="-1"><a class="header-anchor" href="#_1-1-读取模型"><span>1.1 读取模型</span></a></h3><p>该部分主要为调用训练好的模型。主要内容如下</p><ol><li>直接读取预训练模型</li><li>将模型转换为推理模型</li><li>查看模型的结构</li></ol><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token comment">## ----- 1 读取模型</span>
...
----------------------------------------------------------------
</code></pre><h3 id="_1-2-检测图像" tabindex="-1"><a class="header-anchor" href="#_1-2-检测图像"><span>1.2 检测图像</span></a></h3><p>该部分主要为检测图像，查看模型结果。一般来说pytorch导出的onnx模型都是用于C++调用，所以基于OpenCV直接读取图像，进行图像通道转换以及图像归一化以模拟实际C++调用情况，而不是用pillow和pytorch的transform。一般来说C++提供的图像都是经由OpenCV调用而来。主要内容如下：</p><ol><li>基于OpenCV读取图像,进行通道转换</li><li>将图像进行归一化</li><li>进行模型推理，查看结果</li></ol><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token comment">## ----- 2 检测图像</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token comment">## ---- 3 导出为onnx模型</span>
...
模型导出成功
</code></pre><h3 id="_1-4-模型测试" tabindex="-1"><a class="header-anchor" href="#_1-4-模型测试"><span>1.4 模型测试</span></a></h3>`,22),k={href:"https://github.com/lutzroeder/Netron",target:"_blank",rel:"noopener noreferrer"},m=p(`<div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token comment">## ---- 4 模型测试(可跳过)</span>
...
模型测试成功
</code></pre><h3 id="_1-5-模型简化" tabindex="-1"><a class="header-anchor" href="#_1-5-模型简化"><span>1.5 模型简化</span></a></h3>`,3),v={href:"https://github.com/daquexian/onnx-simplifier",target:"_blank",rel:"noopener noreferrer"},b=n("li",null,"调用代码，调用onnx-simplifier的simplify接口",-1),h=n("li",null,"命令行简化，直接输入python3 -m onnxsim input_onnx_model output_onnx_model",-1),_={href:"https://github.com/daquexian/onnx-simplifier",target:"_blank",rel:"noopener noreferrer"},y={href:"https://convertmodel.com/",target:"_blank",rel:"noopener noreferrer"},g=p(`<p>具体来说推荐第三种在线使用，第三种在线调用方便，还能将onnx模型转换为ncnn,mnn等模型格式。</p><p>P.S. onnx-simplifier对于高版本pytorch不那么支持，转换可能失败，所以设置skip_fuse_bn=True跳过融合bn层。这种情况下onnx-simplifier转换出来的onnx模型可能比转换前的模型大，原因是补充了shape信息。</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token comment">## ----- 5 模型简化</span>
...
模型简化成功
</code></pre><h3 id="_1-6-全部代码" tabindex="-1"><a class="header-anchor" href="#_1-6-全部代码"><span>1.6 全部代码</span></a></h3><p>全部工程代码如下</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token comment">## -*- coding: utf-8 -*-</span>
...
----- 5 模型简化 -----
模型简化成功
</code></pre><h2 id="_2-参考" tabindex="-1"><a class="header-anchor" href="#_2-参考"><span>2 参考</span></a></h2>`,9),x={href:"https://github.com/lutzroeder/Netron",target:"_blank",rel:"noopener noreferrer"},f={href:"https://github.com/Tencent/ncnn/wiki/use-ncnn-with-pytorch-or-onnx",target:"_blank",rel:"noopener noreferrer"},B={href:"https://www.learnopencv.com/pytorch-to-coreml-model-conversion/",target:"_blank",rel:"noopener noreferrer"},q={href:"https://github.com/daquexian/onnx-simplifier",target:"_blank",rel:"noopener noreferrer"},w={href:"https://convertmodel.com/",target:"_blank",rel:"noopener noreferrer"};function N(C,E){const a=o("ExternalLinkIcon");return c(),i("div",null,[u,n("p",null,[s("本文主要介绍将pytorch模型准确导出为可用的onnx模型。以方便OpenCV Dnn,NCNN,MNN,TensorRT等框架调用。所有代码见："),n("a",r,[s("Python-Study-Notes"),t(a)])]),d,n("p",null,[s("该部分主要为测试模型，一般可以跳过，不需要这部分代码，通常模型转换不会出错。另外onnx模型可以通过"),n("a",k,[s("Netron"),t(a)]),s("查看结构。")]),m,n("p",null,[s("一般来说导出后的onnx模型会有一堆冗余操作，需要简化。推荐使用"),n("a",v,[s("onnx-simplifier"),t(a)]),s("进行onnx模型简化。onnx简化模型导出路径为当前目录下mobilenet_v2.onnxsim.onnx 调用onnx-simplifier有三种办法：")]),n("ol",null,[b,h,n("li",null,[s("在线调用，调用"),n("a",_,[s("onnx-simplifier"),t(a)]),s("作者的"),n("a",y,[s("https://convertmodel.com/"),t(a)]),s("直接进行模型简化。")])]),g,n("ul",null,[n("li",null,[n("a",x,[s("Netron"),t(a)])]),n("li",null,[n("a",f,[s("use ncnn with pytorch or onnx"),t(a)])]),n("li",null,[n("a",B,[s("PyTorch to CoreML model conversion"),t(a)])]),n("li",null,[n("a",q,[s("onnx-simplifier"),t(a)])]),n("li",null,[n("a",w,[s("https://convertmodel.com/"),t(a)])])])])}const R=e(l,[["render",N],["__file","2020-12-09-_深度学习_ Pytorch模型转换为onnx模型笔记.html.vue"]]),L=JSON.parse('{"path":"/blog/%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0/2020-12-09-_%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0_%20Pytorch%E6%A8%A1%E5%9E%8B%E8%BD%AC%E6%8D%A2%E4%B8%BAonnx%E6%A8%A1%E5%9E%8B%E7%AC%94%E8%AE%B0.html","title":"[深度学习] Pytorch模型转换为onnx模型笔记","lang":"zh-CN","frontmatter":{"date":"2020-12-09T20:30:07.000Z","category":["深度学习"],"tag":["深度学习","常用工具","Python"],"description":"[深度学习] Pytorch模型转换为onnx模型笔记 本文主要介绍将pytorch模型准确导出为可用的onnx模型。以方便OpenCV Dnn,NCNN,MNN,TensorRT等框架调用。所有代码见：Python-Study-Notes 1 使用说明 本文示例为调用pytorch预训练的mobilenetv2模型，将其导出为onnx模型。主要步骤如...","head":[["meta",{"property":"og:url","content":"https://luohenyueji.github.io/blog/%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0/2020-12-09-_%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0_%20Pytorch%E6%A8%A1%E5%9E%8B%E8%BD%AC%E6%8D%A2%E4%B8%BAonnx%E6%A8%A1%E5%9E%8B%E7%AC%94%E8%AE%B0.html"}],["meta",{"property":"og:site_name","content":"落痕月极的博客"}],["meta",{"property":"og:title","content":"[深度学习] Pytorch模型转换为onnx模型笔记"}],["meta",{"property":"og:description","content":"[深度学习] Pytorch模型转换为onnx模型笔记 本文主要介绍将pytorch模型准确导出为可用的onnx模型。以方便OpenCV Dnn,NCNN,MNN,TensorRT等框架调用。所有代码见：Python-Study-Notes 1 使用说明 本文示例为调用pytorch预训练的mobilenetv2模型，将其导出为onnx模型。主要步骤如..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/%5B%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%5D%20Pytorch%E6%A8%A1%E5%9E%8B%E8%BD%AC%E6%8D%A2%E4%B8%BAonnx%E6%A8%A1%E5%9E%8B%E7%AC%94%E8%AE%B0/20201209202924553.png?ref_type=heads"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"name":"twitter:card","content":"summary_large_image"}],["meta",{"name":"twitter:image:alt","content":"[深度学习] Pytorch模型转换为onnx模型笔记"}],["meta",{"property":"article:author","content":"落痕月极"}],["meta",{"property":"article:tag","content":"深度学习"}],["meta",{"property":"article:tag","content":"常用工具"}],["meta",{"property":"article:tag","content":"Python"}],["meta",{"property":"article:published_time","content":"2020-12-09T20:30:07.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"[深度学习] Pytorch模型转换为onnx模型笔记\\",\\"image\\":[\\"https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/%5B%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%5D%20Pytorch%E6%A8%A1%E5%9E%8B%E8%BD%AC%E6%8D%A2%E4%B8%BAonnx%E6%A8%A1%E5%9E%8B%E7%AC%94%E8%AE%B0/20201209202924553.png?ref_type=heads\\"],\\"datePublished\\":\\"2020-12-09T20:30:07.000Z\\",\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"落痕月极\\",\\"url\\":\\"/\\"}]}"]]},"headers":[{"level":2,"title":"1 使用说明","slug":"_1-使用说明","link":"#_1-使用说明","children":[{"level":3,"title":"1.1 读取模型","slug":"_1-1-读取模型","link":"#_1-1-读取模型","children":[]},{"level":3,"title":"1.2 检测图像","slug":"_1-2-检测图像","link":"#_1-2-检测图像","children":[]},{"level":3,"title":"1.3 导出为onnx模型","slug":"_1-3-导出为onnx模型","link":"#_1-3-导出为onnx模型","children":[]},{"level":3,"title":"1.4 模型测试","slug":"_1-4-模型测试","link":"#_1-4-模型测试","children":[]},{"level":3,"title":"1.5 模型简化","slug":"_1-5-模型简化","link":"#_1-5-模型简化","children":[]},{"level":3,"title":"1.6 全部代码","slug":"_1-6-全部代码","link":"#_1-6-全部代码","children":[]}]},{"level":2,"title":"2 参考","slug":"_2-参考","link":"#_2-参考","children":[]}],"git":{},"readingTime":{"minutes":12.52,"words":3756},"filePathRelative":"blog/深度学习/2020-12-09-[深度学习] Pytorch模型转换为onnx模型笔记.md","localizedDate":"2020年12月10日","excerpt":"\\n<p>本文主要介绍将pytorch模型准确导出为可用的onnx模型。以方便OpenCV Dnn,NCNN,MNN,TensorRT等框架调用。所有代码见：<a href=\\"https://github.com/luohenyueji/Python-Study-Notes/blob/master/Documents\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">Python-Study-Notes</a></p>\\n<h2>1 使用说明</h2>\\n<p>本文示例为调用pytorch预训练的mobilenetv2模型，将其导出为onnx模型。主要步骤如下：</p>","autoDesc":true}');export{R as comp,L as data};
