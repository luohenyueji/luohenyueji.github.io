import{_ as p,r as o,o as i,c,a as n,b as s,d as t,e}from"./app-DFbKURJL.js";const l={},r=n("h1",{id:"编程基础-python数据生成库faker总结",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#编程基础-python数据生成库faker总结"},[n("span",null,"[编程基础] Python数据生成库Faker总结")])],-1),u=n("p",null,"Python Faker教程展示了如何使用Faker软件包在Python中生成伪数据。我们使用joke2k/faker包。",-1),k=n("h2",{id:"_1-介绍",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_1-介绍"},[n("span",null,"1 介绍")])],-1),d=n("p",null,"Faker是一个生成假数据的Python库。伪数据通常用于测试或用一些伪数据填充数据库。Python Faker很大程度上受到了PHP的Faker、Perl的Data::Faker和Ruby的Faker的启发。该软件包与composer一起安装。另外，我们安装了Dumper，它在转储变量时提供更好的控制台输出。",-1),m={href:"https://github.com/joke2k/faker",target:"_blank",rel:"noopener noreferrer"},v={href:"https://faker.readthedocs.io/en/master/index.html",target:"_blank",rel:"noopener noreferrer"},g=e(`<div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token comment"># pip install Faker</span>
<span class="token comment"># pip install Dumper</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,1),f={href:"https://faker.readthedocs.io/en/master/locales.html",target:"_blank",rel:"noopener noreferrer"},b=e(`<h3 id="_1-1-简单的使用" tabindex="-1"><a class="header-anchor" href="#_1-1-简单的使用"><span>1.1 简单的使用</span></a></h3><p>下面示例输出假名称，地址和文本。</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> faker <span class="token keyword">import</span> Faker
...
</code></pre>`,4),h={href:"https://faker.readthedocs.io/en/master/locales.html",target:"_blank",rel:"noopener noreferrer"},y=e(`<div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> faker <span class="token keyword">import</span> Faker
...
</code></pre><h3 id="_1-2-faking-names" tabindex="-1"><a class="header-anchor" href="#_1-2-faking-names"><span>1.2 Faking names</span></a></h3><p>在下面示例中，我们伪造与用户名有关的数据。</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> faker <span class="token keyword">import</span> Faker
...
Male name: 黄小红
Female name: 黄建华
</code></pre><h3 id="_1-3-faking-jobs" tabindex="-1"><a class="header-anchor" href="#_1-3-faking-jobs"><span>1.3 Faking jobs</span></a></h3><p>使用job()接口生成假的工作。使用如下：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> faker <span class="token keyword">import</span> Faker
...
畜牧师
水工
</code></pre><h3 id="_1-4-faking-currencies" tabindex="-1"><a class="header-anchor" href="#_1-4-faking-currencies"><span>1.4 Faking currencies</span></a></h3><p>下面的示例为货币创建假数据</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> faker <span class="token keyword">import</span> Faker
...
currency code: PYG
</code></pre><h3 id="_1-5-faking-words" tabindex="-1"><a class="header-anchor" href="#_1-5-faking-words"><span>1.5 Faking words</span></a></h3><p>下面的示例为单词创建假数据</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> faker <span class="token keyword">import</span> Faker
...
</code></pre><h3 id="_1-6-faking-profiles" tabindex="-1"><a class="header-anchor" href="#_1-6-faking-profiles"><span>1.6 Faking profiles</span></a></h3><p>Faker可以使用simple_profile()创建简单的虚拟配置文件，使用profile()创建扩展配置文件。通过profile可以生成信息概要文件，该示例为男性和女性创建虚拟概要文件。</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> faker <span class="token keyword">import</span> Faker
...
</code></pre><h3 id="_1-7-faking-numbers" tabindex="-1"><a class="header-anchor" href="#_1-7-faking-numbers"><span>1.7 Faking numbers</span></a></h3><p>Faker允许生成随机数字和整数。</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> faker <span class="token keyword">import</span> Faker
...
Random int: 72
Random digit: 1
</code></pre><h3 id="_1-8-faking-hashes-and-uuids" tabindex="-1"><a class="header-anchor" href="#_1-8-faking-hashes-and-uuids"><span>1.8 Faking hashes and uuids</span></a></h3><p>hashes和uuids的伪造支持。下面示例生成三个伪哈希和一个uuid值</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> faker <span class="token keyword">import</span> Faker
...
</code></pre><h3 id="_1-9-faking-internet-related-data" tabindex="-1"><a class="header-anchor" href="#_1-9-faking-internet-related-data"><span>1.9 Faking internet related data</span></a></h3><p>Faker有多个用于伪造Internet相关数据的访问器。下面示例显示了各种与Internet相关的数据，包括电子邮件，域名，段，IP地址和URL。其中一些数据是真实存在的，只是伪造随机选择了互联网的数据，如url可以直接打开。</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> faker <span class="token keyword">import</span> Faker
...
</code></pre><h3 id="_1-10-faking-date-and-time" tabindex="-1"><a class="header-anchor" href="#_1-10-faking-date-and-time"><span>1.10 Faking date and time</span></a></h3><p>Faker有很多伪造日期和时间值的方法。</p><p>下面示例显示了伪造的生日，日期时间部分，时区和AM / PM方法</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> faker <span class="token keyword">import</span> Faker
...
AM/PM: AM
</code></pre><p>第二个示例显示了在当前世纪，十年，年份或月份中生成日期时间值的方法。它还包括时间序列值的生成。</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> faker <span class="token keyword">import</span> Faker
...
2020-06-17 11:51:25
2020-06-19 11:51:25
</code></pre><h3 id="_1-11-faker函数列表" tabindex="-1"><a class="header-anchor" href="#_1-11-faker函数列表"><span>1.11 faker函数列表</span></a></h3>`,43),_={href:"https://faker.readthedocs.io/en/master/providers.html",target:"_blank",rel:"noopener noreferrer"},w=e(`<div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token triple-quoted-string string">&#39;&#39;&#39;
faker.providers
...
&#39;&#39;&#39;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-参考" tabindex="-1"><a class="header-anchor" href="#_2-参考"><span>2 参考</span></a></h2>`,2),F={href:"http://zetcode.com/python/faker/",target:"_blank",rel:"noopener noreferrer"},x={href:"https://faker.readthedocs.io/en/master/index.html",target:"_blank",rel:"noopener noreferrer"};function P(E,D){const a=o("ExternalLinkIcon");return i(),c("div",null,[r,u,k,d,n("p",null,[s("官方项目地址见： "),n("a",m,[s("https://github.com/joke2k/faker"),t(a)])]),n("p",null,[s("官方文档地址见： "),n("a",v,[s("https://faker.readthedocs.io/en/master/index.html"),t(a)])]),g,n("p",null,[s("通过faker.Faker()创建并初始化faker数据生成器，该生成器可以通过访问以数据类型命名的属性来生成数据。 Faker将数据生成委托给提供者。默认提供程序使用英语区域设置。Faker支持其他地区语言（包括中文）；它们的完成程度不同。支持的语言列表见： "),n("a",f,[s("https://faker.readthedocs.io/en/master/locales.html"),t(a)])]),b,n("p",null,[s("当然可以在创建Faker生成器时通过语言代号指定语言，如下所示。常用支持的语言代号见： "),n("a",h,[s("https://faker.readthedocs.io/en/master/locales.html"),t(a)])]),y,n("p",null,[s("faker提供许多函数接口，本文并没有全部列出，具体见官方文档。可用的函数列表如下。直接在官方文档地址 "),n("a",_,[s("https://faker.readthedocs.io/en/master/providers.html"),t(a)]),s("，点击对应的函数列表链接，便有对应的使用说明。")]),w,n("blockquote",null,[n("p",null,[n("a",F,[s("http://zetcode.com/python/faker/"),t(a)])])]),n("blockquote",null,[n("p",null,[n("a",x,[s("https://faker.readthedocs.io/en/master/index.html"),t(a)])])])])}const B=p(l,[["render",P],["__file","2020-06-21-_编程基础_ Python数据生成库Faker总结.html.vue"]]),C=JSON.parse('{"path":"/blog/%E7%BC%96%E7%A8%8B%E5%9F%BA%E7%A1%80/%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/2020-06-21-_%E7%BC%96%E7%A8%8B%E5%9F%BA%E7%A1%80_%20Python%E6%95%B0%E6%8D%AE%E7%94%9F%E6%88%90%E5%BA%93Faker%E6%80%BB%E7%BB%93.html","title":"[编程基础] Python数据生成库Faker总结","lang":"zh-CN","frontmatter":{"date":"2020-06-21T12:03:09.000Z","category":["编程基础"],"tag":["编程基础","Python"],"description":"[编程基础] Python数据生成库Faker总结 Python Faker教程展示了如何使用Faker软件包在Python中生成伪数据。我们使用joke2k/faker包。 1 介绍 Faker是一个生成假数据的Python库。伪数据通常用于测试或用一些伪数据填充数据库。Python Faker很大程度上受到了PHP的Faker、Perl的Data:...","head":[["meta",{"property":"og:url","content":"https://luohenyueji.github.io/blog/%E7%BC%96%E7%A8%8B%E5%9F%BA%E7%A1%80/%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/2020-06-21-_%E7%BC%96%E7%A8%8B%E5%9F%BA%E7%A1%80_%20Python%E6%95%B0%E6%8D%AE%E7%94%9F%E6%88%90%E5%BA%93Faker%E6%80%BB%E7%BB%93.html"}],["meta",{"property":"og:site_name","content":"落痕月极的博客"}],["meta",{"property":"og:title","content":"[编程基础] Python数据生成库Faker总结"}],["meta",{"property":"og:description","content":"[编程基础] Python数据生成库Faker总结 Python Faker教程展示了如何使用Faker软件包在Python中生成伪数据。我们使用joke2k/faker包。 1 介绍 Faker是一个生成假数据的Python库。伪数据通常用于测试或用一些伪数据填充数据库。Python Faker很大程度上受到了PHP的Faker、Perl的Data:..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"article:author","content":"落痕月极"}],["meta",{"property":"article:tag","content":"编程基础"}],["meta",{"property":"article:tag","content":"Python"}],["meta",{"property":"article:published_time","content":"2020-06-21T12:03:09.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"[编程基础] Python数据生成库Faker总结\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2020-06-21T12:03:09.000Z\\",\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"落痕月极\\",\\"url\\":\\"/\\"}]}"]]},"headers":[{"level":2,"title":"1 介绍","slug":"_1-介绍","link":"#_1-介绍","children":[{"level":3,"title":"1.1 简单的使用","slug":"_1-1-简单的使用","link":"#_1-1-简单的使用","children":[]},{"level":3,"title":"1.2 Faking names","slug":"_1-2-faking-names","link":"#_1-2-faking-names","children":[]},{"level":3,"title":"1.3 Faking jobs","slug":"_1-3-faking-jobs","link":"#_1-3-faking-jobs","children":[]},{"level":3,"title":"1.4 Faking currencies","slug":"_1-4-faking-currencies","link":"#_1-4-faking-currencies","children":[]},{"level":3,"title":"1.5 Faking words","slug":"_1-5-faking-words","link":"#_1-5-faking-words","children":[]},{"level":3,"title":"1.6 Faking profiles","slug":"_1-6-faking-profiles","link":"#_1-6-faking-profiles","children":[]},{"level":3,"title":"1.7 Faking numbers","slug":"_1-7-faking-numbers","link":"#_1-7-faking-numbers","children":[]},{"level":3,"title":"1.8 Faking hashes and uuids","slug":"_1-8-faking-hashes-and-uuids","link":"#_1-8-faking-hashes-and-uuids","children":[]},{"level":3,"title":"1.9 Faking internet related data","slug":"_1-9-faking-internet-related-data","link":"#_1-9-faking-internet-related-data","children":[]},{"level":3,"title":"1.10 Faking date and time","slug":"_1-10-faking-date-and-time","link":"#_1-10-faking-date-and-time","children":[]},{"level":3,"title":"1.11 faker函数列表","slug":"_1-11-faker函数列表","link":"#_1-11-faker函数列表","children":[]}]},{"level":2,"title":"2 参考","slug":"_2-参考","link":"#_2-参考","children":[]}],"git":{},"readingTime":{"minutes":7,"words":2099},"filePathRelative":"blog/编程基础/学习笔记/2020-06-21-[编程基础] Python数据生成库Faker总结.md","localizedDate":"2020年6月21日","excerpt":"\\n<p>Python Faker教程展示了如何使用Faker软件包在Python中生成伪数据。我们使用joke2k/faker包。</p>\\n<h2>1 介绍</h2>\\n<p>Faker是一个生成假数据的Python库。伪数据通常用于测试或用一些伪数据填充数据库。Python Faker很大程度上受到了PHP的Faker、Perl的Data::Faker和Ruby的Faker的启发。该软件包与composer一起安装。另外，我们安装了Dumper，它在转储变量时提供更好的控制台输出。</p>\\n<p>官方项目地址见：\\n<a href=\\"https://github.com/joke2k/faker\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">https://github.com/joke2k/faker</a></p>","autoDesc":true}');export{B as comp,C as data};
