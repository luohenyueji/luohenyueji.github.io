...
</code></pre><p>[toc]</p><h2 id="_1-tablib使用" tabindex="-1"><a class="header-anchor" href="#_1-tablib使用" aria-hidden="true">#</a> 1 Tablib使用</h2><h3 id="_1-1-表格创建" tabindex="-1"><a class="header-anchor" href="#_1-1-表格创建" aria-hidden="true">#</a> 1.1 表格创建</h3><p><strong>创建数据结构</strong></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 创建表</span>
...
</code></pre><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 查看表格名字，默认为空</span>
data<span class="token punctuation">.</span>title 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 设置表的名字</span>
...
</code></pre><p><strong>数据添加</strong></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 添加行</span>
...
</code></pre><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 添加标题行</span>
...
Tom |16 
Jane|32 
</code></pre><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 添加列</span>
...
Tom |16 |UK     
Jane|32 |UK     
</code></pre><p><strong>选择行或列</strong></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 选择第一行</span>
...
</code></pre><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 选择第一行第三列</span>
...
</code></pre><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 选择列</span>
...
</code></pre><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 获得表头</span>
...
</code></pre><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 基于索引获得列</span>
...
</code></pre><p><strong>删除行或列</strong></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 删除列</span>
...
Tom |16 
Jane|32 
</code></pre><p><strong>行列高级操作</strong></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 表格转置</span>
...
----|----|---|----
Age |28  |16 |32  
</code></pre><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 读取数据维度</span>
...
</code></pre><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 按照字段排序</span>
...
John|28 
Tom |16 
</code></pre><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 计算平均年龄</span>
...
</code></pre><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 移除第一行</span>
...
John|28 
Tom |16 
</code></pre><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 第一行添加数据</span>
...
John|28 
Tom |16 
</code></pre><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 在最左侧插入一列数据</span>
...
Doctor    |John|28 
Doctor    |Tom |16 
</code></pre><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 移除最后一行</span>
<span class="token comment">## data.pop()</span>
<span class="token comment">## print(data)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 移除重复行</span>
...
Alice|25 
Alice|30 
</code></pre><p><strong>表格合并</strong></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 创建两个表格</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 按行合并</span>
...
Alice|Engineer
Bob  |Doctor  
</code></pre><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 按列合并</span>
...
Bob  |30 |Bob  |Doctor    
</code></pre><h3 id="_1-2-数据导入与导出" tabindex="-1"><a class="header-anchor" href="#_1-2-数据导入与导出" aria-hidden="true">#</a> 1.2 数据导入与导出</h3><p><strong>数据导出</strong></p><p>Tablib使得用户可以根据具体需求将数据灵活地导出到不同的环境中，并与其他工具进行无缝集成和交互。<strong>转换的结果是这些格式的对象表示而不是存为本地文件</strong>。这些格式包括但不限于：</p><ul><li>CSV：常见的电子表格格式，每个字段由逗号分隔。</li><li>JSON：一种常见的数据交换格式，以键值对的形式存储数据。</li><li>Excel：电子表格格式，需要额外安装库，可以包含多个工作表，并支持公式和图表等功能。</li><li>YAML：一种易读的数据序列化格式，常用于配置文件。</li><li>HTML：用于创建网页的标记语言。</li><li>Pandas DataFrame：Pandas是另一个Python库，用于数据处理和分析。Tablib支持将数据导出为Pandas DataFrame。</li></ul><p>Tablib提供了两种方式将数据导出为其他格式，一种是调用export函数，一种是调用自带属性。如下所示data.export(&#39;csv&#39;) 和data.csv都可以用于获取Dataset数据的CSV表示：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>data.export(&#39;csv&#39;)
data.csv
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>具体示例代码如下：</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 创建表格</span>
data <span class="token operator">=</span> tablib<span class="token punctuation">.</span>Dataset<span class="token punctuation">(</span><span class="token punctuation">)</span>
data<span class="token punctuation">.</span>headers <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token string">&#39;Name&#39;</span><span class="token punctuation">,</span> <span class="token string">&#39;Age&#39;</span><span class="token punctuation">]</span>
data<span class="token punctuation">.</span>append<span class="token punctuation">(</span><span class="token punctuation">[</span><span class="token string">&#39;John&#39;</span><span class="token punctuation">,</span> <span class="token number">28</span><span class="token punctuation">]</span><span class="token punctuation">)</span>
data<span class="token punctuation">.</span>append<span class="token punctuation">(</span><span class="token punctuation">[</span><span class="token string">&#39;Tom&#39;</span><span class="token punctuation">,</span> <span class="token number">16</span><span class="token punctuation">]</span><span class="token punctuation">)</span>
data<span class="token punctuation">.</span>append<span class="token punctuation">(</span><span class="token punctuation">[</span><span class="token string">&#39;Jane&#39;</span><span class="token punctuation">,</span> <span class="token number">32</span><span class="token punctuation">]</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 导出为csv字符流</span>
...
</code></pre><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 导出为json字符串</span>
...
</code></pre><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 将数据集对象保存为json文件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 保存为yaml文件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 将数据集保存为xls文件，注意使用wb模式</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 转换为html</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 转换为pandas的dataframe</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div><table border="1" class="dataframe"><thead><tr style="text-align:right;"><th></th><th>Name</th><th>Age</th></tr></thead><tbody><tr><th>0</th><td>John</td><td>28</td></tr><tr><th>1</th><td>Tom</td><td>16</td></tr><tr><th>2</th><td>Jane</td><td>32</td></tr></tbody></table></div><p><strong>数据导入</strong></p><p>我们可以使用tablib库导入多种格式的文件，以初始化tablib的数据对象。如下所示：</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">with</span> <span class="token builtin">open</span><span class="token punctuation">(</span><span class="token string">&#39;data.csv&#39;</span><span class="token punctuation">,</span> <span class="token string">&#39;r&#39;</span><span class="token punctuation">)</span> <span class="token keyword">as</span> fh<span class="token punctuation">:</span>
...
Tom |16 
Jane|32 
</code></pre><p>对于支持多表的xls、xlsx，当前默认打开第一个表，注意使用rb模式。多表管理见下一节。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">with</span> <span class="token builtin">open</span><span class="token punctuation">(</span><span class="token string">&#39;data.xls&#39;</span><span class="token punctuation">,</span> <span class="token string">&#39;rb&#39;</span><span class="token punctuation">)</span> <span class="token keyword">as</span> fh<span class="token punctuation">:</span>
...
Tom |16.0
Jane|32.0
</code></pre><h3 id="_1-3-多表管理" tabindex="-1"><a class="header-anchor" href="#_1-3-多表管理" aria-hidden="true">#</a> 1.3 多表管理</h3><p>在Tablib中，Databook是一种数据结构，用于组织和管理多个数据表（Data Table。Databook提供了一种方便的方式来操作和处理多个数据表</p><p><strong>创建Databook</strong></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 创建Databook</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 创建第一个数据表</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 创建二个数据表</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 可以利用现有表一次性创建Databoook</span>
...
</code></pre><p><strong>查看databook</strong></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 查看子表数量</span>
...
</code></pre><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 查看各表</span>
...
</code></pre><p>根据索引获得表</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">for</span> index<span class="token punctuation">,</span>table <span class="token keyword">in</span> <span class="token builtin">enumerate</span><span class="token punctuation">(</span>databook<span class="token punctuation">.</span>sheets<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
...
Jane|34 
Mike|14 
</code></pre><p><strong>保存与导入</strong></p><p>databook支持保存xlsx和xls文件，但是导入仅支持xlsx文件。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 保存为xlsx文件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 多表导入</span>
...
</code></pre><h3 id="_1-4-进阶使用" tabindex="-1"><a class="header-anchor" href="#_1-4-进阶使用" aria-hidden="true">#</a> 1.4 进阶使用</h3><p><strong>动态列</strong></p><p>Talblib允许在数据表格中随意创建和管理动态列。这些列不需要预先定义，可以根据需要随时添加、删除和修改。如下所示根据随机函数设置列：</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 导入数据</span>
...
Tom |16 
Jane|32 
</code></pre><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> random
...
</code></pre><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 过滤出标签为vegetable的数据</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><div><table border="1" class="dataframe"><thead><tr style="text-align:right;"><th></th><th>name</th><th>color</th></tr></thead><tbody><tr><th>0</th><td>strawberry</td><td>red</td></tr><tr><th>1</th><td>corn</td><td>yellow</td></tr></tbody></table></div><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## 先过滤出标签为fruit,再过滤为sour的数据</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div><table border="1" class="dataframe"><thead><tr style="text-align:right;"><th></th><th>Name</th><th>Profession</th></tr></thead><tbody><tr><th>0</th><td>Alice</td><td>Doctor</td></tr><tr><th>1</th><td>Jack</td><td>Engineer</td></tr></tbody></table></div><h2 id="_2-参考" tabindex="-1"><a class="header-anchor" href="#_2-参考" aria-hidden="true">#</a> 2 参考</h2>`,138),v={href:"https://github.com/jazzband/tablib",target:"_blank",rel:"noopener noreferrer"},m={href:"https://tablib.readthedocs.io/en/stable/",target:"_blank",rel:"noopener noreferrer"};function b(g,h){const a=p("ExternalLinkIcon");return o(),c("div",null,[u,n("p",null,[s("Tablib是一个用于处理电子表格（如 Excel，CSV，JSON）的Python 库。它提供了一种简单而强大的方式来操作和处理数据。利用Tablib，我们可以轻松地读取、写入、过滤和转换各种类型的电子表格数据。Tablib 具有一致且易于使用的 API，以在不同的数据格式之间进行无缝转换。比如，Tablib可以将数据从Excel表格导入为Python对象，然后将其转换为JSON或CSV格式，并进行相应的操作和分析。此外Tablib还支持对数据进行排序、筛选和合并等常见操作。Tablib官方仓库地址为："),n("a",d,[s("tablib"),t(a)]),s("，Tablib官方文档地址为："),n("a",r,[s("tablib-doc"),t(a)]),s("。")]),k,n("ul",null,[n("li",null,[n("a",v,[s("tablib"),t(a)])]),n("li",null,[n("a",m,[s("tablib-doc"),t(a)]),s("。")])])])}const _=e(l,[["render",b],["__file","2023-11-30-_python_ 基于Tablib库处理表格数据.html.vue"]]);export{_ as default};
