...
<span class="line"><span># 计算显著性</span></span>
<span class="line"><span>success, saliencyMap = saliencyAlgorithm.computeSaliency(image)</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_1-1-2-staticsaliencyfinegrained" tabindex="-1"><a class="header-anchor" href="#_1-1-2-staticsaliencyfinegrained"><span>1.1.2 StaticSaliencyFineGrained</span></a></h4><ul><li>原理：该方法基于空间尺度差异center-surround differences计算显著性。利用积分图像integral images.实时生成高分辨率显著性图。</li><li>论文：<a href="https://www.sciencedirect.com/science/article/abs/pii/S0262885609001371" target="_blank" rel="noopener noreferrer">Human detection using a mobile platform and novel features derived from a visual saliency mechanism</a></li><li>提出时间：2010</li><li>检测方式：单张图片检测</li></ul><p>调用接口如下：</p><p><strong>C++</strong></p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>saliencyAlgorithm = StaticSaliencyFineGrained::create();</span></span>
<span class="line"><span>// 计算显著性</span></span>
<span class="line"><span>bool success = saliencyAlgorithm-&gt;computeSaliency(image, saliencyMap);</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>Python</strong></p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>saliencyAlgorithm = cv2.saliency.StaticSaliencyFineGrained_create()</span></span>
<span class="line"><span># 计算显著性</span></span>
<span class="line"><span>success, saliencyMap = saliencyAlgorithm.computeSaliency(image)</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_1-1-3-objectnessbing" tabindex="-1"><a class="header-anchor" href="#_1-1-3-objectnessbing"><span>1.1.3 ObjectnessBING</span></a></h4><ul><li>原理：基于二值化梯度特征(BING features)进行物体检测</li><li>论文：<a href="https://mmcheng.net/bing/" target="_blank" rel="noopener noreferrer">BING: Binarized Normed Gradients for Objectness Estimation at 300fps</a></li><li>提出时间：2014</li><li>检测方式：加载模型，单张图片检测</li></ul><p>调用接口如下：</p><p><strong>C++</strong></p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>saliencyAlgorithm = ObjectnessBING::create();</span></span>
