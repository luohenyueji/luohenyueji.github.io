import{_ as a,r as l,o as d,c as s,a as e,b as t,d as n,e as r}from"./app-q9tmr8t5.js";const o={},u=r(`<h1 id="数据分析与可视化-数据绘图要点6-数据组过多" tabindex="-1"><a class="header-anchor" href="#数据分析与可视化-数据绘图要点6-数据组过多" aria-hidden="true">#</a> [数据分析与可视化] 数据绘图要点6-数据组过多</h1><p>比较几个数值变量的分布是数据展示中的一项常见任务。变量的分布可以使用直方图或密度图来表示，在同一轴上表示适量数据的组是非常有吸引力的。但是数据组过多将严重影响图表信息表现。</p><h2 id="数据分布绘图实例" tabindex="-1"><a class="header-anchor" href="#数据分布绘图实例" aria-hidden="true">#</a> 数据分布绘图实例</h2><p>下面是一个示例，展示了人们如何感知词汇。短语“Highly likely”表示什么情况的概率问题。以下是人们给出概率分数分布结果。</p><div class="language-R line-numbers-mode" data-ext="R"><pre class="language-R"><code>## 加载库
library(tidyverse)
library(hrbrthemes)
library(viridis)
library(patchwork)
...
xlab(&quot;&quot;) +
ylab(&quot;Assigned Probability (%)&quot;)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/R-Study-Notes/[数据分析与可视化] 数据绘图要点/[数据分析与可视化] 数据绘图要点6-数据组过多/output_20_0.png" alt="png" tabindex="0" loading="lazy"><figcaption>png</figcaption></figure><h2 id="参考" tabindex="-1"><a class="header-anchor" href="#参考" aria-hidden="true">#</a> 参考</h2>`,43),c={href:"https://www.data-to-viz.com/caveat/multi_distribution.html",target:"_blank",rel:"noopener noreferrer"},v={href:"https://www.data-to-viz.com/story/OneNumOneCatSeveralObs.html",target:"_blank",rel:"noopener noreferrer"};function m(b,p){const i=l("ExternalLinkIcon");return d(),s("div",null,[u,e("ul",null,[e("li",null,[e("a",c,[t("TOO MANY DISTRIBUTIONS"),n(i)])]),e("li",null,[e("a",v,[t("PERCEPTION OF PROBABILITY"),n(i)])])])])}const h=a(o,[["render",m],["__file","2021-12-19-_数据分析与可视化_ 数据绘图要点6-数据组过多.html.vue"]]);export{h as default};
