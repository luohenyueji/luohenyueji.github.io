import{_ as l,r as a,o as s,c as r,a as e,b as t,d as n,e as d}from"./app-CD_-ggd_.js";const c={},u=e("h1",{id:"opencv实战-48-基于opencv实现图像质量评价",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#opencv实战-48-基于opencv实现图像质量评价"},[e("span",null,"[OpenCV实战]48 基于OpenCV实现图像质量评价")])],-1),o=e("p",null,"本文主要介绍基于OpenCV contrib中的quality模块实现图像质量评价。图像质量评估Image Quality Analysis简称IQA，主要通过数学度量方法来评价图像质量的好坏。",-1),v=e("p",null,"本文需要OpenCV contrib库，OpenCV contrib库的编译安装见：",-1),m={href:"https://blog.csdn.net/LuohenYJ/article/details/107944236",target:"_blank",rel:"noopener noreferrer"},g=e("p",null,"本文所有代码见：",-1),p={href:"https://github.com/luohenyueji/OpenCV-Practical-Exercise",target:"_blank",rel:"noopener noreferrer"},b=e("h2",{id:"_1-opencv中图像质量评价算法介绍",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_1-opencv中图像质量评价算法介绍"},[e("span",null,"1 OpenCV中图像质量评价算法介绍")])],-1),y=e("h3",{id:"_1-1-相关背景",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_1-1-相关背景"},[e("span",null,"1.1 相关背景")])],-1),E=e("p",null,"图像质量评价(IQA)算法以任意图像作为输入，输出质量分数作为输出。有三种类型的IQA：",-1),_=e("ol",null,[e("li",null,"全参考图像质量评价，适用情形：一个“干净”参考(非扭曲)图像以衡量扭曲图像的质量。此度量可用于评估图像压缩算法的质量。"),e("li",null,"半参考图像质量评价，适用情形：如果没有参考图像，而是具有一些选择性信息的图像(例如，水印图像)来比较和测量失真图像的质量。"),e("li",null,"无参考图像质量评价，适用情形：算法得到的唯一输入是要测量其质量的图像。")],-1),h={href:"https://github.com/opencv/opencv_contrib/tree/master/modules/quality",target:"_blank",rel:"noopener noreferrer"},x=e("ul",null,[e("li",null,"均方误差 Mean squared error (MSE)"),e("li",null,"峰值信噪比 Peak signal-to-noise ratio (PSNR)"),e("li",null,"结构相似性 Structural similarity (SSIM)"),e("li",null,"梯度幅度相似性偏差 Gradient Magnitude Similarity Deviation (GMSD)"),e("li",null,"盲/无参考图像空间质量评估器 Blind/Referenceless Image Spatial Quality Evaluation (BRISQUE)")],-1),S=e("p",null,"这5种图像质量评价算法中，除了BRISQUE是无参考图像质量评价算法外，其他都是全参考图像质量评价。本文不具体介绍这些算法的原理，仅介绍这些算法的应用。想知道具体原理见链接：",-1),B=e("br",null,null,-1),q={href:"https://blog.csdn.net/baidu_33216040/article/details/97373480",target:"_blank",rel:"noopener noreferrer"},C=e("br",null,null,-1),A={href:"https://blog.csdn.net/xiaoxifei/article/details/88222485",target:"_blank",rel:"noopener noreferrer"},M=e("br",null,null,-1),f={href:"https://blog.csdn.net/LuohenYJ/article/details/104582701",target:"_blank",rel:"noopener noreferrer"},V=e("strong",null,"就全参考图像质量评价算法而言，一般情况下GMSD效果比其他全参考图像质量评价算法效果好",-1),O={href:"https://blog.csdn.net/xiaoxifei/category_9282438.html",target:"_blank",rel:"noopener noreferrer"},I=e("h3",{id:"_1-2-opencv中图像质量评价算法接口介绍",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_1-2-opencv中图像质量评价算法接口介绍"},[e("span",null,"1.2 OpenCV中图像质量评价算法接口介绍")])],-1),Q={href:"https://blog.csdn.net/LuohenYJ/article/details/104582701",target:"_blank",rel:"noopener noreferrer"},j={href:"https://blog.csdn.net/LuohenYJ/article/details/104582701",target:"_blank",rel:"noopener noreferrer"},R=d(`<h4 id="_1-2-1-opencv-contrib中全参考图像质量评价算法具体接口" tabindex="-1"><a class="header-anchor" href="#_1-2-1-opencv-contrib中全参考图像质量评价算法具体接口"><span>1.2.1 opencv_contrib中全参考图像质量评价算法具体接口</span></a></h4><p><strong>C++/静态方法</strong></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>// output quality map
// 质量结果图
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>C++/实例方法</strong></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>// alternatively, compute MSE via instance
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>Python/静态方法</strong></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># 静态方法，一步到位
# 质量结果图quality_map就是检测图像和基准图像各个像素点差值结果
result_static, quality_map = cv2.quality.QualityMSE_compute(img1, img2)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>Python/实例方法</strong></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>obj = cv2.quality.QualityMSE_create(img1)
result = obj.compute(img2)
quality_map = obj.getQualityMap()
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_1-2-2-opencv-contrib中无参考图像质量评价算法具体接口" tabindex="-1"><a class="header-anchor" href="#_1-2-2-opencv-contrib中无参考图像质量评价算法具体接口"><span>1.2.2 opencv_contrib中无参考图像质量评价算法具体接口</span></a></h4><p><strong>C++/静态方法</strong></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>// path to the trained model
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>C++/实例方法</strong></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>cv::Ptr&lt;quality::QualityBase&gt; ptr = quality::QualityBRISQUE::create(model_path, range_path);
// computes BRISQUE score for img
cv::Scalar result = ptr-&gt;compute(img)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>Python/静态方法</strong></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># path to the trained model
