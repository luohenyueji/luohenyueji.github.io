import{_ as e,r as o,o as c,c as i,a as n,b as s,d as p,e as t}from"./app-q9tmr8t5.js";const l={},u=n("h1",{id:"python-向量检索库faiss使用指北",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#python-向量检索库faiss使用指北","aria-hidden":"true"},"#"),s(" [python] 向量检索库Faiss使用指北")],-1),r={href:"https://github.com/facebookresearch/faiss",target:"_blank",rel:"noopener noreferrer"},d={href:"https://github.com/facebookresearch/faiss/wiki",target:"_blank",rel:"noopener noreferrer"},k=t(`<p>对于Faiss，linux系统的安装如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># CPU安装
