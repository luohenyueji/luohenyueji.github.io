import{_ as l}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as d,o as t,c as r,a as e,b as i,d as a,e as s}from"./app-kCY7hV_E.js";const u={},c=s(`<h1 id="常用工具-pyautogui使用教程" tabindex="-1"><a class="header-anchor" href="#常用工具-pyautogui使用教程" aria-hidden="true">#</a> [常用工具] PyAutoGUI使用教程</h1><p>[toc]</p><p>PyAutoGUI允许Python脚本控制鼠标和键盘，并自动与其他应用程序交互。PyAutoGUI的API设计很简单，非常容易上手，PyAutoGUI适用于 Windows、macOS和Linux系统，支持在Python2和3上运行。PyAutoGUI安装很简单。</p><p>windows安装：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>pip install pyautogui
