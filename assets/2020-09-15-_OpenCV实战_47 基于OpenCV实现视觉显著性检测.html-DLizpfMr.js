import{_ as a,r as s,o as r,c,a as e,b as i,d as t,e as l}from"./app-CD_-ggd_.js";const d={},u=e("h1",{id:"opencv实战-47-基于opencv实现视觉显著性检测",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#opencv实战-47-基于opencv实现视觉显著性检测"},[e("span",null,"[OpenCV实战]47 基于OpenCV实现视觉显著性检测")])],-1),o=e("p",null,[i("人类具有一种视觉注意机制，即当面对一个场景时，会选择性地忽略不感兴趣的区域，聚焦于感兴趣的区域。这些感兴趣的区域称为显著性区域。视觉显著性检测（Visual Saliency Detection，VSD）则是一种模拟人类视觉并从图像中提取显著性区域的智能算法。如下面左边的图所示，人眼在观看该图片时会首先注意其中的小狗，自动忽略背景区域，小狗所在区域就是显著性区域。通过计算机视觉算法对左边的图像进行视觉显著性检测能够得到下图右边的结果，其中黑色区域为不显著区域，白色为显著区域，显著性检测在机器人领域、目标检测领域和图像识别领域有大量应用。 "),e("img",{src:"https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/[OpenCV实战]47 基于OpenCV实现视觉显著性检测/image/dog.jpg",alt:"",loading:"lazy"})],-1),v={href:"https://github.com/opencv/opencv_contrib/tree/master/modules/saliency",target:"_blank",rel:"noopener noreferrer"},m={href:"https://blog.csdn.net/u010736662/article/details/88930849",target:"_blank",rel:"noopener noreferrer"},p=e("p",null,"本文需要OpenCV contrib库，OpenCV contrib库的编译安装见：",-1),b={href:"https://blog.csdn.net/LuohenYJ/article/details/107944236",target:"_blank",rel:"noopener noreferrer"},g=e("p",null,"本文所有代码见：",-1),h={href:"https://github.com/luohenyueji/OpenCV-Practical-Exercise",target:"_blank",rel:"noopener noreferrer"},y=l('<hr><h2 id="_1-opencv显著性算法背景介绍" tabindex="-1"><a class="header-anchor" href="#_1-opencv显著性算法背景介绍"><span>1 OpenCV显著性算法背景介绍</span></a></h2><h3 id="_1-1-opencv显著性检测算法相关信息介绍" tabindex="-1"><a class="header-anchor" href="#_1-1-opencv显著性检测算法相关信息介绍"><span>1.1 OpenCV显著性检测算法相关信息介绍</span></a></h3><p>OpenCV contrib库中的saliency模块提供四种显著性检测算法。本节主要介绍这四种方法的相关信息。</p><h4 id="_1-1-1-staticsaliencyspectralresidual" tabindex="-1"><a class="header-anchor" href="#_1-1-1-staticsaliencyspectralresidual"><span>1.1.1 StaticSaliencySpectralResidual</span></a></h4>',5),E=e("li",null,"原理：该方法从自然图像统计原理出发，模拟注意前视觉搜索的行为。该算法对每幅图像的对数谱进行分析，得到谱残差SR (Spectral Residual)。然后将谱残差进行空间变换，得到显著性图，该显著性图显示了感兴趣目标的位置。",-1),_={href:"http://bcmi.sjtu.edu.cn/~zhangliqing/Papers/2007CVPR_Houxiaodi_04270292.pdf",target:"_blank",rel:"noopener noreferrer"},A=e("li",null,"提出时间：2007",-1),B=e("li",null,"检测方式：单张图片检测",-1),f=l(`<p>调用接口如下：</p><p><strong>C++</strong></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>saliencyAlgorithm = StaticSaliencySpectralResidual::create();
// 计算显著性
bool success = saliencyAlgorithm-&gt;computeSaliency(image, saliencyMap);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>Python</strong></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>saliencyAlgorithm = cv2.saliency.StaticSaliencySpectralResidual_create()
# 计算显著性
success, saliencyMap = saliencyAlgorithm.computeSaliency(image)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_1-1-2-staticsaliencyfinegrained" tabindex="-1"><a class="header-anchor" href="#_1-1-2-staticsaliencyfinegrained"><span>1.1.2 StaticSaliencyFineGrained</span></a></h4>`,6),C=e("li",null,"原理：该方法基于空间尺度差异center-surround differences计算显著性。利用积分图像integral images.实时生成高分辨率显著性图。",-1),S={href:"https://www.sciencedirect.com/science/article/abs/pii/S0262885609001371",target:"_blank",rel:"noopener noreferrer"},q=e("li",null,"提出时间：2010",-1),O=e("li",null,"检测方式：单张图片检测",-1),x=l(`<p>调用接口如下：</p><p><strong>C++</strong></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>saliencyAlgorithm = StaticSaliencyFineGrained::create();
// 计算显著性
bool success = saliencyAlgorithm-&gt;computeSaliency(image, saliencyMap);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>Python</strong></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>saliencyAlgorithm = cv2.saliency.StaticSaliencyFineGrained_create()
# 计算显著性
success, saliencyMap = saliencyAlgorithm.computeSaliency(image)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_1-1-3-objectnessbing" tabindex="-1"><a class="header-anchor" href="#_1-1-3-objectnessbing"><span>1.1.3 ObjectnessBING</span></a></h4>`,6),w=e("li",null,"原理：基于二值化梯度特征(BING features)进行物体检测",-1),V={href:"https://mmcheng.net/bing/",target:"_blank",rel:"noopener noreferrer"},M=e("li",null,"提出时间：2014",-1),j=e("li",null,"检测方式：加载模型，单张图片检测",-1),R=l(`<p>调用接口如下：</p><p><strong>C++</strong></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>saliencyAlgorithm = ObjectnessBING::create();
...
// 计算显著性
bool success = saliencyAlgorithm-&gt;computeSaliency(image, saliencyMap);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>Python</strong></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>saliencyAlgorithm = cv2.saliency.ObjectnessBING_create()
# 提取模型文件参数
...
# 计算显著性
success, saliencyMap = saliencyAlgorithm.computeSaliency(image)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_1-1-4-binwangapr2014" tabindex="-1"><a class="header-anchor" href="#_1-1-4-binwangapr2014"><span>1.1.4 BinWangApr2014</span></a></h4>`,6),I=e("li",null,"原理：基于运动背景减除法实现显著性区域检测",-1),N={href:"https://ieeexplore.ieee.org/document/6910012/",target:"_blank",rel:"noopener noreferrer"},k=e("li",null,"提出时间：2014",-1),G=e("li",null,"检测方式：基于多张图片初始化模型，然后进行单张图片检测",-1),F=l(`<p>调用接口如下：</p><p><strong>C++</strong></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>saliencyAlgorithm = MotionSaliencyBinWangApr2014::create();
// 设置数据结构大小
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>Python</strong></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>saliencyAlgorithm = cv2.saliency.MotionSaliencyBinWangApr2014_create()
# 设置数据结构大小
