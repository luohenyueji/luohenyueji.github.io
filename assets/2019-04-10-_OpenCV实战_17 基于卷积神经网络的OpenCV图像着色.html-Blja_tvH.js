...
</code></pre><h2 id="_3-代码" tabindex="-1"><a class="header-anchor" href="#_3-代码"><span>3 代码</span></a></h2><p>算法速度很快，但是我个人觉得没加颜色再平衡的效果更好。代码分为图像版本和视频版本。但是总体效果一般般吧。</p><p>代码下载地址：</p>`,21),O={href:"https://github.com/luohenyueji/OpenCV-Practical-Exercise",target:"_blank",rel:"noopener noreferrer"},v=o(`<h3 id="_3-1-图像着色代码" tabindex="-1"><a class="header-anchor" href="#_3-1-图像着色代码"><span>3.1 图像着色代码</span></a></h3><p>C++:</p><pre><code>// OpenCV_Colorization.cpp : 此文件包含 &quot;main&quot; 函数。程序执行将在此处开始并结束。
//
