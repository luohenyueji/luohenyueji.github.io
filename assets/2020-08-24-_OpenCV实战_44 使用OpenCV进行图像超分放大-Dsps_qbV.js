...
<span class="line"><span>    sr.setModel(algorithm, scale)</span></span>
<span class="line"><span>    # 放大图像</span></span>
<span class="line"><span>    img_new = sr.upsample(img)</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-1-2-示例代码" tabindex="-1"><a class="header-anchor" href="#_2-1-2-示例代码"><span>2.1.2 示例代码</span></a></h4><p>主要展示通过OpenCV自带resize函数或调用深度学习将一张图像发大指定倍数，C++代码和Python代码如下。 <strong>C++/dnn_superres.cpp</strong></p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>// 图像超分放大单输出</span></span>
