import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as e,c as t,e as n}from"./app-kCY7hV_E.js";const s={},l=n(`<h1 id="数据与分析可视化-d3入门教程2-在d3中构建形状" tabindex="-1"><a class="header-anchor" href="#数据与分析可视化-d3入门教程2-在d3中构建形状" aria-hidden="true">#</a> [数据与分析可视化] D3入门教程2-在d3中构建形状</h1><p>[toc]</p><p>d3.js是一个用于绘图的JavaScript 库。 它可以可视化展示任何类型的数据。 d3.js允许绘制形状，然后将各种形状构建一个图形。本文档描述了一些函数，可以更有效地从数据中绘制svg。</p><h2 id="形状的添加" tabindex="-1"><a class="header-anchor" href="#形状的添加" aria-hidden="true">#</a> 形状的添加</h2><h3 id="圆形的添加" tabindex="-1"><a class="header-anchor" href="#圆形的添加" aria-hidden="true">#</a> 圆形的添加</h3><p>在svg中绘制圆形。需要三个参数：分别代表圆心x位置的cx、圆心y位置的cy和半径的r。基础调用函数如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;circle style=&quot;fill: #69b3a2&quot; stroke=&quot;black&quot; cx=100 cy=100 r=40&gt;&lt;/circle&gt;
