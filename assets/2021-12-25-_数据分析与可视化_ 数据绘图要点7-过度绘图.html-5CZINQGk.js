import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as a,o as d,c as l,a as e,b as s,d as r,e as t}from"./app-tQFRrlV7.js";const o={},u=t(`<h1 id="数据分析与可视化-数据绘图要点7-过度绘图" tabindex="-1"><a class="header-anchor" href="#数据分析与可视化-数据绘图要点7-过度绘图" aria-hidden="true">#</a> [数据分析与可视化] 数据绘图要点7-过度绘图</h1><p>过度绘图是数据绘图中的一个常见问题。当您的数据集很大时，散点图的点往往会重叠，使图形不可读。在这篇文章中，将给出多种解决方法来避免过度绘图。</p><h2 id="过度绘图实例" tabindex="-1"><a class="header-anchor" href="#过度绘图实例" aria-hidden="true">#</a> 过度绘图实例</h2><p>下面的散点图中说明了过度绘图存在的问题。乍一看可能会得出这样的结论：X 和 Y 之间没有明显的关系。但后续我们将证明这个结论是多么错误。</p><div class="language-R line-numbers-mode" data-ext="R"><pre class="language-R"><code>## ## 加载库
library(tidyverse)
library(hrbrthemes)
library(viridis)
library(patchwork)
