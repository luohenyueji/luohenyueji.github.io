import{_ as p,r as o,o as c,c as i,a as n,b as s,d as e,e as t}from"./app-D9j_HxfT.js";const l={},u=t('<h1 id="编程基础-python内置模块collections使用笔记" tabindex="-1"><a class="header-anchor" href="#编程基础-python内置模块collections使用笔记"><span>[编程基础] Python内置模块collections使用笔记</span></a></h1><p>collections是Python标准库中的一个内置模块，它提供了一些额外的数据结构类型，用于增强Python基础类型如列表（list）、元组（tuple）和字典（dict）等。以下是对collections模块中主要数据结构类的概述：</p><ul><li>namedtuple：命名元组，创建一个带有名称的tuple，并且可以通过名称访问元素。</li><li>deque：双端队列，可以在两端高效地执行插入和删除操作。</li><li>Counter：计数器，用于计算可迭代对象中元素的出现次数。</li><li>defaultdict：默认字典，类似于普通字典，但是在访问不存在的键时会返回一个默认值。</li><li>OrderedDict：有序字典，可以设置字典键值的顺序。</li><li>ChainMap：将多个字典或映射组合在一起的类。</li><li>UserList：列表的包装器类，用于创建自定义列表。</li><li>UserString：字符串的包装器类，用于创建自定义字符串。</li><li>UserDict：字典的包装器类，用于创建自定义字典。</li></ul>',3),d={href:"https://docs.python.org/zh-cn/3.8/library/collections.html",target:"_blank",rel:"noopener noreferrer"},r=t(`<p>[toc]</p><h2 id="_1-namedtuple" tabindex="-1"><a class="header-anchor" href="#_1-namedtuple"><span>1 namedtuple</span></a></h2><p>namedtuple类似于元组（tuple），但是可以通过为每个元素指定名称，从而实现使用元素字段名来引用其元素，而不仅仅依赖于位置索引。</p><p>以下代码展示了namedtuple的使用</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> collections <span class="token keyword">import</span> namedtuple
...
1
[1, 2]
</code></pre><p>deque也支持基于字符串或列表来添加元素，如下所示：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> collections <span class="token keyword">import</span> deque
...
</code></pre><p>deque一些常用函数操作如下所示：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> collections <span class="token keyword">import</span> deque
...
deque([&#39;l&#39;, &#39;l&#39;, &#39;o&#39;, &#39;123&#39;, &#39;H&#39;, &#39;e&#39;])
deque([])
</code></pre><h2 id="_3-counter" tabindex="-1"><a class="header-anchor" href="#_3-counter"><span>3 Counter</span></a></h2><p>Counter用于计算可迭代对象中元素的出现次数，这些可迭代对象可以是列表、字符串、元组等。</p><p>以下代码展示了Counter的使用。</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> collections <span class="token keyword">import</span> Counter
...
(&#39;c&#39;, 1)
(&#39;d&#39;, 2)
</code></pre><p>若分别计算字符串中词的出现次数和字符的出现次数，代码如下：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> collections <span class="token keyword">import</span> Counter
...
</code></pre><p>Counter相关功能函数d的使用如下所示：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> collections <span class="token keyword">import</span> Counter
...
dict_keys([&#39;a&#39;, &#39;c&#39;, &#39;d&#39;, &#39;b&#39;])
dict_values([2, 2, 2, 1])
</code></pre><p>对Counter中单个元素的操作，代码如下：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> collections <span class="token keyword">import</span> Counter
...
</code></pre><h2 id="_4-defaultdict、ordereddict" tabindex="-1"><a class="header-anchor" href="#_4-defaultdict、ordereddict"><span>4 defaultdict、OrderedDict</span></a></h2><h3 id="_4-1-defaultdict" tabindex="-1"><a class="header-anchor" href="#_4-1-defaultdict"><span>4.1 defaultdict</span></a></h3><p>defaultdict是Python标准库collections模块中的一个类，它是dict类的一个子类。defaultdict的作用是创建一个字典，当访问字典中不存在的键时，不会抛出KeyError异常，而是返回一个默认值。defaultdict用法如下：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> collections <span class="token keyword">import</span> defaultdict
...
</code></pre><h3 id="_4-2-ordereddict" tabindex="-1"><a class="header-anchor" href="#_4-2-ordereddict"><span>4.2 OrderedDict</span></a></h3><p>OrderedDict的使用方法与普通字典dict类似，唯一的区别是它可以设置元素的顺序。</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> collections <span class="token keyword">import</span> OrderedDict
...
OrderedDict([(&#39;apple&#39;, 3), (&#39;banana&#39;, 2), (&#39;orange&#39;, 5)])
</code></pre><h2 id="_5-chainmap" tabindex="-1"><a class="header-anchor" href="#_5-chainmap"><span>5 ChainMap</span></a></h2><p>ChainMap用于方便地合并多个字典或映射对象，使它们作为一个整体进行操作。具体使用方法如下：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> collections <span class="token keyword">import</span> ChainMap
...
</code></pre><p>如果要合并的对象中出现键值重合，使用ChainMap时将按照添加顺序，以最先添加的字典为准。在这种情况下，相同的键值经过合并后，会取第一个字典中的值作为重复键的值。具体示例如下：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> collections <span class="token keyword">import</span> ChainMap
...
[&#39;Lisa&#39;, &#39;John&#39;, &#39;Mary&#39;]
[&#39;004&#39;, &#39;001&#39;, &#39;002&#39;]
</code></pre><p>在创建ChainMap对象后，也可以为其添加新的字典类型子项。</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> collections <span class="token keyword">import</span> ChainMap
...
</code></pre><h2 id="_6-userlist、userstring、userdict" tabindex="-1"><a class="header-anchor" href="#_6-userlist、userstring、userdict"><span>6 UserList、UserString、UserDict</span></a></h2><h3 id="_6-1-userlist" tabindex="-1"><a class="header-anchor" href="#_6-1-userlist"><span>6.1 UserList</span></a></h3><p>UserList是list的包装类，用于创建一个自定义的列表类。如下所示，UserList可以像普通list一样操作：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> collections <span class="token keyword">import</span> UserList
...
[13, 4, 1, 5, 7]
[13, 4, 1, 5]
</code></pre><p>UserList的好处在于可以创建一个继承自UserList的子类，以便自定义列表的各个方法。下面是重写了append方法的简单示例：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> collections <span class="token keyword">import</span> UserList
...
[1, 2, 3, 4]
</code></pre><h3 id="_6-2-userstring" tabindex="-1"><a class="header-anchor" href="#_6-2-userstring"><span>6.2 UserString</span></a></h3><p>UserString用于创建自定义字符串类。通过继承UserString类，可以创建自定义的可变字符串对象，并且可以使用各种字符串操作方法。如下所示：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> collections <span class="token keyword">import</span> UserString
...
</code></pre><h3 id="_6-3-userdict" tabindex="-1"><a class="header-anchor" href="#_6-3-userdict"><span>6.3 UserDict</span></a></h3><p>UserDic是一个字典类型的包装类，用于创建自定义字典类。通过继承UserDict类，可以创建自定义的字典对象。如下所示：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> collections <span class="token keyword">import</span> UserDict
...
</code></pre><h2 id="_7-参考" tabindex="-1"><a class="header-anchor" href="#_7-参考"><span>7 参考</span></a></h2>`,74),k={href:"https://docs.python.org/zh-cn/3.8/library/collections.html",target:"_blank",rel:"noopener noreferrer"},m={href:"https://www.machinelearningplus.com/python-collections-guide",target:"_blank",rel:"noopener noreferrer"},v={href:"https://vegibit.com/python-collections-tutorial/",target:"_blank",rel:"noopener noreferrer"};function b(y,g){const a=o("ExternalLinkIcon");return c(),i("div",null,[u,n("p",null,[s("本文主要介绍这些数据类的基础使用方法，以更好地利用Python的collections模块来处理不同类型的数据。关于collections模块更详细的使用介绍可以参考Python官方文档："),n("a",d,[s("python-collections"),e(a)]),s("。")]),r,n("ul",null,[n("li",null,[n("a",k,[s("python-collections"),e(a)])]),n("li",null,[n("a",m,[s("python-collections-guide"),e(a)])]),n("li",null,[n("a",v,[s("python-collections-tutorial"),e(a)])])])])}const _=p(l,[["render",b],["__file","2023-09-05-_编程基础_ Python内置模块collections使用笔记.html.vue"]]),w=JSON.parse('{"path":"/blog/%E7%BC%96%E7%A8%8B%E5%9F%BA%E7%A1%80/%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/2023-09-05-_%E7%BC%96%E7%A8%8B%E5%9F%BA%E7%A1%80_%20Python%E5%86%85%E7%BD%AE%E6%A8%A1%E5%9D%97collections%E4%BD%BF%E7%94%A8%E7%AC%94%E8%AE%B0.html","title":"[编程基础] Python内置模块collections使用笔记","lang":"zh-CN","frontmatter":{"date":"2023-09-05T17:33:12.000Z","category":["编程基础"],"tag":["Python","编程基础"],"description":"[编程基础] Python内置模块collections使用笔记 collections是Python标准库中的一个内置模块，它提供了一些额外的数据结构类型，用于增强Python基础类型如列表（list）、元组（tuple）和字典（dict）等。以下是对collections模块中主要数据结构类的概述： namedtuple：命名元组，创建一个带有名称...","head":[["meta",{"property":"og:url","content":"https://luohenyueji.github.io/blog/%E7%BC%96%E7%A8%8B%E5%9F%BA%E7%A1%80/%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/2023-09-05-_%E7%BC%96%E7%A8%8B%E5%9F%BA%E7%A1%80_%20Python%E5%86%85%E7%BD%AE%E6%A8%A1%E5%9D%97collections%E4%BD%BF%E7%94%A8%E7%AC%94%E8%AE%B0.html"}],["meta",{"property":"og:site_name","content":"落痕月极的博客"}],["meta",{"property":"og:title","content":"[编程基础] Python内置模块collections使用笔记"}],["meta",{"property":"og:description","content":"[编程基础] Python内置模块collections使用笔记 collections是Python标准库中的一个内置模块，它提供了一些额外的数据结构类型，用于增强Python基础类型如列表（list）、元组（tuple）和字典（dict）等。以下是对collections模块中主要数据结构类的概述： namedtuple：命名元组，创建一个带有名称..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"article:author","content":"落痕月极"}],["meta",{"property":"article:tag","content":"Python"}],["meta",{"property":"article:tag","content":"编程基础"}],["meta",{"property":"article:published_time","content":"2023-09-05T17:33:12.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"[编程基础] Python内置模块collections使用笔记\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2023-09-05T17:33:12.000Z\\",\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"落痕月极\\",\\"url\\":\\"/\\"}]}"]]},"headers":[{"level":2,"title":"1 namedtuple","slug":"_1-namedtuple","link":"#_1-namedtuple","children":[]},{"level":2,"title":"2 deque","slug":"_2-deque","link":"#_2-deque","children":[]},{"level":2,"title":"3 Counter","slug":"_3-counter","link":"#_3-counter","children":[]},{"level":2,"title":"4 defaultdict、OrderedDict","slug":"_4-defaultdict、ordereddict","link":"#_4-defaultdict、ordereddict","children":[{"level":3,"title":"4.1 defaultdict","slug":"_4-1-defaultdict","link":"#_4-1-defaultdict","children":[]},{"level":3,"title":"4.2 OrderedDict","slug":"_4-2-ordereddict","link":"#_4-2-ordereddict","children":[]}]},{"level":2,"title":"5 ChainMap","slug":"_5-chainmap","link":"#_5-chainmap","children":[]},{"level":2,"title":"6 UserList、UserString、UserDict","slug":"_6-userlist、userstring、userdict","link":"#_6-userlist、userstring、userdict","children":[{"level":3,"title":"6.1 UserList","slug":"_6-1-userlist","link":"#_6-1-userlist","children":[]},{"level":3,"title":"6.2 UserString","slug":"_6-2-userstring","link":"#_6-2-userstring","children":[]},{"level":3,"title":"6.3 UserDict","slug":"_6-3-userdict","link":"#_6-3-userdict","children":[]}]},{"level":2,"title":"7 参考","slug":"_7-参考","link":"#_7-参考","children":[]}],"git":{},"readingTime":{"minutes":12.93,"words":3878},"filePathRelative":"blog/编程基础/学习笔记/2023-09-05-[编程基础] Python内置模块collections使用笔记.md","localizedDate":"2023年9月6日","excerpt":"\\n<p>collections是Python标准库中的一个内置模块，它提供了一些额外的数据结构类型，用于增强Python基础类型如列表（list）、元组（tuple）和字典（dict）等。以下是对collections模块中主要数据结构类的概述：</p>\\n<ul>\\n<li>namedtuple：命名元组，创建一个带有名称的tuple，并且可以通过名称访问元素。</li>\\n<li>deque：双端队列，可以在两端高效地执行插入和删除操作。</li>\\n<li>Counter：计数器，用于计算可迭代对象中元素的出现次数。</li>\\n<li>defaultdict：默认字典，类似于普通字典，但是在访问不存在的键时会返回一个默认值。</li>\\n<li>OrderedDict：有序字典，可以设置字典键值的顺序。</li>\\n<li>ChainMap：将多个字典或映射组合在一起的类。</li>\\n<li>UserList：列表的包装器类，用于创建自定义列表。</li>\\n<li>UserString：字符串的包装器类，用于创建自定义字符串。</li>\\n<li>UserDict：字典的包装器类，用于创建自定义字典。</li>\\n</ul>","autoDesc":true}');export{_ as comp,w as data};
