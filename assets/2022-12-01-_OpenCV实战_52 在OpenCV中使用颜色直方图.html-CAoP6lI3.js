...
<span class="token keyword">if</span> __name__ <span class="token operator">==</span> <span class="token string">&quot;__main__&quot;</span><span class="token punctuation">:</span>
    main<span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),B={href:"https://blog.csdn.net/LuohenYJ/article/details/84957101",target:"_blank",rel:"noopener noreferrer"},w={href:"https://blog.csdn.net/LuohenYJ/article/details/88237008",target:"_blank",rel:"noopener noreferrer"},y=e(`<div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>#include &quot;opencv2/highgui.hpp&quot;
#include &quot;opencv2/imgcodecs.hpp&quot;
#include &quot;opencv2/imgproc.hpp&quot;
#include &lt;iostream&gt;
using namespace std;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7),O={href:"https://blog.csdn.net/LuohenYJ/article/details/119392091",target:"_blank",rel:"noopener noreferrer"},q=e(`<p>下面的代码展示了compareHist函数的使用方式，代码综合hsv空间的h通道（色调）和s通道（饱和度）计算图像的颜色直方图。</p><p><strong>C++</strong></p><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>#include &quot;opencv2/imgcodecs.hpp&quot;
#include &quot;opencv2/highgui.hpp&quot;
#include &quot;opencv2/imgproc.hpp&quot;
#include &lt;iostream&gt;
using namespace std;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-反向投影" tabindex="-1"><a class="header-anchor" href="#_4-反向投影"><span>4 反向投影</span></a></h2>`,10),f={href:"https://ieeexplore.ieee.org/document/139558",target:"_blank",rel:"noopener noreferrer"},A={href:"https://www.cnblogs.com/bjxqmy/p/12452420.html",target:"_blank",rel:"noopener noreferrer"},V={href:"https://blog.csdn.net/hysterisis/article/details/113097507",target:"_blank",rel:"noopener noreferrer"},M=e(`<p><strong>C++</strong></p><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>#include &quot;opencv2/imgproc.hpp&quot;
#include &quot;opencv2/imgcodecs.hpp&quot;
#include &quot;opencv2/highgui.hpp&quot;
#include &lt;iostream&gt;
using namespace cv;
...
<span class="token keyword">if</span> __name__ <span class="token operator">==</span> <span class="token string">&quot;__main__&quot;</span><span class="token punctuation">:</span>
    main<span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>结果如下所示，可以看到反向投影结果是不太准的，毕竟是很简单也是很古老的的算法，了解下就好。真正想要实现图像分割，还是看看深度学习。</p><table><thead><tr><th>类型</th><th>结果</th></tr></thead><tbody><tr><td>感兴趣对象</td><td><img src="https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/[OpenCV实战]52 在OpenCV中使用颜色直方图/image/test3.jpg" alt="" loading="lazy"></td></tr><tr><td>输入对象</td><td><img src="https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/[OpenCV实战]52 在OpenCV中使用颜色直方图/image/test2.jpg" alt="" loading="lazy"></td></tr><tr><td>反向投影结果</td><td><img src="https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/[OpenCV实战]52 在OpenCV中使用颜色直方图/image/thresh.jpg" alt="" loading="lazy"></td></tr><tr><td>匹配结果</td><td><img src="https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/[OpenCV实战]52 在OpenCV中使用颜色直方图/image/res.jpg" alt="" loading="lazy"></td></tr></tbody></table><h2 id="_5-参考" tabindex="-1"><a class="header-anchor" href="#_5-参考"><span>5 参考</span></a></h2>`,7),D={href:"https://cloud.tencent.com/developer/article/1769742",target:"_blank",rel:"noopener noreferrer"},S={href:"https://docs.opencv.org/4.4.0/d6/dc7/group__imgproc__hist.html#gad689d2607b7b3889453804f414ab1018",target:"_blank",rel:"noopener noreferrer"},z={href:"https://zhuanlan.zhihu.com/p/382430357",target:"_blank",rel:"noopener noreferrer"},R={href:"https://www.cnblogs.com/Imageshop/archive/2013/04/07/3006334.html",target:"_blank",rel:"noopener noreferrer"},N={href:"https://blog.csdn.net/LuohenYJ/article/details/84957101",target:"_blank",rel:"noopener noreferrer"},H={href:"https://blog.csdn.net/LuohenYJ/article/details/88237008",target:"_blank",rel:"noopener noreferrer"},L={href:"https://blog.csdn.net/LuohenYJ/article/details/119392091",target:"_blank",rel:"noopener noreferrer"},I={href:"https://ieeexplore.ieee.org/document/139558",target:"_blank",rel:"noopener noreferrer"},j={href:"https://www.cnblogs.com/bjxqmy/p/12452420.html",target:"_blank",rel:"noopener noreferrer"},Y={href:"https://blog.csdn.net/hysterisis/article/details/113097507",target:"_blank",rel:"noopener noreferrer"};function J(x,G){const a=p("ExternalLinkIcon");return c(),o("div",null,[u,n("p",null,[s("颜色直方图是一种常见的图像特征，顾名思义颜色直方图就是用来反映图像颜色组成分布的直方图。颜色直方图的横轴表示像素值或像素值范围，纵轴表示该像素值范围内像素点的个数或出现频率。颜色直方图属于计算机视觉中的基础概念，其常常被应用于图像相似度计算，"),n("a",r,[s("视觉词袋"),t(a)]),s("，图像颜色平衡等。颜色直方图可以基于不同的颜色空间和坐标系来实现，本文主要基于RGB颜色空间和直角坐标系计算颜色直方图。")]),n("p",null,[s("颜色直方图是图像的一种全局颜色特征，优点为方法简单、计算迅速、对旋转和尺度等变化不敏感，缺点是忽略了图像的空间分布信息以及用于相似度对比时往往不那么准确。当然对于颜色直方图有一些改进的变种算法，但是本文只介绍最原始的颜色直方图计算方法。因为改进过的算法提效不高，还不如直接用深度学习。本文主要内容有：颜色直方图的计算、图像均衡化、直方图比较和反向投影，涉及到用于直方图计算的OpenCV函数出自"),n("a",d,[s("OpenCV_Histograms"),t(a)]),s("。")]),v,m,n("ul",null,[n("li",null,[s("github: "),n("a",k,[s("OpenCV-Practical-Exercise"),t(a)])]),n("li",null,[s("gitee(备份，主要是下载速度快): "),n("a",b,[s("OpenCV-Practical-Exercise-gitee"),t(a)])])]),h,n("p",null,[s("图像均衡化是一种提高图像对比度的方法，通过变换函数将原图像的直方图修正为分布比较均匀的直方图，从而改变图像整体偏暗或整体偏亮，灰度层次不丰富的情况。图像均衡化的具体原理见："),n("a",g,[s("直方图均衡化详解"),t(a)]),s("。在OpenCV中提供equalizeHist函数实现直方图的均衡化，但是equalizeHist函数只对灰度图进行运算。")]),_,n("p",null,[s("但是标准的直方图均衡会导致图中部分区域由于对比度增强过大而成为噪点；或导致一些区域调整后变得更暗/更亮而丢失细节信息。所以面对这种情况，OpenCV提供自适应直方图均衡以获得更好的结果。 自适应直方图均衡的工作原理是将图像划分为MxN个网格，然后将直方图均衡局部应用于每个网格，同时设置对比度限制阈值。结果是输出图像总体上具有更高的对比度（理想情况下）并抑制噪声。OpenCV实现自适应直方图的代码结果如上所示，可以看到直方图分布更加平滑。自适应直方图均衡缺点是效果很依靠手动调整参数（传统图像算法的通病），其具体原理见"),n("a",E,[s("限制对比度自适应直方图均衡化算法原理、实现及效果"),t(a)]),s("，实现代码如下：")]),C,n("p",null,[s("如果想对彩色图进行直方图均衡化，则有两种办法：1）分别对RGB三通道均衡化，再组合通道图输出结果；2）将图像颜色空间转化为YUV，YCbCr等颜色空间，仅对亮度通道进行均衡化，最后组合通道图并转回RGB空间。在这里推荐使用第二种办法，具体原因看下面示例代码的结果。所用的转换颜色空间是YUV颜色空间，想要进一步了解YUV颜色空间见"),n("a",B,[s("YUV图像处理入门1"),t(a)]),s("及其他颜色空间见"),n("a",w,[s("OpenCV中的颜色空间"),t(a)]),s("。")]),y,n("p",null,[s("以上评价指标可以自行搜索查询相关含义，具体使用哪个评价指标好完全取决于数据集和目标，所以需要通过实验来确定效果最佳的指标。当然也可以自己设计评价指标，不过通过用直方图比较来衡量图片相似性本身效果不太好，各种评价指标都大差不差。直方图比较特点就是快，简单但是不太准。如果想了解其他基于图像处理算法的图片相似度比较方法可以参考"),n("a",O,[s("基于图像哈希构建图像相似度对比算法"),t(a)]),s("。")]),q,n("p",null,[s("反向投影（Histogram Backprojection）于1990年在论文"),n("a",f,[s("Indexing via color histograms"),t(a)]),s("提出。反向投影的作用简单来说，就是进行图像分割或在图像中查找感兴趣的对象。通过创建了一个与输入图像大小相同（但只有一个通道）的图像，该图片每个像素对应于该像素属于该兴趣对象的概率。一般步骤为计算某一感兴趣区域特征的直方图模型，然后使用这个直方图模型去寻找图像中和该特征相似的区域。在OpenCV中使用calcBackProject函数来实现反向投影。关于calcBackProject函数介绍见"),n("a",A,[s("calcBackProject 反向投影"),t(a)]),s("。")]),n("p",null,[s("下面示例展示了反向投影的代码，代码以某块草地图片为感兴趣对象，检索输入图像中包含类似草地的区域。代码中涉及到的fliter2D函数使用见"),n("a",V,[s("cv.filter2D()函数详解"),t(a)]),s("。")]),M,n("ul",null,[n("li",null,[n("a",D,[s("视觉词袋"),t(a)])]),n("li",null,[n("a",S,[s("OpenCV_Histograms"),t(a)])]),n("li",null,[n("a",z,[s("图像直方图均衡化详解"),t(a)])]),n("li",null,[n("a",R,[s("限制对比度自适应直方图均衡化算法原理、实现及效果"),t(a)])]),n("li",null,[n("a",N,[s("YUV图像处理入门1"),t(a)])]),n("li",null,[n("a",H,[s("OpenCV中的颜色空间"),t(a)])]),n("li",null,[n("a",L,[s("基于图像哈希构建图像相似度对比算法"),t(a)])]),n("li",null,[n("a",I,[s("Indexing via color histograms"),t(a)])]),n("li",null,[n("a",j,[s("calcBackProject 反向投影"),t(a)])]),n("li",null,[n("a",Y,[s("cv.filter2D() 函数详解"),t(a)])])])])}const F=i(l,[["render",J],["__file","2022-12-01-_OpenCV实战_52 在OpenCV中使用颜色直方图.html.vue"]]),T=JSON.parse('{"path":"/blog/opencv/opencv%E5%AE%9E%E6%88%98/2022-12-01-_OpenCV%E5%AE%9E%E6%88%98_52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE.html","title":"[OpenCV实战]52 在OpenCV中使用颜色直方图","lang":"zh-CN","frontmatter":{"category":["OpenCV"],"date":"2022-12-01T20:46:47.000Z","tag":["OpenCV实战","OpenCV","图像处理"],"description":"[OpenCV实战]52 在OpenCV中使用颜色直方图 颜色直方图是一种常见的图像特征，顾名思义颜色直方图就是用来反映图像颜色组成分布的直方图。颜色直方图的横轴表示像素值或像素值范围，纵轴表示该像素值范围内像素点的个数或出现频率。颜色直方图属于计算机视觉中的基础概念，其常常被应用于图像相似度计算，视觉词袋，图像颜色平衡等。颜色直方图可以基于不同的颜色...","head":[["meta",{"property":"og:url","content":"https://luohenyueji.github.io/blog/opencv/opencv%E5%AE%9E%E6%88%98/2022-12-01-_OpenCV%E5%AE%9E%E6%88%98_52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE.html"}],["meta",{"property":"og:site_name","content":"落痕月极的博客"}],["meta",{"property":"og:title","content":"[OpenCV实战]52 在OpenCV中使用颜色直方图"}],["meta",{"property":"og:description","content":"[OpenCV实战]52 在OpenCV中使用颜色直方图 颜色直方图是一种常见的图像特征，顾名思义颜色直方图就是用来反映图像颜色组成分布的直方图。颜色直方图的横轴表示像素值或像素值范围，纵轴表示该像素值范围内像素点的个数或出现频率。颜色直方图属于计算机视觉中的基础概念，其常常被应用于图像相似度计算，视觉词袋，图像颜色平衡等。颜色直方图可以基于不同的颜色..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/%5BOpenCV%E5%AE%9E%E6%88%98%5D52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE/image/img1_1.jpg"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"name":"twitter:card","content":"summary_large_image"}],["meta",{"name":"twitter:image:alt","content":"[OpenCV实战]52 在OpenCV中使用颜色直方图"}],["meta",{"property":"article:author","content":"落痕月极"}],["meta",{"property":"article:tag","content":"OpenCV实战"}],["meta",{"property":"article:tag","content":"OpenCV"}],["meta",{"property":"article:tag","content":"图像处理"}],["meta",{"property":"article:published_time","content":"2022-12-01T20:46:47.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"[OpenCV实战]52 在OpenCV中使用颜色直方图\\",\\"image\\":[\\"https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/%5BOpenCV%E5%AE%9E%E6%88%98%5D52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE/image/img1_1.jpg\\",\\"https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/%5BOpenCV%E5%AE%9E%E6%88%98%5D52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE/image/img1_2.jpg\\",\\"https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/%5BOpenCV%E5%AE%9E%E6%88%98%5D52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE/image/img2_1.jpg\\",\\"https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/%5BOpenCV%E5%AE%9E%E6%88%98%5D52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE/image/img2_2.jpg\\",\\"https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/%5BOpenCV%E5%AE%9E%E6%88%98%5D52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE/image/img2_3.jpg\\",\\"https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/%5BOpenCV%E5%AE%9E%E6%88%98%5D52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE/image/img2_4.jpg\\",\\"https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/%5BOpenCV%E5%AE%9E%E6%88%98%5D52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE/image/img2_5.jpg\\",\\"https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/%5BOpenCV%E5%AE%9E%E6%88%98%5D52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE/image/img2_6.jpg\\",\\"https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/%5BOpenCV%E5%AE%9E%E6%88%98%5D52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE/image/img1_1.jpg\\",\\"https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/%5BOpenCV%E5%AE%9E%E6%88%98%5D52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE/image/img2_7.jpg\\",\\"https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/%5BOpenCV%E5%AE%9E%E6%88%98%5D52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE/image/img2_8.jpg\\",\\"https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/%5BOpenCV%E5%AE%9E%E6%88%98%5D52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE/image/lena.jpg\\",\\"https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/%5BOpenCV%E5%AE%9E%E6%88%98%5D52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE/image/lena_resize.jpg\\",\\"https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/%5BOpenCV%E5%AE%9E%E6%88%98%5D52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE/image/lena_flip.jpg\\",\\"https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/%5BOpenCV%E5%AE%9E%E6%88%98%5D52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE/image/test.jpg\\",\\"https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/%5BOpenCV%E5%AE%9E%E6%88%98%5D52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE/image/test3.jpg\\",\\"https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/%5BOpenCV%E5%AE%9E%E6%88%98%5D52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE/image/test2.jpg\\",\\"https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/%5BOpenCV%E5%AE%9E%E6%88%98%5D52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE/image/thresh.jpg\\",\\"https://gitcode.net/LuohenYJ/article_picture_warehouse/-/raw/main/CSDN/%5BOpenCV%E5%AE%9E%E6%88%98%5D52%20%E5%9C%A8OpenCV%E4%B8%AD%E4%BD%BF%E7%94%A8%E9%A2%9C%E8%89%B2%E7%9B%B4%E6%96%B9%E5%9B%BE/image/res.jpg\\"],\\"datePublished\\":\\"2022-12-01T20:46:47.000Z\\",\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"落痕月极\\",\\"url\\":\\"/\\"}]}"]]},"headers":[{"level":2,"title":"1 颜色直方图的计算","slug":"_1-颜色直方图的计算","link":"#_1-颜色直方图的计算","children":[]},{"level":2,"title":"2 图像均衡化","slug":"_2-图像均衡化","link":"#_2-图像均衡化","children":[]},{"level":2,"title":"3 直方图比较","slug":"_3-直方图比较","link":"#_3-直方图比较","children":[]},{"level":2,"title":"4 反向投影","slug":"_4-反向投影","link":"#_4-反向投影","children":[]},{"level":2,"title":"5 参考","slug":"_5-参考","link":"#_5-参考","children":[]}],"git":{},"readingTime":{"minutes":20.16,"words":6049},"filePathRelative":"blog/opencv/opencv实战/2022-12-01-[OpenCV实战]52 在OpenCV中使用颜色直方图.md","localizedDate":"2022年12月2日","excerpt":"\\n<p>颜色直方图是一种常见的图像特征，顾名思义颜色直方图就是用来反映图像颜色组成分布的直方图。颜色直方图的横轴表示像素值或像素值范围，纵轴表示该像素值范围内像素点的个数或出现频率。颜色直方图属于计算机视觉中的基础概念，其常常被应用于图像相似度计算，<a href=\\"https://cloud.tencent.com/developer/article/1769742\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">视觉词袋</a>，图像颜色平衡等。颜色直方图可以基于不同的颜色空间和坐标系来实现，本文主要基于RGB颜色空间和直角坐标系计算颜色直方图。</p>","autoDesc":true}');export{F as comp,T as data};
