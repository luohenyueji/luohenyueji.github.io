import{_ as t,r as n,o as a,c as l,a as e,b as d,d as s,e as r}from"./app-CD_-ggd_.js";const o={},c=r(`<h1 id="编程基础-c-多线程入门7-条件变量介绍" tabindex="-1"><a class="header-anchor" href="#编程基础-c-多线程入门7-条件变量介绍"><span>[编程基础] C++多线程入门7-条件变量介绍</span></a></h1><p>原始C++标准仅支持单线程编程。新的C++标准(称为C++11或C++0x)于2011年发布。在C++11中，引入了新的线程库。因此运行本文程序需要C++至少符合C++11标准。</p><h2 id="_7-条件变量介绍" tabindex="-1"><a class="header-anchor" href="#_7-条件变量介绍"><span>7 条件变量介绍</span></a></h2><p>在本文中，我们将通过示例讨论C ++ 11多线程中条件变量的用法。</p><h3 id="_7-1-条件变量" tabindex="-1"><a class="header-anchor" href="#_7-1-条件变量"><span>7.1 条件变量</span></a></h3><p>条件变量是一种事件，用于在两个或多个线程之间发出信号。一个或多个线程可以等待它发出信号，而另一个线程可以发出信号。 C ++ 11中的条件变量所需的头文件是：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>#include &lt;condition_variable&gt;
