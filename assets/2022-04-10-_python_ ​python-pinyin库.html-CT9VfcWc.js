import{_ as p,r as i,o as l,c as o,a as n,b as s,d as e,e as t}from"./app-BFw6ZVWV.js";const c={},r=n("h1",{id:"python-​python-pinyin库",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#python-​python-pinyin库"},[n("span",null,"[python] ​python-pinyin库")])],-1),u=n("p",null,"python-pinyin库是一个汉字拼音转换工具，其主要功能有：",-1),d=n("ul",null,[n("li",null,"根据词组智能匹配最正确的拼音。"),n("li",null,"支持多音字。"),n("li",null,"简单的繁体支持, 注音支持。"),n("li",null,"支持多种不同拼音风格。")],-1),k=n("p",null,[s("安装命令为："),n("code",null,"pip install pypinyin")],-1),y={href:"https://github.com/mozillazg/python-pinyin",target:"_blank",rel:"noopener noreferrer"},v={href:"https://pypinyin.readthedocs.io/zh_CN/master/",target:"_blank",rel:"noopener noreferrer"},m=t(`<h2 id="_1-api使用" tabindex="-1"><a class="header-anchor" href="#_1-api使用"><span>1 api使用</span></a></h2><h3 id="_1-1-pypinyin-pinyin" tabindex="-1"><a class="header-anchor" href="#_1-1-pypinyin-pinyin"><span>1.1 pypinyin.pinyin</span></a></h3><p>pypinyin的常用函数为pinyin，即将汉字转换为拼音，返回汉字的拼音列表。</p><blockquote><p>pypinyin.pinyin(hans, style=Style.TONE, heteronym=False, errors=&#39;default&#39;, strict=True, v_to_u=False, neutral_tone_with_five=False)</p></blockquote><p>pinyin的参数介绍如下：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>参数
...
返回类型：list。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>拼音风格style的可选参数列表如下：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>#: 普通风格，不带声调。如： 中国 -&gt; \`\`zhong guo\`\`
NORMAL = 0
...
WADEGILES = 14
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>errors处理方式如下：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>&#39;default&#39;: 保留原始字符
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>具体函数和参数使用如下：</p><p><strong>基础使用</strong></p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> pypinyin <span class="token keyword">import</span> pinyin
...
[[&#39;zhòng&#39;], [&#39;dú&#39;]]
</code></pre><p><strong>设置拼音风格</strong></p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> pypinyin <span class="token keyword">import</span> pinyin<span class="token punctuation">,</span> Style
...
[[&#39;z&#39;], [&#39;x&#39;]]
[[&#39;ong&#39;], [&#39;in&#39;]]
</code></pre><p><strong>v_to_u</strong></p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token comment"># 使用 ü 代替原来的 v</span>
...
[[&#39;zhan&#39;], [&#39;lve&#39;]]
</code></pre><p><strong>neutral_tone_with_five</strong></p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token comment"># 声调风格下是否用5表示轻声</span>
...
[[&#39;yi1&#39;], [&#39;shang&#39;]]
</code></pre><p><strong>处理不包含拼音的字符</strong></p><p>根据errors 参数的值做相应的处理即可。</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token comment"># default (默认行为): 不做任何处理，原样返回:</span>
...
</code></pre><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token comment"># ignore : 忽略该字符</span>
...
</code></pre><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token comment"># replace : 替换为去掉 \\u 的 unicode 编码:</span>
...
</code></pre><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token comment"># callable 对象 : 提供一个回调函数，接受无拼音字符(串)作为参数, 支持的返回值类型: unicode 或 list 或 None 。</span>
...
[&#39;zhong&#39;, &#39;du&#39;]
</code></pre><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token comment"># 是否按照声调变调规则对拼音进行处理</span>
...
[&#39;ni3&#39;, &#39;ha3o&#39;]
</code></pre><h3 id="_1-3-load-single-dict和load-phrases-dict" tabindex="-1"><a class="header-anchor" href="#_1-3-load-single-dict和load-phrases-dict"><span>1.3 load_single_dict和load_phrases_dict</span></a></h3><p>pypinyin.load_single_dict用于载入用户自定义的单字拼音库。</p><blockquote><p>pypinyin.load_single_dict(pinyin_dict, style=&#39;default&#39;)</p></blockquote><p>pypinyin.load_single_dict的参数介绍如下：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>pinyin_dict (dict) – 单字拼音库。比如： {0x963F: u&quot;ā,ē&quot;}
style – pinyin_dict 参数值的拼音库风格. 支持 ‘default’, ‘tone2’
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>pypinyin.load_phrases_dict用于载入用户自定义的词语拼音库。</p><blockquote><p>pypinyin.load_phrases_dict(phrases_dict, style=&#39;default&#39;)</p></blockquote><p>pypinyin.load_phrases_dict的参数介绍如下：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>phrases_dict (dict) – 词语拼音库。比如： {u&quot;阿爸&quot;: [[u&quot;ā&quot;], [u&quot;bà&quot;]]}
style – phrases_dict 参数值的拼音库风格. 支持 ‘default’, ‘tone2’
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>具体函数和参数使用如下：</p><p><strong>增加单字</strong></p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> pypinyin <span class="token keyword">import</span> lazy_pinyin<span class="token punctuation">,</span> load_phrases_dict<span class="token punctuation">,</span> Style<span class="token punctuation">,</span> load_single_dict
...
[&#39;ju2&#39;, &#39;zi3&#39;]
</code></pre><p><strong>pypinyin-dict</strong></p>`,66),g={href:"https://github.com/mozillazg/pypinyin-dict",target:"_blank",rel:"noopener noreferrer"},b=t(`<blockquote><p>pip install pypinyin-dict</p></blockquote><p><strong>示例</strong></p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> pypinyin <span class="token keyword">import</span> pinyin
...
[[&#39;zhōng&#39;], [&#39;xīn&#39;]]
</code></pre><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> pypinyin <span class="token keyword">import</span> pinyin
...
[[&#39;rēng&#39;]]
</code></pre><h3 id="_1-4-pypinyin-slug" tabindex="-1"><a class="header-anchor" href="#_1-4-pypinyin-slug"><span>1.4 pypinyin.slug</span></a></h3><p>pypinyin.slug将汉字转换为拼音，然后生成slug字符串。</p><blockquote><p>pypinyin.slug(hans, style=Style.NORMAL, heteronym=False, separator=&#39;-&#39;, errors=&#39;default&#39;, strict=True)</p></blockquote><p>pypinyin.slug的参数介绍如下：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>hans (unicode 字符串或字符串列表) – 汉字字符串( &#39;你好吗&#39; )或列表( [&#39;你好&#39;, &#39;吗&#39;] ). 可以使用自己喜爱的分词模块对字符串进行分词处理, 只需将经过分词处理的字符串列表传进来就可以了。
...
返回：slug字符串.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>示例</strong></p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">import</span> pypinyin
...
ni|wo|ta
n-w-t
</code></pre><h3 id="_1-5-pypinyin-style-register" tabindex="-1"><a class="header-anchor" href="#_1-5-pypinyin-style-register"><span>1.5 pypinyin.style.register</span></a></h3><p>pypinyin.style.register用于注册一个拼音风格实现。示例注册方式如下：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>@register(&#39;echo&#39;)
def echo(pinyin, **kwargs):
    return pinyin

# or
register(&#39;echo&#39;, echo)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>具体使用看示例代码理解：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> pypinyin <span class="token keyword">import</span> lazy_pinyin
...
[&#39;😘 me&#39;, &#39;😘 me&#39;]
</code></pre><h2 id="_2-参考" tabindex="-1"><a class="header-anchor" href="#_2-参考"><span>2 参考</span></a></h2>`,21),h={href:"https://github.com/mozillazg/python-pinyin",target:"_blank",rel:"noopener noreferrer"},_={href:"https://pypinyin.readthedocs.io/zh_CN/master/",target:"_blank",rel:"noopener noreferrer"},x={href:"https://github.com/mozillazg/pypinyin-dict",target:"_blank",rel:"noopener noreferrer"};function w(z,f){const a=i("ExternalLinkIcon");return l(),o("div",null,[r,u,d,k,n("p",null,[s("官方仓库为："),n("a",y,[s("python-pinyin"),e(a)])]),n("p",null,[s("官方中文文档为："),n("a",v,[s("pypinyin文档"),e(a)])]),m,n("p",null,[s("使用"),n("a",g,[s("pypinyin-dict"),e(a)]),s("项目提供的自定义拼音库可以纠正结果。但是需要安装该自定义拼音库。")]),b,n("ul",null,[n("li",null,[n("p",null,[n("a",h,[s("python-pinyin"),e(a)])])]),n("li",null,[n("p",null,[n("a",_,[s("pypinyin文档"),e(a)])])]),n("li",null,[n("p",null,[n("a",x,[s("pypinyin-dict"),e(a)])])])])])}const N=p(c,[["render",w],["__file","2022-04-10-_python_ ​python-pinyin库.html.vue"]]),S=JSON.parse('{"path":"/blog/python/python%E5%AD%A6%E4%B9%A0/2022-04-10-_python_%20%E2%80%8Bpython-pinyin%E5%BA%93.html","title":"[python] ​python-pinyin库","lang":"zh-CN","frontmatter":{"date":"2022-04-10T11:02:17.000Z","category":["Python"],"tag":["Python"],"description":"[python] ​python-pinyin库 python-pinyin库是一个汉字拼音转换工具，其主要功能有： 根据词组智能匹配最正确的拼音。 支持多音字。 简单的繁体支持, 注音支持。 支持多种不同拼音风格。 安装命令为：pip install pypinyin 官方仓库为：python-pinyin 官方中文文档为：pypinyin文档 1 ...","head":[["meta",{"property":"og:url","content":"https://luohenyueji.github.io/blog/python/python%E5%AD%A6%E4%B9%A0/2022-04-10-_python_%20%E2%80%8Bpython-pinyin%E5%BA%93.html"}],["meta",{"property":"og:site_name","content":"落痕月极的博客"}],["meta",{"property":"og:title","content":"[python] ​python-pinyin库"}],["meta",{"property":"og:description","content":"[python] ​python-pinyin库 python-pinyin库是一个汉字拼音转换工具，其主要功能有： 根据词组智能匹配最正确的拼音。 支持多音字。 简单的繁体支持, 注音支持。 支持多种不同拼音风格。 安装命令为：pip install pypinyin 官方仓库为：python-pinyin 官方中文文档为：pypinyin文档 1 ..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"article:author","content":"落痕月极"}],["meta",{"property":"article:tag","content":"Python"}],["meta",{"property":"article:published_time","content":"2022-04-10T11:02:17.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"[python] ​python-pinyin库\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2022-04-10T11:02:17.000Z\\",\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"落痕月极\\",\\"url\\":\\"/\\"}]}"]]},"headers":[{"level":2,"title":"1 api使用","slug":"_1-api使用","link":"#_1-api使用","children":[{"level":3,"title":"1.1 pypinyin.pinyin","slug":"_1-1-pypinyin-pinyin","link":"#_1-1-pypinyin-pinyin","children":[]},{"level":3,"title":"1.2 pypinyin.lazy_pinyin","slug":"_1-2-pypinyin-lazy-pinyin","link":"#_1-2-pypinyin-lazy-pinyin","children":[]},{"level":3,"title":"1.3 load_single_dict和load_phrases_dict","slug":"_1-3-load-single-dict和load-phrases-dict","link":"#_1-3-load-single-dict和load-phrases-dict","children":[]},{"level":3,"title":"1.4 pypinyin.slug","slug":"_1-4-pypinyin-slug","link":"#_1-4-pypinyin-slug","children":[]},{"level":3,"title":"1.5 pypinyin.style.register","slug":"_1-5-pypinyin-style-register","link":"#_1-5-pypinyin-style-register","children":[]}]},{"level":2,"title":"2 参考","slug":"_2-参考","link":"#_2-参考","children":[]}],"git":{},"readingTime":{"minutes":7.13,"words":2139},"filePathRelative":"blog/python/python学习/2022-04-10-[python] ​python-pinyin库.md","localizedDate":"2022年4月10日","excerpt":"\\n<p>python-pinyin库是一个汉字拼音转换工具，其主要功能有：</p>\\n<ul>\\n<li>根据词组智能匹配最正确的拼音。</li>\\n<li>支持多音字。</li>\\n<li>简单的繁体支持, 注音支持。</li>\\n<li>支持多种不同拼音风格。</li>\\n</ul>\\n<p>安装命令为：<code>pip install pypinyin</code></p>\\n<p>官方仓库为：<a href=\\"https://github.com/mozillazg/python-pinyin\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">python-pinyin</a></p>","autoDesc":true}');export{N as comp,S as data};
