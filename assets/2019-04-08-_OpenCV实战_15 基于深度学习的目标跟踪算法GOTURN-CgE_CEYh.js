...
while True:
    ...
    if k == 27:
        break
</code></pre><h2 id="_3-goturn-优缺点" tabindex="-1"><a class="header-anchor" href="#_3-goturn-优缺点"><span><strong>3 GOTURN</strong> <strong>优缺点</strong></span></a></h2><p>与其他基于深度学习的跟踪器相比，GOTURN速度更快。它在Caffe的GPU上以100FPS运行，在OpenCV CPU中以20FPS运行。即使跟踪器是通用的，理论上，通过使用特定类型的对象偏置训练集，可以在特定对象（例如行人）上获得优异的结果。</p><p>个人观点：</p><p>GOTURN速度和MIL水平差不多，如果是在特定对象上进行目标跟踪，精度能够达到KCF算法的水平。如果不是特定对象，精度和BOOSTING差不多。特定对象是指模型训练集的场景。总的来说GOTURN不推荐，还不如用KCF算法。除非你有大量数据训练GOTURN模型。不过有这个数据和算法还不如训练目标检测模型，每帧都检测。</p><h2 id="_4-参考" tabindex="-1"><a class="header-anchor" href="#_4-参考"><span>4 参考</span></a></h2><p><a href="https://www.learnopencv.com/goturn-deep-learning-based-object-tracking/" target="_blank" rel="noopener noreferrer"> https://www.learnopencv.com/goturn-deep-learning-based-object-tracking/</a></p>`,35)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};