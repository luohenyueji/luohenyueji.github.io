import{_ as r}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as i,o,c as p,a as n,b as t,d as a,e as s}from"./app-MsA2k2kn.js";const l={},c=s(`<h1 id="常用工具-深度学习caffe处理工具" tabindex="-1"><a class="header-anchor" href="#常用工具-深度学习caffe处理工具" aria-hidden="true">#</a> [常用工具] 深度学习Caffe处理工具</h1><p>对于机器学习、图像处理有时要对图像数据进行分割处理。用python写了一些常用小工具代码。</p><h2 id="_1-caffe数据集txt文本制作" tabindex="-1"><a class="header-anchor" href="#_1-caffe数据集txt文本制作" aria-hidden="true">#</a> 1 Caffe数据集txt文本制作</h2><p>很多时候要建立如下数据集txt文本，类似图片所示（图片网上找的)</p><figure><img src="https://img-blog.csdnimg.cn/20190121145819354.jpg?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0x1b2hlbllK,size_16,color_FFFFFF,t_70" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>生成代码如下：</p><pre><code>&quot;&quot;&quot;
caffe数据集txt文本制作
&quot;&quot;&quot;
...
f.close()
</code></pre><h2 id="_2-jpg图像完整性检测" tabindex="-1"><a class="header-anchor" href="#_2-jpg图像完整性检测" aria-hidden="true">#</a> 2 jpg图像完整性检测</h2><p>有时爬虫所获得图像可能不完整，需要进行图像完整性检测。代码如下：</p><pre><code>&quot;&quot;&quot;
jpg图像完整性检测
&quot;&quot;&quot;
...
if __name__ == &#39;__main__&#39;:
    ...
    print(&quot;end!&quot;)
    f.close()
</code></pre><h2 id="_3-图像随机移动复制" tabindex="-1"><a class="header-anchor" href="#_3-图像随机移动复制" aria-hidden="true">#</a> 3 图像随机移动复制</h2><p>对于windows系统，移动太慢，也费时。linux也差不多。通过python可以快速移动/复制大量图像，代码如下：</p><pre><code>&quot;&quot;&quot;
图像随机移动复制
&quot;&quot;&quot;
...
</code></pre><h2 id="_4-图像尺寸统计" tabindex="-1"><a class="header-anchor" href="#_4-图像尺寸统计" aria-hidden="true">#</a> 4 图像尺寸统计</h2><p>主要是统计图像尺寸，可以添加过滤条件，滤掉尺寸过小或者过大的图像。代码如下：</p><pre><code>&quot;&quot;&quot;
统计数据集下图像尺寸
&quot;&quot;&quot;
...
df.to_csv(&#39;test.csv&#39;)
f.close()
</code></pre><h2 id="_5-图像名字后缀重命名" tabindex="-1"><a class="header-anchor" href="#_5-图像名字后缀重命名" aria-hidden="true">#</a> 5 图像名字后缀重命名</h2><p>对图像的名字以及后缀名重新命名，代码如下：</p><pre><code>&quot;&quot;&quot;
图像名称后缀重命名
&quot;&quot;&quot;
...
for i in f:
    ...
    count += 1
</code></pre><h2 id="_6-两文件夹文件比对" tabindex="-1"><a class="header-anchor" href="#_6-两文件夹文件比对" aria-hidden="true">#</a> 6 两文件夹文件比对</h2><p>判断两个文件夹里面文件的文件名是不是相互对应，并移动文件名不对应的文件</p><pre><code># -*- coding: utf-8 -*-
&quot;&quot;&quot;
...
listdir(&#39;./2&#39;,name)
del_dir(&#39;./1&#39;,name,&#39;./3&#39;)
</code></pre><h2 id="_7-绘制caffe模型的roc曲线-二分类" tabindex="-1"><a class="header-anchor" href="#_7-绘制caffe模型的roc曲线-二分类" aria-hidden="true">#</a> 7 绘制caffe模型的ROC曲线(二分类)</h2><p>主要原理为通过OpenCV DNN 调用caffe模型，其他模型一样套路。然后对每张图像进行检测，保存该图像真实标签，以及该标签分类的模型预测概率。调用sklearn绘制ROC，并计算AUC值。通过约登指数获得ROC曲线中最佳阈值。最后通过matplotlib绘图。约登指数为TPR- FPR或者TPR+TNR-1。具体ROC原理可参考：</p>`,24),d={href:"https://www.jianshu.com/p/c61ae11cc5f6",target:"_blank",rel:"noopener noreferrer"},f={href:"https://www.jianshu.com/p/82903edb58dc",target:"_blank",rel:"noopener noreferrer"},m={href:"https://blog.csdn.net/u014264373/article/details/80487766",target:"_blank",rel:"noopener noreferrer"},u=n("pre",null,[n("code",null,`'''
opencv调用caffe并计算roc
'''
import numpy as np
...
`)],-1),h=n("p",null,"结果如图所示：",-1),_=n("figure",null,[n("img",{src:"https://img-blog.csdnimg.cn/20190806135744661.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0x1b2hlbllK,size_16,color_FFFFFF,t_70",alt:"",tabindex:"0",loading:"lazy"}),n("figcaption")],-1);function g(b,q){const e=i("ExternalLinkIcon");return o(),p("div",null,[c,n("p",null,[n("a",d,[t(" https://www.jianshu.com/p/c61ae11cc5f6 "),a(e)])]),n("p",null,[n("a",f,[t(" https://www.jianshu.com/p/82903edb58dc "),a(e)])]),n("p",null,[n("a",m,[t(" https://blog.csdn.net/u014264373/article/details/80487766 "),a(e)])]),u,h,_])}const k=r(l,[["render",g],["__file","2019-01-21-_常用工具_ 深度学习Caffe处理工具.html.vue"]]);export{k as default};
