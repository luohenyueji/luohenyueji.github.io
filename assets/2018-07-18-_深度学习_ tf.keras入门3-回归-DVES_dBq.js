...
print(test_predictions)
</code></pre><p>对于回归问题的官方总结：</p><ul><li>均方误差(MSE)是一种常见的用于回归问题损失函数。</li><li>平均绝对误差(MAE)也是一种常用评价指标而不是精度。</li><li>对于输入数据，归一化是十分必要的。</li><li>训练数据较少，则模型结构较小更合适，防止过拟合。</li><li>提前停止是防止过拟合的好办法。</li></ul>`,32)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};