import{_ as r,r as l,o,c as i,a as e,b as t,d as n,e as s}from"./app-DrqaGevo.js";const c={},d=e("h1",{id:"深度学习-tf-keras入门1-基本函数介绍",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#深度学习-tf-keras入门1-基本函数介绍"},[e("span",null,"[深度学习] tf.keras入门1-基本函数介绍")])],-1),p=e("p",null,"目前keras API 已经整合到 tensorflow最新版本1.9.0 中，在tensorflow中通过tf.keras就可以调用keras。",-1),h=e("pre",null,[e("code",null,`import tensorflow as tf
...
</code></pre>`,7),m={href:"http://keras-cn.readthedocs.io/en/latest/other/activations/",target:"_blank",rel:"noopener noreferrer"},k=s(`<h3 id="网络层的构造" tabindex="-1"><a class="header-anchor" href="#网络层的构造"><span>网络层的构造</span></a></h3><p>通常在tf.keras中，网络层的构造参数主要有以下几个：</p><ol><li>激活函数activation function，默认是没有激活函数的。</li><li>参数初始化，默认通过正态分布初始化（Glorot uniform）</li><li>参数正则化，包括权值初始化和偏置的初始化。</li></ol><pre><code>#参数调整
#建立一个sigmoid层
...
</code></pre><h2 id="模型训练和参数评价" tabindex="-1"><a class="header-anchor" href="#模型训练和参数评价"><span>模型训练和参数评价</span></a></h2><h3 id="模型训练" tabindex="-1"><a class="header-anchor" href="#模型训练"><span>模型训练</span></a></h3><p>模型建立后，通过compile模块确定模型的训练参数（tf.keras.Model.compile）</p><p>tf.keras.Model.compile有三个主要参数：</p>`,8),u={href:"http://keras-cn.readthedocs.io/en/latest/other/optimizers/",target:"_blank",rel:"noopener noreferrer"},g={href:"http://keras-cn.readthedocs.io/en/latest/other/objectives/",target:"_blank",rel:"noopener noreferrer"},y={href:"http://keras-cn.readthedocs.io/en/latest/other/metrics/",target:"_blank",rel:"noopener noreferrer"},b=e("p",null,"具体例子如下：",-1),v=e("pre",null,[e("code",null,`## 配置均方误差回归模型
...
`)],-1),x=e("h3",{id:"模型的训练",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#模型的训练"},[e("span",null,"模型的训练")])],-1),B=e("p",null,"对于小数据集,使用numpy数组，通过tf.keras.Model.fit模块来训练和评估模型。",-1),E=e("pre",null,[e("code",null,`import numpy as np
#输入数据（1000，32）
...
`)],-1),A=e("p",null,"tf.keras.Model.fit模块有三个重要的参数：",-1),z=e("li",null,"训练轮数epochs：epochs指的就是训练过程中数据将被训练多少轮，一个epoch指的是当一个完整的数据集通过了神经网络一次并且返回了一次。",-1),w={href:"http://keras-cn.readthedocs.io/en/latest/for_beginners/concepts/#epochs",target:"_blank",rel:"noopener noreferrer"},D=e("li",null,"验证集validation_data：通常一个模型训练，评估要有训练集，验证集和测试集。验证集就是模型调参时用来评估模型的数据集。",-1),M=e("h3",{id:"tf-data的数据集",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#tf-data的数据集"},[e("span",null,"tf.data的数据集")])],-1),S={href:"https://tensorflow.google.cn/guide/datasets",target:"_blank",rel:"noopener noreferrer"},C=s(`<pre><code>## 数据实例化
