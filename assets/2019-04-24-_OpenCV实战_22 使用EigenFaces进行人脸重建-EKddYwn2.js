...
</code></pre><p><a href="http://xn--pcaParams-927ns6zoufj5ngh0agyfy77b.xn--ymlcreatePCAModel-rf11ay743c.xn--cppcreatePCAModel-qf03a.py" target="_blank" rel="noopener noreferrer">您可以创建模型pcaParams.yml使用createPCAModel.cpp和createPCAModel.py</a>。该代码使用CelebA数据集的前1000个图像，并将它们首先缩放到一半大小。所以这个PCA模型是在大小（89x109）的图像上训练的。除了1000张图像之外，代码还使用了原始图像的垂直翻转版本，因此我们使用2000张图像进行训练。。但是createPCAModel文件里面没有reisze函数，要自己缩放为89X109分辨率。生成了pcaParams.yml文件，再通过reconstructFace获取人脸。</p><p>本文所有代码包括createPCAModel文件见：</p><p><a href="https://github.com/luohenyueji/OpenCV-Practical-Exercise" target="_blank" rel="noopener noreferrer"> https://github.com/luohenyueji/OpenCV-Practical-Exercise</a></p><p>但是图像没有列出，从CelebA数据集下载</p><p><a href="http://mmlab.ie.cuhk.edu.hk/projects/CelebA.html" target="_blank" rel="noopener noreferrer"> http://mmlab.ie.cuhk.edu.hk/projects/CelebA.html<br></a></p><h2 id="_3-参考" tabindex="-1"><a class="header-anchor" href="#_3-参考"><span>3 参考</span></a></h2><ul><li><a href="https://www.learnopencv.com/face-reconstruction-using-eigenfaces-cpp-python/" target="_blank" rel="noopener noreferrer"> https://www.learnopencv.com/face-reconstruction-using-eigenfaces-cpp-python/</a></li></ul>`,43)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};