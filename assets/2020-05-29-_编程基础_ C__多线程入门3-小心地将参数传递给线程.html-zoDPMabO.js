import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as d,o as t,c as l,a as e,b as s,d as a,e as r}from"./app-kCY7hV_E.js";const v={},c=r(`<h1 id="编程基础-c-多线程入门3-小心地将参数传递给线程" tabindex="-1"><a class="header-anchor" href="#编程基础-c-多线程入门3-小心地将参数传递给线程" aria-hidden="true">#</a> [编程基础] C++多线程入门3-小心地将参数传递给线程</h1><p>原始C++标准仅支持单线程编程。新的C++标准(称为c++11或c++0x)于2011年发布。在c++11中，引入了新的线程库。因此运行本文程序需要C++至少符合c++11标准。</p><h2 id="_3-小心地将参数传递给线程" tabindex="-1"><a class="header-anchor" href="#_3-小心地将参数传递给线程" aria-hidden="true">#</a> 3 小心地将参数传递给线程</h2><p>要将参数传递给线程的关联可调用对象或函数，只需将其他参数传递给std::thread构造函数。默认情况下，所有参数都复制到新线程的内部存储中。让我们看一个例子：</p><h3 id="_3-1-在c-11中将简单参数传递给std-thread" tabindex="-1"><a class="header-anchor" href="#_3-1-在c-11中将简单参数传递给std-thread" aria-hidden="true">#</a> 3.1 在c++11中将简单参数传递给std::thread</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#include &lt;iostream&gt;
#include &lt;string&gt;
#include &lt;thread&gt;
