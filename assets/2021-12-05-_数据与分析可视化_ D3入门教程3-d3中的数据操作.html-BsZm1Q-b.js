import{_ as n,c as a,a as i,o as e}from"./app-DmOfh4oW.js";const l={};function p(t,s){return e(),a("div",null,s[0]||(s[0]=[i(`<h1 id="数据与分析可视化-d3入门教程3-d3中的数据操作" tabindex="-1"><a class="header-anchor" href="#数据与分析可视化-d3入门教程3-d3中的数据操作"><span>[数据与分析可视化] D3入门教程3-d3中的数据操作</span></a></h1><p>d3.js是一个用于绘图的JavaScript库。 它可以可视化展示任何类型的数据。 这篇文章介绍d3.js最常见的数据操作任务，包括排序、过滤、分组、嵌套等。</p><h3 id="数学操作" tabindex="-1"><a class="header-anchor" href="#数学操作"><span>数学操作</span></a></h3><p>d3.max和d3.min就是获取数据每一列的最大值和最小值的函数，示例代码如下</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>    &lt;!-- 加载d3 --&gt;</span></span>
