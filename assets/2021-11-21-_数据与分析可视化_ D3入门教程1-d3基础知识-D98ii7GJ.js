...
<span class="line"><span>    &lt;/script&gt;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/web-Study-Notes/[数据分析与可视化] D3入门教程/[数据与分析可视化] D3入门教程1/image/img2.svg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="_2-4-比例尺" tabindex="-1"><a class="header-anchor" href="#_2-4-比例尺"><span>2.4 比例尺</span></a></h3><p>如果想用百分比来表示svg中元素的位置，那么就需要用到比例尺，比例尺就是一个将像素值范围转换为位置百分比的函数。它被称为scale。如果我的数据是百分比并且我的svg区域是400px宽度。那么0%代表0px，100%代表400像素。50%代表200像素。比例尺有domain和range两个属性，range设置像素值范围，domain设置位置百分比。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>    &lt;!-- 添加一个空的svg图片 --&gt;</span></span>
...
<span class="line"><span>    &lt;/script&gt;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/web-Study-Notes/[数据分析与可视化] D3入门教程/[数据与分析可视化] D3入门教程1/image/img3.svg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="_2-5-添加轴" tabindex="-1"><a class="header-anchor" href="#_2-5-添加轴"><span>2.5 添加轴</span></a></h3><p>d3提供了一些自动绘制轴的功能。这些轴始终与比例尺scale对应。axisBottom()创建一个水平轴，底部带有刻度和标签。axisLeft()将用于Y 轴。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>    &lt;!-- 添加一个空的svg图片 --&gt;</span></span>
<span class="line"><span>    &lt;svg id=&quot;viz_area&quot; height=200 width=450&gt;&lt;/svg&gt;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    &lt;!-- 加载d3.js --&gt;</span></span>
<span class="line"><span>    &lt;script src=&quot;https://d3js.org/d3.v4.js&quot;&gt;&lt;/script&gt;</span></span>
...
<span class="line"><span>        svg.append(&quot;circle&quot;)</span></span>
<span class="line"><span>            .attr(&quot;cx&quot;, x(100)).attr(&quot;cy&quot;, 100).attr(&quot;r&quot;, 40).style(&quot;fill&quot;, &quot;green&quot;);</span></span>
<span class="line"><span>    &lt;/script&gt;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/web-Study-Notes/[数据分析与可视化] D3入门教程/[数据与分析可视化] D3入门教程1/image/img4.svg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="_2-6-边距和偏移" tabindex="-1"><a class="header-anchor" href="#_2-6-边距和偏移"><span>2.6 边距和偏移</span></a></h3><p>轴位置经常需要调整，例如，X轴通常位于图表的底部。这归功于translation函数，应用.attr(&quot;transform&quot;, &quot;translate(20,50)&quot;)到一个元素，将其向右平移 20 像素，向底部平移 50 像素。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span></span></span>
<span class="line"><span>    &lt;!-- 添加一个空的svg图片 --&gt;</span></span>
