import{_ as e,o as t,c as n,e as i}from"./app-q9tmr8t5.js";const s={},a=i(`<h1 id="编程基础-c-多线程入门9-async教程和示例" tabindex="-1"><a class="header-anchor" href="#编程基础-c-多线程入门9-async教程和示例" aria-hidden="true">#</a> [编程基础] C++多线程入门9-async教程和示例</h1><p>原始C++标准仅支持单线程编程。新的C++标准(称为C++11或C++0x)于2011年发布。在C++11中，引入了新的线程库。因此运行本文程序需要C++至少符合C++11标准。</p><h2 id="_9-async教程和示例" tabindex="-1"><a class="header-anchor" href="#_9-async教程和示例" aria-hidden="true">#</a> 9 async教程和示例</h2><p>在本文中，我们将讨论如何在C++11中使用std::async异步执行任务。std::async在c++11中引入。</p><h3 id="_9-1-什么是std-async" tabindex="-1"><a class="header-anchor" href="#_9-1-什么是std-async" aria-hidden="true">#</a> 9.1 什么是std::async()</h3><p>std::async()是一个函数模板，它接受回调(即函数或函数对象)作为参数，并有可能异步执行它们。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>template &lt;class Fn, class... Args&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,30),d=[a];function l(c,r){return t(),n("div",null,d)}const v=e(s,[["render",l],["__file","2020-05-29-_编程基础_ C__多线程入门9-async教程和示例.html.vue"]]);export{v as default};
