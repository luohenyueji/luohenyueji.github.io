...
make
</code></pre><h3 id="_2-2-修改代码以定期保存模型文件" tabindex="-1"><a class="header-anchor" href="#_2-2-修改代码以定期保存模型文件"><span><strong>2.2</strong> <strong>修改代码以定期保存模型文件</strong></span></a></h3><p>在我们确保原始仓库在您的系统中编译之后，让我们进行一些小修改以存储中间权重。在文件examples /<br> detector.c中，更改train_detector函数，大概在130行到140行之间。</p><p>将</p><pre><code>if(i%10000==0 || (i &lt; 1000 &amp;&amp; i%100 == 0))
</code></pre><p>改为</p><pre><code>if(i%1000==0 || (i &lt; 2000 &amp;&amp; i%200 == 0))
</code></pre><p>改动的意思是，原始训练过程在每100次训练后保存网络权重，直到前1000次。然后接下来仅在每10000次训练后才保存。在我们的例子中，由于我们只训练一个类，我们希望我们的训练收敛得更快。因此，为了密切监视进度，我们在每200次迭代后保存，直到达到2000，然后接下来在每1000次迭代后保存。完成上述更改后，再次使用make命令重新编译darknet。</p><h3 id="_2-3-数据注释" tabindex="-1"><a class="header-anchor" href="#_2-3-数据注释"><span><strong>2.3 数据注释</strong></span></a></h3><p>我们在labels文件夹中共享带有注释的标签文件。标签文件中的每个行条目表示图像中的单个边界框，并包含有关该框的以下信息：</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>&lt;object-class-id&gt; &lt;center-x&gt; &lt;center-y&gt; &lt;width&gt; &lt;height&gt;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>第一个字段object-class-id是表示类别的整数。范围从0到（类别总数-1）。在我们目前的情况下，由于我们只有一类雪人，因此总是设置object-class-id为0。</p><p>center-x和center-y分别是边界框中心的x和y坐标，除以图像宽度和高度后的结果。</p><p>width和height分别是边界框的宽度和高度，除以图像宽度和高度后的结果。</p><p>让我们考虑一个带有以下符号的示例：</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>x-边界框中心的x坐标（以像素为单位）</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>H-整个图像的高度（以像素为单位）</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后我们计算标签文件中的注释值，如下所示：</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>center-x= x /W.</span></span>
<span class="line"><span></span></span>
...
</code></pre><h2 id="_5-参考" tabindex="-1"><a class="header-anchor" href="#_5-参考"><span><strong>5 参考</strong></span></a></h2><ul><li><a href="https://www.learnopencv.com/training-yolov3-deep-learning-based-custom-object-detector/" target="_blank" rel="noopener noreferrer"> https://www.learnopencv.com/training-yolov3-deep-learning-based-custom-object-detector/ </a></li></ul>`,139)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};