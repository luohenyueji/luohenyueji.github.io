import{_ as p}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as o,o as i,c as l,a as n,b as s,d as e,e as t}from"./app-MsA2k2kn.js";const c={},u=n("h1",{id:"python-《python编程快速上手让繁琐工作自动化》学习笔记3",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#python-《python编程快速上手让繁琐工作自动化》学习笔记3","aria-hidden":"true"},"#"),s(" [python]《Python编程快速上手让繁琐工作自动化》学习笔记3")],-1),r={id:"_1-组织文件笔记-第9章-代码下载",tabindex:"-1"},d=n("a",{class:"header-anchor",href:"#_1-组织文件笔记-第9章-代码下载","aria-hidden":"true"},"#",-1),k={href:"https://github.com/luohenyueji/Python-Study-Notes/tree/master/Automate%20the%20Boring%20Stuff%20with%20Python",target:"_blank",rel:"noopener noreferrer"},m=t(`<h3 id="_1-1-文件与文件路径" tabindex="-1"><a class="header-anchor" href="#_1-1-文件与文件路径" aria-hidden="true">#</a> <strong>1.1 文件与文件路径</strong></h3><p>通过import shutil调用shutil模块操作目录，shutil模块能够在Python 程序中实现文件复制、移动、改名和删除；同时也介绍部分os操作文件的函数。常用函数如下：</p><table><thead><tr><th>函数</th><th>用途</th><th>备注</th></tr></thead><tbody><tr><td>shutil.copy(source, destination)</td><td>复制文件</td><td></td></tr><tr><td>shutil.copytree(source, destination)</td><td>复制文件夹</td><td>如果文件夹不存在，则创建文件夹</td></tr><tr><td>shutil.move(source, destination)</td><td>移动文件</td><td>返回新位置的绝对路径的字符串，且会覆写文件</td></tr><tr><td>os.unlink(path)</td><td>删除path处的文件</td><td></td></tr><tr><td>os.rmdir(path)</td><td>删除path处的文件夹</td><td>该文件夹必须为空，其中没有任何文件和文件</td></tr><tr><td>shutil.rmtree(path)</td><td>删除path处的文件夹</td><td>包含的所有文件和文件夹都会被删除</td></tr><tr><td>os.walk(path)</td><td>遍历path下所有文件夹和文件</td><td>返回3个值：当前文件夹名称，当前文件夹子文件夹的字符串列表，当前文件夹文件的字符串列表</td></tr><tr><td>os.rename(path)</td><td>path处文件重命名</td><td></td></tr></tbody></table><h3 id="_1-2-用zipfile-模块压缩文件" tabindex="-1"><a class="header-anchor" href="#_1-2-用zipfile-模块压缩文件" aria-hidden="true">#</a> <strong>1.2 用zipfile 模块压缩文件</strong></h3><p>通过import zipfile，利用zipfile模块中的函数，Python 程序可以创建和打开（或解压）ZIP 文件。常用函数如下：</p><table><thead><tr><th>函数</th><th>用途</th><th>备注</th></tr></thead><tbody><tr><td>exampleZip=zipfile.ZipFile(&#39;example.zip&#39;)</td><td>创建一个ZipFile对象</td><td>example.zip表示.zip 文件的文件名</td></tr><tr><td>exampleZip.namelist()</td><td>返回ZIP 文件中包含的所有文件和文件夹的字符串的列表</td><td></td></tr><tr><td>spamInfo = exampleZip.getinfo(&#39;example.txt&#39;)</td><td>返回一个关于特定文件的ZipInfo 对象</td><td>example.txt为压缩文件中的某一文件</td></tr><tr><td>spamInfo.file_size</td><td>返回源文件大小</td><td>单位字节</td></tr><tr><td>spamInfo.compress_size</td><td>返回压缩后文件大小</td><td>单位字节</td></tr><tr><td>exampleZip.extractall(path))</td><td>解压压缩文件到path目录</td><td>path不写，默认为当前目录</td></tr><tr><td>exampleZip.extract(&#39;spam.txt&#39;, path)</td><td>提取某一压缩文件当path目录</td><td>path不写，默认为当前目录</td></tr><tr><td>newZip = zipfile.ZipFile(&#39;new.zip&#39;, &#39;w&#39;)</td><td>以“写模式”打开ZipFile 对象</td><td></td></tr><tr><td>newZip.write(&#39;spam.txt&#39;, compress_type=zipfile.ZIP_DEFLATED)</td><td>压缩文件</td><td>第一个参数是要添加的文件。第二个参数是“压缩类型”参数</td></tr><tr><td>newZip.close()</td><td>关闭ZipFile对象</td><td></td></tr></tbody></table><h2 id="_2-项目练习" tabindex="-1"><a class="header-anchor" href="#_2-项目练习" aria-hidden="true">#</a> 2. 项目练习</h2><h3 id="_2-1-将带有美国风格日期的文件改名为欧洲风格日期" tabindex="-1"><a class="header-anchor" href="#_2-1-将带有美国风格日期的文件改名为欧洲风格日期" aria-hidden="true">#</a> 2.1 将带有美国风格日期的文件改名为欧洲风格日期</h3><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment"># 导入模块</span>
...
</code></pre><h3 id="_2-2-将一个文件夹备份到一个zip-文件" tabindex="-1"><a class="header-anchor" href="#_2-2-将一个文件夹备份到一个zip-文件" aria-hidden="true">#</a> 2.2 将一个文件夹备份到一个ZIP 文件</h3><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code>
...
Done.
Done.
</code></pre><h3 id="_2-3-选择性拷贝" tabindex="-1"><a class="header-anchor" href="#_2-3-选择性拷贝" aria-hidden="true">#</a> 2.3 选择性拷贝</h3><p>编写一个程序，遍历一个目录树，查找特定扩展名的文件（诸如.pdf 或.jpg）。不论这些文件的位置在哪里，将它们拷贝到一个新的文件夹中。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> shutil
<span class="token keyword">import</span> os
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-4-删除不需要的文件" tabindex="-1"><a class="header-anchor" href="#_2-4-删除不需要的文件" aria-hidden="true">#</a> 2.4 删除不需要的文件</h3><p>编写一个程序，遍历一个目录树，查找特别大的文件或文件夹。将这些文件的绝对路径打印到屏幕上。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code>
<span class="token keyword">import</span> os
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,19),v={id:"_1-模式匹配与正则表达式笔记-第7章-代码下载",tabindex:"-1"},b=n("a",{class:"header-anchor",href:"#_1-模式匹配与正则表达式笔记-第7章-代码下载","aria-hidden":"true"},"#",-1),h={href:"https://github.com/luohenyueji/Python-Study-Notes/tree/master/Automate%20the%20Boring%20Stuff%20with%20Python",target:"_blank",rel:"noopener noreferrer"},g=t(`<p>正则表达式，又称规则表达式。（英语：Regular Expression，在代码中常简写为regex、regexp或RE），计算机科学的一个概念。正则表达式通常被用来检索、替换那些符合某个模式(规则)的文本。</p><p><strong>1.1 正则表达式匹配步骤</strong><br> 虽然在Python 中使用正则表达式有几个步骤，但每一步都相当简单。</p><ol><li>用import re 导入正则表达式模块。</li><li>用re.compile()函数创建一个Regex 对象（记得使用原始字符串）。</li><li>向Regex 对象的search()方法传入想查找的字符串。它返回一个Match 对象。</li><li>调用Match 对象的group()方法，返回实际匹配文本的字符。</li></ol><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment"># 用import re 导入正则表达式模块</span>
<span class="token keyword">import</span> re
...
</code></pre><p>fileList = [] numList = []</p><h1 id="寻找文件" tabindex="-1"><a class="header-anchor" href="#寻找文件" aria-hidden="true">#</a> 寻找文件</h1><p>pattern = re.compile(&#39;spam(\\d{3}).txt&#39;) for file in os.listdir(path): mo = pattern.search(file) if mo != None: fileList.append(file) numList.append(mo.group(1))</p><h1 id="对存储的文件排序" tabindex="-1"><a class="header-anchor" href="#对存储的文件排序" aria-hidden="true">#</a> 对存储的文件排序</h1><p>fileList.sort() numList.sort()</p><h1 id="开始缺失的文件编号" tabindex="-1"><a class="header-anchor" href="#开始缺失的文件编号" aria-hidden="true">#</a> 开始缺失的文件编号</h1><h1 id="编号从1开始" tabindex="-1"><a class="header-anchor" href="#编号从1开始" aria-hidden="true">#</a> 编号从1开始</h1><p>index = 1</p><h1 id="打印不连续的文件" tabindex="-1"><a class="header-anchor" href="#打印不连续的文件" aria-hidden="true">#</a> 打印不连续的文件</h1><p>for i in range(len(numList)): # 如果文件编号不连续 if int(numList[i]) != i+index: inputFile = os.path.join(path, fileList[i]) print(&quot;the missing number file is {}:&quot;.format(inputFile)) outputFile = os.path.join(path, &#39;spam&#39;+&#39;%03d&#39; % (i+1)+&#39;.txt&#39;) os.rename(inputFile, outputFile)</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>
    the missing number file is .\\spam005.txt:
    
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,59);function f(y,x){const a=o("ExternalLinkIcon");return i(),l("div",null,[u,n("h2",r,[d,s(" 1. 组织文件笔记（第9章）"),n("a",k,[s("(代码下载)"),e(a)])]),m,n("h2",v,[b,s(" 1. 模式匹配与正则表达式笔记（第7章）"),n("a",h,[s("(代码下载)"),e(a)])]),g])}const F=p(c,[["render",f],["__file","2019-06-28-_python_《Python编程快速上手让繁琐工作自动化》学习笔记3.html.vue"]]);export{F as default};
