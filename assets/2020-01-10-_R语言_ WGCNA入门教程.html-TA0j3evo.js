...
The following object is masked from &#39;package:stats&#39;:
    ...
    cor
</code></pre><h2 id="_1-数据输入和清洗" tabindex="-1"><a class="header-anchor" href="#_1-数据输入和清洗" aria-hidden="true">#</a> 1 数据输入和清洗</h2><p>主要步骤如下：</p><ol><li>加载基因表达数据</li><li>数据清洗</li><li>加载临床特征数据</li></ol>`,12),h={href:"https://github.com/xndless/helixlife-WGCNA-2018/blob/master/FemaleLiver-Data.zip",target:"_blank",rel:"noopener noreferrer"},p=n(`<h3 id="_1-1-加载基因表达数据" tabindex="-1"><a class="header-anchor" href="#_1-1-加载基因表达数据" aria-hidden="true">#</a> 1.1 加载基因表达数据</h3><div class="language-R line-numbers-mode" data-ext="R"><pre class="language-R"><code># 读取文件
