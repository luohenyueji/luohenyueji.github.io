import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as d,o as t,c as l,a as e,b as a,d as s,e as r}from"./app-kCY7hV_E.js";const v={},c=r(`<p>原始C++标准仅支持单线程编程。新的C++标准(称为C++11或C++0x)于2011年发布。在C++11中，引入了新的线程库。因此运行本文程序需要C++至少符合C++11标准。</p><h1 id="编程基础-c-多线程入门1-创建线程的三种不同方式" tabindex="-1"><a class="header-anchor" href="#编程基础-c-多线程入门1-创建线程的三种不同方式" aria-hidden="true">#</a> [编程基础] C++多线程入门1-创建线程的三种不同方式</h1><h2 id="_1-创建线程的三种不同方式" tabindex="-1"><a class="header-anchor" href="#_1-创建线程的三种不同方式" aria-hidden="true">#</a> 1 创建线程的三种不同方式</h2><p>在本章中，我们将讨论如何使用std::thread在C++11中创建线程。<br> 在每个C++应用程序中，都有一个默认的主线程，即main()函数。在C++11中，我们可以通过创建std::thread类的对象来创建其他线程。每个std::thread对象都可以与一个线程关联。因此我们需要引入头文件为：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#include &lt;thread&gt;
