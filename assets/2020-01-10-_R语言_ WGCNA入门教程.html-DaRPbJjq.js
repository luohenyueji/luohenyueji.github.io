import{_ as l,r as s,o as a,c as o,a as t,d as i,b as e,e as n}from"./app-CD_-ggd_.js";const c={},r=t("h1",{id:"r语言-wgcna入门教程",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#r语言-wgcna入门教程"},[t("span",null,"[R语言] WGCNA入门教程")])],-1),u={href:"https://github.com/luohenyueji/R-Study-Notes/blob/master/WGCNA/wgcna_tutorial.ipynb",target:"_blank",rel:"noopener noreferrer"},m=t("strong",null,"代码下载地址",-1),v=n(`<ol><li>数据输入和清理</li><li>建设表达网络与模块检测</li><li>筛选与表型相关的模块</li><li>使用WGCNA进行网络可视化</li><li>参考</li></ol><p><strong>WGCNA的安装</strong> 前置软件包安装如果是R语言3.5及以上版本，安装命令如下：</p><blockquote><p>install.packages(&quot;BiocManager&quot;)<br> BiocManager::install(c(&quot;AnnotationDbi&quot;, &quot;impute&quot;,&quot;GO.db&quot;, &quot;preprocessCore&quot;)) install.packages(c(&quot;matrixStats&quot;, &quot;Hmisc&quot;,&quot;foreach&quot;, &quot;doParallel&quot;, &quot;fastcluster&quot;, &quot;dynamicTreeCut&quot;, &quot;survival&quot;)) install.packages(c(&quot;WGCNA&quot;, &quot;stringr&quot;, &quot;reshape2&quot;))</p></blockquote><p>如果R语言3.5以下版本，安装命令如下：</p><blockquote><p>source(&quot;https://bioconductor.org/biocLite.R&quot;) biocLite(c(&quot;AnnotationDbi&quot;, &quot;impute&quot;,&quot;GO.db&quot;, &quot;preprocessCore&quot;)) install.packages(c(&quot;matrixStats&quot;, &quot;Hmisc&quot;,&quot;foreach&quot;, &quot;doParallel&quot;, &quot;fastcluster&quot;, &quot;dynamicTreeCut&quot;, &quot;survival&quot;)) install.packages(c(&quot;WGCNA&quot;, &quot;stringr&quot;, &quot;reshape2&quot;))</p></blockquote><p><strong>专有名词</strong></p><ul><li>共表达网络：定义为加权基因网络。点代表基因，边代表基因表达相关性；</li><li>Module(模块)：高度內连的基因集。在无向网络中，模块内是高度相关的基因。在有向网络中，模块内是高度正相关的基因；</li><li>邻接矩阵(Adjacency matrix)：基因和基因之间的加权相关性值构成的矩阵;</li><li>软阈值：相关性值进行幂次运算幂次的值也就是软阈值;</li><li>连接度(Connectivity)：类似于网络中 &quot;度&quot;degree)的概念。每个基因的连接度是与其相连的基因的边属性之和;</li></ul><div class="language-R line-numbers-mode" data-ext="R" data-title="R"><pre class="language-R"><code># 加载库
library(WGCNA);
...
The following object is masked from &#39;package:stats&#39;:
    ...
    cor
</code></pre><h2 id="_1-数据输入和清洗" tabindex="-1"><a class="header-anchor" href="#_1-数据输入和清洗"><span>1 数据输入和清洗</span></a></h2><p>主要步骤如下：</p><ol><li>加载基因表达数据</li><li>数据清洗</li><li>加载临床特征数据</li></ol>`,12),p={href:"https://github.com/xndless/helixlife-WGCNA-2018/blob/master/FemaleLiver-Data.zip",target:"_blank",rel:"noopener noreferrer"},h=n(`<h3 id="_1-1-加载基因表达数据" tabindex="-1"><a class="header-anchor" href="#_1-1-加载基因表达数据"><span>1.1 加载基因表达数据</span></a></h3><div class="language-R line-numbers-mode" data-ext="R" data-title="R"><pre class="language-R"><code># 读取文件
...
gsg$allOK;
  ...
  ..step 1
</code></pre><p>TRUE</p><p>如果样本检查语句返回TRUE，那么没有缺失值。如果不是的话，我们会移除那些有问题的基因和样本。通过以下代码来移除缺失值</p><div class="language-R line-numbers-mode" data-ext="R" data-title="R"><pre class="language-R"><code>if (!gsg$allOK)
{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>接下来我们对样本进行聚类（与随后的基因聚类相比），看看是否有明显的异常值。</p><div class="language-R line-numbers-mode" data-ext="R" data-title="R"><pre class="language-R"><code># hclusts聚类算法, dist计算基因之间的距离
...
dev.off()
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>png:</strong> 2</p><p>由上图图能够看出，F2_221 这个样本和其他样本差距非常大，需要将该样本过滤掉。过滤代码如下</p><div class="language-R line-numbers-mode" data-ext="R" data-title="R"><pre class="language-R"><code># Plot a line to show the cut
# 设置文字大小
par(cex = 0.5);
plot(sampleTree, main = &quot;Sample clustering to detect outliers&quot;, sub=&quot;&quot;, xlab=&quot;&quot;, cex.lab = 1.5, cex.axis = 1.5, cex.main = 2)
# 在上图上画红线
...
# 垃圾回收
collectGarbage();
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>现在我们有了变量datExpr中的表达式数据，以及变量dattitries中相应的临床特征。在我们继续进行网络构建和模块检测之前，我们将可视化临床特征与样本树状图的关系。</p><div class="language-R line-numbers-mode" data-ext="R" data-title="R"><pre class="language-R"><code># Re-cluster samples
# 画聚类图
...
</code></pre><div class="language-R line-numbers-mode" data-ext="R" data-title="R"><pre class="language-R"><code># sft这中保存了每个powers值计算出来的网络特征,其中powerEstimate就是最佳power值，fitIndices保存了每个power对应的网络的特征。
str(sft)
...
</code></pre><div class="language-R line-numbers-mode" data-ext="R" data-title="R"><pre class="language-R"><code># Plot the results 结果绘图
# 设置窗格大小
#sizeGrWindow(9, 5)
# 设置图的显示一行两列
# par(mfrow = c(1,2));
...
Done cluster 1492 
 ...
 ..merging modules that are too close..
     mergeCloseModules: Merging modules whose distance is less than 0.25
       Calculating new MEs...
</code></pre><p>我们现在回到网络分析。要查看标识了多少个模块以及模块大小</p><div class="language-R line-numbers-mode" data-ext="R" data-title="R"><pre class="language-R"><code> table(net$colors)
...
</code></pre><p>指示有18个模块，按大小降序标记为1至18，大小范围为609至34个基因。 标签0保留用于所有模块外部的基因。 用于模块识别的分层聚类树状图（树）以net $ dendrograms [[1]]返回； 可以使用以下代码将树状图与颜色分配一起显示：</p><div class="language-R line-numbers-mode" data-ext="R" data-title="R"><pre class="language-R"><code># open a graphics window
# sizeGrWindow(12, 9)
...
</code></pre><figure><img src="https://imgconvert.csdnimg.cn/aHR0cHM6Ly9naXRlZS5jb20vbHVtaW5pb3VzL2FydGljbGVfcGljdHVyZV93YXJlaG91c2UvcmF3L21hc3Rlci9SLVN0dWR5LU5vdGVzL1dHQ05BJTIwVFVUT1JJQUwvb3V0cHV0XzQ1XzEucG5n?x-oss-process=image/format,png" alt="png" tabindex="0" loading="lazy"><figcaption>png</figcaption></figure><div class="language-R line-numbers-mode" data-ext="R" data-title="R"><pre class="language-R"><code>sizeGrWindow(10,6)
...
with green-red color blindness (the most common kind of color blindness).
Consider using the function blueWhiteRed instead.&quot;
</code></pre><h3 id="_3-2-基因与性状和重要模块的关系-基因重要性和模块成员" tabindex="-1"><a class="header-anchor" href="#_3-2-基因与性状和重要模块的关系-基因重要性和模块成员"><span>3.2 基因与性状和重要模块的关系：基因重要性和模块成员</span></a></h3><p>我们量化阵列上所有基因与每个模块的相似性寻找重要模块</p><div class="language-R line-numbers-mode" data-ext="R" data-title="R"><pre class="language-R"><code># Define variable weight containing the weight column of datTrait
# 定义包含数据特征权重列的变量权重
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-使用wgcna进行网络可视化" tabindex="-1"><a class="header-anchor" href="#_4-使用wgcna进行网络可视化"><span>4 使用WGCNA进行网络可视化</span></a></h2><p>主要步骤如下：</p><ol><li>显示基因网络</li><li>可视化特征基因网络</li></ol><h2 id="_4-1-显示基因网络" tabindex="-1"><a class="header-anchor" href="#_4-1-显示基因网络"><span>4.1 显示基因网络</span></a></h2><p>可视化加权网络的一种方法是绘制其热图，热图的每一行和每一列都对应一个基因。 热图可以描述邻接或拓扑重叠，浅色表示低邻接（重叠），而深色表示更高的邻接（重叠）。 另外，沿着热图的顶部和左侧绘制了基因树状图和模块颜色。</p><div class="language-R line-numbers-mode" data-ext="R" data-title="R"><pre class="language-R"><code># Calculate topological overlap anew: this could be done more efficiently by saving the TOM
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://imgconvert.csdnimg.cn/aHR0cHM6Ly9naXRlZS5jb20vbHVtaW5pb3VzL2FydGljbGVfcGljdHVyZV93YXJlaG91c2UvcmF3L21hc3Rlci9SLVN0dWR5LU5vdGVzL1dHQ05BJTIwVFVUT1JJQUwvb3V0cHV0XzY0XzAucG5n?x-oss-process=image/format,png" alt="png" tabindex="0" loading="lazy"><figcaption>png</figcaption></figure><p>该函数生成特征基因和特征的树状图，以及它们之间关系的热图。 要拆分树状图和热图图，我们可以使用以下代码</p><div class="language-R line-numbers-mode" data-ext="R" data-title="R"><pre class="language-R"><code># Plot the dendrogram
# sizeGrWindow(6,6);
par(cex = 1.0)
