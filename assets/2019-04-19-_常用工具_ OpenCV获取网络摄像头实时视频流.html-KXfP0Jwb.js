import{_ as a,r as p,o,c as i,a as n,b as t,d as r,e as c}from"./app-q9tmr8t5.js";const d={},s=c(`<h1 id="常用工具-opencv获取网络摄像头实时视频流" tabindex="-1"><a class="header-anchor" href="#常用工具-opencv获取网络摄像头实时视频流" aria-hidden="true">#</a> [常用工具] OpenCV获取网络摄像头实时视频流</h1><h1 id="所需要硬件及软件环境" tabindex="-1"><a class="header-anchor" href="#所需要硬件及软件环境" aria-hidden="true">#</a> 所需要硬件及软件环境：</h1><p>python 3/OpenCV3.4 or C++11/OpenCV3.4</p><h2 id="_1-rtsp协议" tabindex="-1"><a class="header-anchor" href="#_1-rtsp协议" aria-hidden="true">#</a> <strong>1 RTSP协议</strong></h2><p>RTSP (Real Time Streaming Protocol)，是一种语法和操作类似 HTTP 协议，专门用于音频和视频的应用层协议。 和 HTTP类似，RTSP 也使用 URL地址。同时我们也要了解到摄像机传输数据用的是码流，高清网络摄像机产品编码器都会产生两个编码格式，称为主码流和子码流。这就叫双码流技术。目的是用于解决监控录像的本地存储和网络传输的图像的质量问题。双码流能实现本地和远程传输的两种不同的带宽码流需求，本地传输可以用主码流，能获得更清晰的存储录像，远程传输就因为带宽限制的原因，而使用子码流来获得流畅的图像和录像。通过RTSP协议传输不同的码流，但是各大摄像头厂家的RTSP协议地址不大一样。通常你只要知道摄像头IP地址，用户名密码就行了。</p><p>海康的RTSP协议地址如下：</p><pre><code>rtsp://[username]:[password]@[ip]:[port]/[codec]/[channel]/[subtype]/av_stream
