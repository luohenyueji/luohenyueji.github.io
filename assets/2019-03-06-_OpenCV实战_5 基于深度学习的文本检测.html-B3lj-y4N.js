...
geometry = output[1]
</code></pre><h2 id="_4-处理输出" tabindex="-1"><a class="header-anchor" href="#_4-处理输出"><span><strong>4</strong> <strong>处理输出</strong></span></a></h2><p>如前所述，我们将使用两个层的输出并解码文本框的位置及其方向。我们可能会得到许多文本框。因此，我们需要从该批次中筛选出看起来最好的文本框。这是使用非极大值抑制算法完成的。</p><p>非极大值抑制算法在目标检测中应用很广泛，具体可以参考</p>`,12),y={href:"http://www.it610.com/article/5215825.htm",target:"_blank",rel:"noopener noreferrer"},b={href:"https://blog.csdn.net/qq_14845119/article/details/52064928",target:"_blank",rel:"noopener noreferrer"},x=t("em",null,"https://blog.csdn.net/qq_14845119/article/details/5206492",-1),v=r(`<p>1 解码</p><p>C++:</p><pre><code>std::vector&lt;RotatedRect&gt; boxes;
