import{_ as t,c as n,a,o as r}from"./app-CocSIQlC.js";const o={};function i(p,e){return r(),n("div",null,e[0]||(e[0]=[a(`<h1 id="常用工具-深度学习caffe处理工具" tabindex="-1"><a class="header-anchor" href="#常用工具-深度学习caffe处理工具"><span>[常用工具] 深度学习Caffe处理工具</span></a></h1><p>对于机器学习、图像处理有时要对图像数据进行分割处理。用python写了一些常用小工具代码。</p><h2 id="_1-caffe数据集txt文本制作" tabindex="-1"><a class="header-anchor" href="#_1-caffe数据集txt文本制作"><span>1 Caffe数据集txt文本制作</span></a></h2><p>很多时候要建立如下数据集txt文本，类似图片所示（图片网上找的)</p><figure><img src="https://img-blog.csdnimg.cn/20190121145819354.jpg?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0x1b2hlbllK,size_16,color_FFFFFF,t_70" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>生成代码如下：</p><pre><code>&quot;&quot;&quot;
caffe数据集txt文本制作
&quot;&quot;&quot;
