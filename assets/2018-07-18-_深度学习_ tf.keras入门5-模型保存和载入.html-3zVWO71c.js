...
loss, acc = new_model.evaluate(test_images, test_labels)
print(&quot;Restored model, accuracy: {:5.2f}%&quot;.format(100*acc)) #86.30%
</code></pre>`,17);function p(u,h){const n=t("ExternalLinkIcon");return l(),i("div",null,[d,e("p",null,[a("模型可以在训练中或者训练完成后保存。具体文档参考： "),e("a",m,[a("https://tensorflow.google.cn/tutorials/keras/save_and_restore_models"),o(n)])]),_])}const b=s(c,[["render",p],["__file","2018-07-18-_深度学习_ tf.keras入门5-模型保存和载入.html.vue"]]);export{b as default};
