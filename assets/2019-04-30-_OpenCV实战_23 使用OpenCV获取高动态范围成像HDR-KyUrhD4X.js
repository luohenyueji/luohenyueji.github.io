...
float\xA0\xA0 gamma = 1.0f,

float\xA0\xA0 saturation = 1.0f,

float\xA0\xA0 bias = 0.85f

)
</code></pre><p>这里，bias是[0,1]范围内偏置函数的值。从0.7到0.9的值通常会得到最好的结果。默认值为0.85。有关更多技术细节，请参阅此文章。参数通过反复试验获得。最终输出乘以3只是因为它给出了最令人满意的结果。更多的技术细节见：</p><p><a href="http://resources.mpi-inf.mpg.de/tmo/logmap/logmap.pdf" target="_blank" rel="noopener noreferrer"> http://resources.mpi-inf.mpg.de/tmo/logmap/logmap.pdf<br></a></p><p>结果如下所示：</p><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/[OpenCV实战]23 使用OpenCV获取高动态范围成像HDR/20190430163548711.jpeg?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0x1b2hlbllK,size_16,color_FFFFFF,t_70" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>(2) Durand Tonemap</p><p>Durand Tonemap的参数如下所示：</p><pre><code>createTonemapDurand

(\xA0\xA0

\xA0 float\xA0\xA0\xA0\xA0 gamma = 1.0f,

\xA0 float\xA0\xA0\xA0\xA0 contrast = 4.0f,

\xA0 float\xA0\xA0\xA0\xA0 saturation = 1.0f,

\xA0 float\xA0\xA0\xA0\xA0 sigma_space = 2.0f,

\xA0 float\xA0\xA0\xA0\xA0 sigma_color = 2.0f
...
</code></pre><h3 id="_2-7-工程代码" tabindex="-1"><a class="header-anchor" href="#_2-7-工程代码"><span><strong>2.7</strong> <strong>工程代码</strong></span></a></h3><p>本文所有代码见：</p><p><a href="https://github.com/luohenyueji/OpenCV-Practical-Exercise" target="_blank" rel="noopener noreferrer"> https://github.com/luohenyueji/OpenCV-Practical-Exercise<br></a></p><p>C++:</p><pre><code>#include &quot;pch.h&quot;
