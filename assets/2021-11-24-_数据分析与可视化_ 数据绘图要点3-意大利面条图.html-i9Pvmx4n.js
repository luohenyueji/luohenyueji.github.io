import{_ as e,r as a,o as i,c as n,a as t,b as l,d as r,e as s}from"./app-q9tmr8t5.js";const o={},c=s(`<h1 id="数据分析与可视化-数据绘图要点3-意大利面条图" tabindex="-1"><a class="header-anchor" href="#数据分析与可视化-数据绘图要点3-意大利面条图" aria-hidden="true">#</a> [数据分析与可视化] 数据绘图要点3-意大利面条图</h1><h2 id="数据绘图要点3-意大利面条图" tabindex="-1"><a class="header-anchor" href="#数据绘图要点3-意大利面条图" aria-hidden="true">#</a> 数据绘图要点3-意大利面条图</h2><p>线条太多的折线图通常变的不可读，这种图一般被称为意大利面条图。因此这种图几乎无法提供有关数据的信息。</p><h3 id="绘图实例" tabindex="-1"><a class="header-anchor" href="#绘图实例" aria-hidden="true">#</a> 绘图实例</h3><p>让我们以美国从1880年到2015年女性婴儿名字的演变为例。</p><div class="language-R line-numbers-mode" data-ext="R"><pre class="language-R"><code>## Libraries
library(tidyverse)
library(hrbrthemes)
library(kableExtra)
library(babynames)
