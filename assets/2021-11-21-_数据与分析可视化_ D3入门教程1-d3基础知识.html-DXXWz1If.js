import{_ as l,c as e,a as i,g as n,d as a,o as t}from"./app-BmRggoXf.js";const p={};function d(r,s){return t(),e("div",null,[s[0]||(s[0]=i(`<h1 id="数据与分析可视化-d3入门教程1-d3基础知识" tabindex="-1"><a class="header-anchor" href="#数据与分析可视化-d3入门教程1-d3基础知识"><span>[数据与分析可视化] D3入门教程1-d3基础知识</span></a></h1><p>d3.js是一个用于绘图的JavaScript 库。 它可以可视化展示任何类型的数据。 本文档展示了多个交互式示例，说明了d3.js的关键概念，从而生成了第一个基本散点图。</p><h2 id="_1-html介绍" tabindex="-1"><a class="header-anchor" href="#_1-html介绍"><span>1 HTML介绍</span></a></h2><h3 id="_1-1-什么是html" tabindex="-1"><a class="header-anchor" href="#_1-1-什么是html"><span>1.1 什么是HTML？</span></a></h3><p>HTML介绍：</p><ul><li>HTML代表超文本标记语言。基本上，它是任何网站背后的语言。Mozilla 或 Safari 等 Web 浏览器会读取此类文件并将其翻译到网页中</li><li>在HTML文件中，组成网页的元素被创建，并由标签描述。例如，级别1的标题由h1标签表示，带有标签的段落，由p标签表示图像img</li><li>如果没有 html 的基本知识，就不可能学会d3.js</li></ul><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>&lt;!DOCTYPE html&gt;</span></span>
