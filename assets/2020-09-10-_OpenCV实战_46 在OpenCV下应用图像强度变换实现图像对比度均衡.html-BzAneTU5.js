import{_ as r,r as s,o as l,c,a as e,b as n,d as i,e as a}from"./app-CD_-ggd_.js";const d={},o=e("h1",{id:"opencv实战-46-在opencv下应用图像强度变换实现图像对比度均衡",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#opencv实战-46-在opencv下应用图像强度变换实现图像对比度均衡"},[e("span",null,"[OpenCV实战]46 在OpenCV下应用图像强度变换实现图像对比度均衡")])],-1),m=e("p",null,[n("本文主要介绍基于图像强度变换算法来实现图像对比度均衡。通过图像对比度均衡能够抑制图像中的无效信息，使图像转换为更符合计算机或人处理分析的形式，以提高图像的视觉价值和使用价值。本文主要介绍通过OpenCV contrib中的intensity_transform模块实现图像对比度均衡。如果想了解具体相关方法原理见冈萨雷斯主编的图像处理经典书籍 "),e("strong",null,"数字图像处理Digital Image Processing"),n(" 第四版第三章。")],-1),g=e("p",null,"本文需要OpenCV contrib库，OpenCV contrib库的编译安装见：",-1),u={href:"https://blog.csdn.net/LuohenYJ/article/details/107944236",target:"_blank",rel:"noopener noreferrer"},E=e("p",null,"本文所有代码见：",-1),v={href:"https://github.com/luohenyueji/OpenCV-Practical-Exercise",target:"_blank",rel:"noopener noreferrer"},b=a('<h2 id="_1-相关知识介绍" tabindex="-1"><a class="header-anchor" href="#_1-相关知识介绍"><span>1 相关知识介绍</span></a></h2><h3 id="_1-1-图像强度" tabindex="-1"><a class="header-anchor" href="#_1-1-图像强度"><span>1.1 图像强度</span></a></h3><p>图像强度的英文名称是image intensity，意思是单通道图像像素的值大小。在灰度图像中，图像强度是就是图像的灰度级。在RGB颜色空间中，可以理解为RGB三个通道的像素灰度值，即RGB包含三种图像强度。其他颜色空间也是同样的道理。</p><h3 id="_1-2-图像对比度" tabindex="-1"><a class="header-anchor" href="#_1-2-图像对比度"><span>1.2 图像对比度</span></a></h3><p>对比度是指图像中物体在亮度或颜色上的差异，对比度使图像中一个物体区别于同一视场内的其他物体。对比度越大，图像类各个物体的颜色差别就越大，图像也就越鲜艳。</p><p>如下图所示。显然，左图像的对比度较低，因为与右图像相比，很难识别图像中存在的细节。</p><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/[OpenCV实战]46 在OpenCV下应用图像强度变换实现图像对比度均衡/38df71b0ee517d8ed9529d96d893de6c.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>现实生活中的例子可以是晴天和大雾天。在阳光明媚的日子里，我们觉得一切都很清晰，因此与雾天相比，一切看起来几乎都一样强烈（暗淡、灰暗）。晴天的图像代码对比度高，雾天代表对比度低。</p><p>一种更有效的检查图像对比度是低还是高的方法是绘制图像直方图，让我们为上面的图像绘制直方图。如下图所示： <img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/[OpenCV实战]46 在OpenCV下应用图像强度变换实现图像对比度均衡/9db5568b991afd0a73f65b5b21ad699c.png" alt="" loading="lazy"></p><p>很明显，从左边的图像直方图中，我们可以看到图像强度值位于一个狭窄的范围内。因为很难区分几乎相同的强度值，因此左图像的对比度较低。如果不理解可以看看下面灰度范围图，可以看到灰度变化范围越大，可视化区分度越好。因此，对于高对比度，图像直方图应该跨越整个动态范围。 <img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/[OpenCV实战]46 在OpenCV下应用图像强度变换实现图像对比度均衡/5f67064dc323dc47de603b6861e69873.png" alt="" loading="lazy"></p><p>到目前为止，我们讨论了对比度，但没有讨论低对比度图像的原因。低对比度图像可能是由于照明不足、成像传感器缺乏动态范围，甚至在图像采集过程中镜头光圈设置错误等原因造成的。因此我们需要对低对比度的图像进行图像增强。</p><h3 id="_1-3-opencv中基于图像强度的对比度增强算法" tabindex="-1"><a class="header-anchor" href="#_1-3-opencv中基于图像强度的对比度增强算法"><span>1.3 OpenCV中基于图像强度的对比度增强算法</span></a></h3><p>OpenCV contrib中的intensity_transform模块包含于图像强度的对比度增强算法。主要包括的算法有：</p><ul><li>自适应直方图均衡化 Autoscaling</li><li>对数变换 Log Transformations</li><li>gamma变换 Power-Law (Gamma) Transformations</li><li>对比度拉伸 Contrast Stretching</li><li>BIMEF, A Bio-Inspired Multi-Exposure Fusion Framework for Low-light Image enhancement</li></ul>',14),p={href:"https://github.com/opencv/opencv_contrib/tree/master/modules/intensity_transform",target:"_blank",rel:"noopener noreferrer"},_=e("p",null,[e("strong",null,"BIMEF算法，是一个C++实现的原始MATLAB算法。与原始代码相比，此实现速度稍慢，并且无法提供相同的结果。特别是，在一定条件下，对于明亮区域，图像增强的质量会降低，而且OpenCV需要engine库才能运行BIMEF算法，所以本文就不介绍该算法。")],-1),h={href:"https://www.cnblogs.com/fydeblog/p/10734733.html",target:"_blank",rel:"noopener noreferrer"},A=a(`<h2 id="_2-代码与结果分析" tabindex="-1"><a class="header-anchor" href="#_2-代码与结果分析"><span>2 代码与结果分析</span></a></h2><h3 id="_2-1-调用接口说明" tabindex="-1"><a class="header-anchor" href="#_2-1-调用接口说明"><span>2.1 调用接口说明</span></a></h3><p>本文介绍OpenCV contrib的intensity_transform模块中四种图像强度增强算法。所有图像增加代码都在intensity_transform模块中。本文提供C++和Python版本的实现，不同图像强度增强算法调用接口如下：</p><p><strong>C++</strong></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>// Apply intensity transformations
// 应用强度转换
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>Python</strong></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># Apply intensity transformations
# 应用强度转换
# autoscaling
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>不同的方法所需要设定的参数不同，具体如下：</p><ul><li>autoscaling：对输入图像进行自适应缩放以增强对比度，仅需要输入待增强的图像。</li><li>gamma变换：对输入图像进行伽马校正以增强对比度，需要输入待增强图像和参数gamma。</li><li>对数变换：对输入图像进行对数转换以增强对比度，仅需要输入待增强的图像。</li><li>对比度拉伸：对输入图像应用线性对比度拉伸以增强对比度，需要输入待增强图像和参数r1，s1，r2，s2，(r1,s1)和(r2,s2)为转换函数第一个点和第二个点的坐标。</li></ul><p><strong>此外为了比较不同图像强度增强方法的效果，加入了图像对比度计算方法</strong></p>`,10),B={href:"https://stackoverflow.com/questions/58821130/how-to-calculate-the-contrast-of-an-image",target:"_blank",rel:"noopener noreferrer"},C=a(`<p>方法原理很简单,就是将图像变为灰度图，然后计算图像方差。</p><h3 id="_2-2-完整代码" tabindex="-1"><a class="header-anchor" href="#_2-2-完整代码"><span>2.2 完整代码</span></a></h3><p>代码功能很简单，就是获得输入图像，然后对输入图像应用不同的图像增强算法。对于可调参数的，创建滑动条以调整方法的输入参数。但是要注意的是，输入图像必须为三通道RGB图像。C++和Python代码如下：</p><p><strong>C++</strong></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>#include &lt;opencv2/opencv.hpp&gt;
