import{_ as t,r as i,o as l,c as a,a as e,b as s,d,e as r}from"./app-7i6QNW5x.js";const o={},c=r(`<h1 id="编程基础-c-多线程入门4-数据共享和资源竞争" tabindex="-1"><a class="header-anchor" href="#编程基础-c-多线程入门4-数据共享和资源竞争"><span>[编程基础] C++多线程入门4-数据共享和资源竞争</span></a></h1><p>原始C++标准仅支持单线程编程。新的C++标准(称为C++11或C++0x)于2011年发布。在C++11中，引入了新的线程库。因此运行本文程序需要C++至少符合C++ 11标准。</p><h2 id="_4-数据共享和资源竞争" tabindex="-1"><a class="header-anchor" href="#_4-数据共享和资源竞争"><span>4 数据共享和资源竞争</span></a></h2><p>在多线程环境中，线程之间的数据共享非常容易。但是，这种易于共享的数据可能会导致应用程序出现问题。这样的问题之一就是资源竞争。</p><h3 id="_4-1-资源竞争" tabindex="-1"><a class="header-anchor" href="#_4-1-资源竞争"><span>4.1 资源竞争</span></a></h3><p>竞争条件是多线程应用程序中出现的一种错误。当两个或多个线程并行执行一组操作时，它们将访问同一内存位置。同样，其中的一个或多个线程会修改该内存位置中的数据，这有时会导致意外结果。这称为竞争条件。 竞赛条件通常不会每次都出现，因此通常很难找到和复制。仅当两个或多个线程的相对执行顺序导致意外结果时，它们才会发生。让我们通过一个例子来理解。 让我们创建一个Wallet类，它在内部维护money并提供一个服务/功能，即addMoney()。此成员函数按指定的计数递增钱包对象的内部货币。</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>class Wallet
{
	int mMoney;
public:
	Wallet() :mMoney(0) {}
