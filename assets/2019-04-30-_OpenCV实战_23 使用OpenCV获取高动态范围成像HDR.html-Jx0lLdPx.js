...
</code></pre><p>这里，bias是[0,1]范围内偏置函数的值。从0.7到0.9的值通常会得到最好的结果。默认值为0.85。有关更多技术细节，请参阅此文章。参数通过反复试验获得。最终输出乘以3只是因为它给出了最令人满意的结果。更多的技术细节见：</p>`,29),w={href:"http://resources.mpi-inf.mpg.de/tmo/logmap/logmap.pdf",target:"_blank",rel:"noopener noreferrer"},f=e("p",null,"结果如下所示：",-1),C=e("figure",null,[e("img",{src:"https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/[OpenCV实战]23 使用OpenCV获取高动态范围成像HDR/20190430163548711.jpeg?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0x1b2hlbllK,size_16,color_FFFFFF,t_70",alt:"",tabindex:"0",loading:"lazy"}),e("figcaption")],-1),y=e("p",null,"(2) Durand Tonemap",-1),V=e("p",null,"Durand Tonemap的参数如下所示：",-1),M=e("pre",null,[e("code",null,`createTonemapDurand
...
`)],-1),k=e("p",null,"该算法基于将图像分解为基础层和细节层。使用称为双边滤波器的边缘保留滤波器获得基础层。sigma_space和sigma_color是双边滤波器的参数，分别控制空间域和颜色域中的平滑量。更多的技术细节见：",-1),B={href:"https://people.csail.mit.edu/fredo/PUBLI/Siggraph2002/DurandBilateral.pdf",target:"_blank",rel:"noopener noreferrer"},H=e("p",null,"结果如下所示：",-1),x=e("figure",null,[e("img",{src:"https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/[OpenCV实战]23 使用OpenCV获取高动态范围成像HDR/20190430163548702.jpeg?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0x1b2hlbllK,size_16,color_FFFFFF,t_70",alt:"",tabindex:"0",loading:"lazy"}),e("figcaption")],-1),T=e("p",null,"(3) Reinhard Tonemap",-1),A=e("p",null,"Reinhard Tonemap的参数如下所示：",-1),j=e("pre",null,[e("code",null,`createTonemapReinhard
...
</code></pre><h3 id="_2-7-工程代码" tabindex="-1"><a class="header-anchor" href="#_2-7-工程代码"><span><strong>2.7</strong> <strong>工程代码</strong></span></a></h3><p>本文所有代码见：</p>`,9),K={href:"https://github.com/luohenyueji/OpenCV-Practical-Exercise",target:"_blank",rel:"noopener noreferrer"},S=e("p",null,"C++:",-1),X=e("pre",null,[e("code",null,`#include "pch.h"
...
`)],-1),J=e("p",null,"Python:",-1),U=e("pre",null,[e("code",null,`import cv2
import numpy as np
