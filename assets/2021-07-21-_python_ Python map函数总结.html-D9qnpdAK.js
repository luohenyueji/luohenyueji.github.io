import{_ as t,r as p,o,c as l,a as n,b as a,d as e,e as c}from"./app-DrqaGevo.js";const i={},u=c(`<h1 id="python-python-map函数总结" tabindex="-1"><a class="header-anchor" href="#python-python-map函数总结"><span>[python] Python map函数总结</span></a></h1><p>本文主要介绍如何使用Python（Python3版本）的内置map()函数。简单来说map()函数会将指定的函数依次作用于某个序列的每个元素，并返回一个迭代器对象。map语法如下，其中function表示我们指定的函数，iterable表示要作用的序列，这个序列可以是一个也可以是多个。</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>map(function, iterable, ...)
