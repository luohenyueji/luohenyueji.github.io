...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-目标检测" tabindex="-1"><a class="header-anchor" href="#_2-目标检测"><span>2 目标检测</span></a></h2><h3 id="_2-1-参数说明" tabindex="-1"><a class="header-anchor" href="#_2-1-参数说明"><span>2.1 参数说明</span></a></h3><p>ImageAI提供了非常强大但易于使用的类和函数来执行图像对象检测和提取。ImageAI允许您使用最新的深度学习算法（例如RetinaNet，YOLOv3和TinyYOLOv3）执行所有这些操作。使用ImageAI，您可以运行检测任务并分析图像。</p><p>ImageAI的ObjectDetection类为您提供使用在COCO数据集上训练的预训练模型对任何图像或一组图像执行对象检测的功能。支持的模型是RetinaNet，YOLOv3和TinyYOLOv3。这意味着您可以检测和识别80种常见的日常物品。首先，请通过下面的链接下载要使用的任何预训练模型。</p>`,35),f={href:"https://github.com/OlafenwaMoses/ImageAI/releases/tag/1.0/",target:"_blank",rel:"noopener noreferrer"},A={href:"https://github.com/OlafenwaMoses/ImageAI/releases/tag/1.0/",target:"_blank",rel:"noopener noreferrer"},I={href:"https://github.com/OlafenwaMoses/ImageAI/releases/tag/1.0/",target:"_blank",rel:"noopener noreferrer"},F={href:"https://github.com/OlafenwaMoses/ImageAI/releases/download/1.0/resnet50_coco_best_v2.0.1.h5",target:"_blank",rel:"noopener noreferrer"},w=t(`<p>一旦下载了所选择的模型，就应该创建ObjectDetection类的新实例，如以下示例所示：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> imageai<span class="token punctuation">.</span>Detection <span class="token keyword">import</span> ObjectDetection
...
</code></pre><ul><li>.CustomObjects()，当您只想检测选定数量的对象时，可以使用此函数。它返回对象及其正确或错误值的字典。要检测图像中的选定对象，必须将this函数返回的字典与detectCustomObjectsFromImage（）函数一起使用。在下面的注释和代码示例中找到详细信息：</li></ul><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>There are 80 possible objects that you can detect with the
...
--------------------------------
</code></pre><p>其他用法，比如加快速度，类似对象检测的用法。</p><h2 id="_3-视频实时检测与分析" tabindex="-1"><a class="header-anchor" href="#_3-视频实时检测与分析"><span>3 视频实时检测与分析</span></a></h2><h3 id="_3-1-参数说明" tabindex="-1"><a class="header-anchor" href="#_3-1-参数说明"><span>3.1 参数说明</span></a></h3><p>ImageAI提供了非常强大但易于使用的类和函数来执行 视频对象检测和跟踪 以及视频分析。ImageAI允许您使用最新的深度学习算法（例如RetinaNet，YOLOv3和TinyYOLOv3）执行所有这些操作。使用ImageAI您可以运行检测任务并分析来自设备摄像机和IP摄像机的视频和实况视频源。</p><p>VideoObjectDetection类提供了使用在COCO数据集上进行训练的预训练模型来检测视频中的对象以及来自设备摄像机和IP摄像机的实时馈送的功能。支持的模型是RetinaNet，YOLOv3和TinyYOLOv3。这意味着您可以在任何视频中检测和识别80种常见的日常物体。首先，请通过下面的链接下载要使用的任何预训练模型。</p>`,41),q={href:"https://github.com/OlafenwaMoses/ImageAI/releases/download/1.0/resnet50_coco_best_v2.0.1.h5",target:"_blank",rel:"noopener noreferrer"},O={href:"https://github.com/OlafenwaMoses/ImageAI/releases/download/1.0/yolo.h5",target:"_blank",rel:"noopener noreferrer"},j={href:"https://github.com/OlafenwaMoses/ImageAI/releases/download/1.0/yolo-tiny.h5",target:"_blank",rel:"noopener noreferrer"},x=t(`<p>由于视频对象检测是一项计算密集型任务，因此建议您使用装有NVIDIA GPU和GPU版本的Tensorflow的计算机执行此实验。执行视频对象检测CPU的速度将比使用NVIDIA GPU驱动的计算机慢。</p><p>下载选择使用的模型后，创建VideoObjectDetection的实例，如下所示：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">from</span> imageai<span class="token punctuation">.</span>Detection <span class="token keyword">import</span> VideoObjectDetection
