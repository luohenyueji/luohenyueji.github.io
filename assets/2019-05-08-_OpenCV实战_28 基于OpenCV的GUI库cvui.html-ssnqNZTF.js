import{_ as a,r as c,o as l,c as r,a as n,b as t,d as o,e as i}from"./app-CD_-ggd_.js";const u={},p=n("h1",{id:"opencv实战-28-基于opencv的gui库cvui",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#opencv实战-28-基于opencv的gui库cvui"},[n("span",null,"[OpenCV实战]28 基于OpenCV的GUI库cvui")])],-1),h=n("p",null,"有很多很棒的GUI库，例如Qt和imgui，可以与OpenCV一起使用，允许您在运行时调整参数。但是，在某些情况下，您可能没有（或不希望）此类库的依赖关系，例如，您没有使用Qt支持编译OpenCV，或者您无法使用OpenGL。在这种情况下，您只需要一种快速，轻松的方式来创建GUI来调整算法。",-1),s=n("p",null,"这就是cvui的目的。它是一个基于OpenCV绘图基元构建的跨平台GUI库，仅需使用头文件就可以搭建。除了OpenCV本身（您可能已经在使用）之外，它没有依赖关系。Cvui在C++下通过.h文件实现全部功能，在Python下直接提供.py文件。本文仅仅讲述cvui在C++下的构建，python通常用的少。",-1),d=n("p",null,"cvui遵循一行代码就可以在屏幕上产生一个UI组件的规则。cvui具有友好的C类API，没有类/对象和多个组件，例如，跟踪栏，按钮，文字等等。cvui界面如下所示，",-1),v=n("figure",null,[n("img",{src:"https://www.learnopencv.com/wp-content/uploads/2017/06/cvui.png",alt:"https://www.learnopencv.com/wp-content/uploads/2017/06/cvui.png",tabindex:"0",loading:"lazy"}),n("figcaption",null,"https://www.learnopencv.com/wp-content/uploads/2017/06/cvui.png")],-1),g=n("p",null,"cvui相关使用见：",-1),m={href:"https://dovyski.github.io/cvui/",target:"_blank",rel:"noopener noreferrer"},_=n("p",null,"工程文件及下载见：",-1),w={href:"https://github.com/Dovyski/cvui",target:"_blank",rel:"noopener noreferrer"},f=i(`<h2 id="_1-cvui-的使用" tabindex="-1"><a class="header-anchor" href="#_1-cvui-的使用"><span><strong>1 cvui</strong> <strong>的使用</strong></span></a></h2><h3 id="_1-1-如何在您的应用程序中添加cvui" tabindex="-1"><a class="header-anchor" href="#_1-1-如何在您的应用程序中添加cvui"><span><strong>1.1</strong> <strong>如何在您的应用程序中添加cvui</strong></span></a></h3><p>为了使用cvui，你只需要把cvui.h文件放到工程目录下，包含头文件就行了。但是对于比较新的版本，本文用的是cvui2.7版本则需要在cvui.h前加入</p><blockquote><p>#define CVUI_IMPLEMENTATION</p></blockquote><p>具体如下所示：</p><pre><code>#include &lt;opencv2/opencv.hpp&gt;
...
</code></pre><p>该 cvui::trackbar() 函数接受指定轨迹栏允许的最小值和最大值的参数。在上面的例子中，它们分别是[5,150] low_threshold和[80,300] high_threshold。结果是一个完全交互式的应用程序，允许用户快速，轻松地探索Canny Edge参数的调整，以及启用/禁用它的使用。效果如图所示：</p><figure><img src="https://gitlab.com/luohenyueji/article_picture_warehouse/-/raw/main/blog/[OpenCV实战]28 基于OpenCV的GUI库cvui/20190508174721447.gif" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="_3-代码" tabindex="-1"><a class="header-anchor" href="#_3-代码"><span>3 代码</span></a></h2><p>以下是此应用程序的完整代码，您不需要多行代码就可以为您的应用程序生成最小（且有用）的UI界面。该cvui并非旨在成为复杂图形应用程序开发的完整解决方案。它在很多方面都很简单并且有限。但是，它实用，易于使用，可以为您节省数小时的挫折和繁琐的工作。如果实际工程应用推荐QT而不是MFC(个人观点)。</p><p>本文所有代码和cvui头文件见：</p>`,24),E={href:"https://github.com/luohenyueji/OpenCV-Practical-Exercise",target:"_blank",rel:"noopener noreferrer"},b=n("p",null,"hello world代码：",-1),I=n("pre",null,[n("code",null,`#include "pch.h"
...
`)],-1),O=n("p",null,"canny算子代码：",-1),V=n("pre",null,[n("code",null,`#include "pch.h"
#include <opencv2/opencv.hpp>
#define CVUI_IMPLEMENTATION
#include "cvui.h"
